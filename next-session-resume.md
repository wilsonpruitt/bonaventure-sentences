# Next session — **d24-p2-a2-q1 DONE 2026-05-29 (NEW chunk created — auto-chunker dropped it; commit `ef9a173`). Next action: dispatch `bon-sent-II-d24-p2-a2-q2` (EXISTING skeleton — rebuild). ARTICULUS II QUAESTIO II *Utrum peccatum mortale possit esse in ea parte rationis, superiori non peccante* (TRACTATIO title; body opener title on p.579-R reads *Utrum pars inferior possit peccare mortaliter absque superiori* — SAME question). Body opener *Secundo quaeritur, utrum pars inferior possit peccare mortaliter absque superiori* (raw 40582), opens at the FOOT of p.579 (PDF 601, +22) below a2-q1's SCHOLION III. Runs to where ARTICULUS III opener (*…duo quaeruntur*, raw ~40784) + ART III QUAESTIO I (*utrum in sensualitate possit esse peccatum veniale*) begin — likely pp.579–~581. Verify the *Secundo quaeritur… absque superiori* opener alignment. HAND-OFF RECEIVED from a2-q1: p.579 footers ³–⁴ migrate to a2-q2's body (³ Cfr. supra d.22 a.4 q.1 / cod. bb *etiam*; ⁴ Cap. 12 / August. XII de Trin c.12 — the Augustine/Magister citation for the Sed contra «Si peccatum diu in cogitatione…») — these anchor in the a2-q2 body that opens on p.579 below a2-q1; lead the a2-q2 apparatus with them. Use `vol2/bon-sent-II-d24-p2-a1-q1.md` or `a2-q1.md` as the structural template.**
>
...
>
> **CORRECTED PARS II BUILD ORDER (after a2-q1 done): p2-divisio ✓ → p2-a1-q1 ✓ → p2-a1-q2 ✓ → p2-a2-q1 ✓ → p2-a2-q2 (skel, rebuild, NEXT) → p2-a3-q1 (skel, rebuild) → p2-a3-q2 (skel, rebuild) → p2-dubia (skel, rebuild).** EXISTING skeletons to rebuild: `d24-p2-a2-q2` (NEXT), `d24-p2-a3-q1`, `d24-p2-a3-q2`, `d24-p2-dubia`.
