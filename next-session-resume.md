# Next session — **NEXT = `bon-sent-II-d30-a1-q1` (ARTICULUS I QUAESTIO I, DISTINCTIO XXX). The DISTINCTIO XXX divisio is now Tier-2.** d.30 = *De peccato originali, quomodo transit in posteros*. **ART I opener folds into q1** per Override §5 (theme *De originalis peccati entitate*). **QUAESTIO I title = *Utrum corruptio, quae est in humana natura, insit ei a suae conditionis primordio, an ex peccati merito* (header raw 49759, p.714); q1 body opener *Circa primum sic proceditur et quaeritur, utrum corruptio, quam videmus in humana natura, insit ei ex suae conditionis primordio, an ex peccati merito* at raw ~49764.** **⚠ CHUNKING BUG TO FIX (promoting ART I): `a1-q2` is MISSING.** ART I has TWO quaestiones — q1 (raw 49759) and **QUAESTIO II *Utrum natura humana merito primae transgressionis fuerit corrupta poenaliter tantum, an etiam culpabiliter* (header raw ~49999; q2 opener *Secundo quaeritur, utrum merito primae trans[gressionis]…* raw ~50001)** — but the auto-chunker bundled BOTH into the single `bon-sent-II-d30-a1-q1.md` skeleton (line_start 49759 / line_end 50246, which straddles the q2 header at ~49999). When promoting ART I, CARVE OUT a new `bon-sent-II-d30-a1-q2.md` (a2-q1 starts clean at raw ~50255). **d.30 remaining = 6 units (NO dubia): ART I {a1-q1 + a1-q2-to-create} / ART II {a2-q1 + a2-q2} / ART III {a3-q1 + a3-q2}; DISTINCTIO XXXI at raw 51357.** **Skeletons present (auto-chunked 2026-05-13):** a1-q1, a2-q1, a2-q2, a3-q1, a3-q2 (5 files; a1-q2 to be created). **No d.30 dup strays.** **VERIFIED TRACTATIO question-list (450 dpi, in d30-divisio Notes):** 3 articles = (I) *de originalis peccati entitate* / (II) *de quidditate* / (III) *de veritate humanae naturae*; ART I sub-questions printed in divisio TRACTATIO (q1 = corruptio-ex-primordio-an-ex-merito; q2 = poenaliter-tantum-an-etiam-culpabiliter). Per Override §5, fold the short ARTICULUS openers into each article's q1. **Offset pdf = printed + 22.** **⚠ DECADE BOUNDARY: after d.30's last unit ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
