# Next session — **d28-a1-q2 DONE 2026-05-29 (REBUILT from skeleton). ARTICULUS I QUAESTIO II *Utrum liberum arbitrium absque gratia gratum faciente possit adversarium suum vincere***, pp. **677–679** (PDF 699–701, offset +22), raw **47273–47389**. Holds QUAESTIO II body (args 1–5, Sed contra 1–5, Conclusio, Respondeo [resistentia vs victoria distinction], solutions 1–5) + **SCHOLION I+II** (II = commentator-roll *pro quaest. seq.* per Override §5). **has_scholion=TRUE**. **8 apparatus entries** [^1]–[^8]: [^1]–[^3] = **RECEIVED from d28-a1-q1** = p.677 R-col footers 3–5 (Gen 4:7 *Subter te erit appetitus tuus* / Bernard *Vide supra pag.115 nota 6* / Magister d.21 *Cap.6*), anchored at args 1, 2, 4 / [^4]–[^5] = p.678 L-col footers 1–2 (1 Cor 15:57 / Rom 7:24) at Sed contra 1–2 / [^6]–[^7] = p.678 L-col footers 3–4 (Ps 106:12 Glossa / Ps 77:49 Glossa) at Sed contra 3 / [^8] = p.678 R-col footer 5 (Apoc 2,7.10; 3,12.21) at Sed contra 4. The q2 Respondeo/solutions carry NO printed body markers (p.678 R-col footers 6–10 + p.679 footers are editorial back-refs / belong to QUAESTIO III) — not rendered as numbered apparatus, consistent with no body anchors. Page seams 677→678 (*…de diabolo triumphare.*) and 678→679 (*…vitaret poenam…* / sol 5 *…subiugando sibi hominem*) both grammatically continuous (450 dpi). **No hand-off FORWARDED** — q2 closes clean with SCHOLION II at bottom of p.679 (raw 47389); QUAESTIO III opens fresh at raw 47390 with its own p.679 L-col footers 1–4. NO [?] flags. Marker pairing OK (8 La = 8 En = 8 defs). Commit 6e29a2e (chunk+content.json+paraphrase-audit) + this resume advance. Build **884 q / 726 translated** (+1). Audits: paraphrase **0 critical / 5 high** (5 high = remaining unbuilt d.28 skeletons: a1-q3, a2-q1, a2-q3, dubia, dubia-dup2; a1-q2 now OK); header d.28 Q-LOSS = Vol II false-positive (the 2 remaining QUAEST raw headers live in the still-skeleton q3+a2 chunks; ART diff now +0 — accept per Vol II calibration); apparatus a1-q2 NOT flagged (4 SKELETON-SUSPECT = the unbuilt d.28 article/dubia skeletons).**

**NEXT = `bon-sent-II-d28-a1-q3`** (ARTICULUS I QUAESTIO III *Utrum liberum arbitrium absque gratia gratum faciente possit omnia mandata implere* — skeleton, `auto-chunked 2026-05-13`; **NOTE the printed title is *omnia mandata implere*, not the abbreviated *Dei mandata implere* in the TRACTATIO list — use the printed title**). **LAST quaestio of ARTICULUS I.** **QUAESTIO III at raw 47390** (p.679 L-col bottom, *Tertio quaeritur, utrum absque gratia gratum faciente liberum arbitrium possit omnia mandata implere. Et quod sic, videtur…*); runs to ARTICULUS II at **raw ~47508** (grep `ARTICULUS II` / `QUAESTIO I` — the ART II 3-question list is printed at that opener, NOT in the divisio — record verbatim when a2-q1 is built). **RECEIVES from d28-a1-q2:** nothing (q2 closed clean). q3 owns its own p.679 L-col footers 1–4 (4 footers: [1] *Vat. cum edd. 3,4 bono* / [2] *Cfr. supra pag.170 nota 2* / [3] *Vers.11…* / [4] *Vers.30*) + further p.680 footers. **Verify the opener** *Tertio quaeritur … omnia mandata implere* alignment before promoting. Pages: opens p.679, likely runs pp.679–680. SCHOLION II of q2 already supplied the q3 commentator-roll, so q3 may legitimately have **no scholion of its own** — check before flagging. **d.28 structure** (DISTINCTIO XXVIII raw 46924 → XXIX raw 48282): littera ✅ → divisio ✅ → ARTICULUS I (raw 47086) **q1 ✅ / q2 ✅** / q3 → ARTICULUS II (raw ~47508) Q I/II/III → DUBIA (raw ~48173). **d.28 remaining inventory:** a1-q3, a2-q1, **a2-q3 (but a2-q2 MISSING — must be CREATED)**, dubia, **dubia-dup2 (stray — investigate at a2-q2/dubia time: may be the misfiled a2-q2 per the d.27 pattern, or a genuine over-range dup)**. Single-pars distinction (no p1/p2 split). Offset +22.
