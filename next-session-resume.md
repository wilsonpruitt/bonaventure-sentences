...
>
> ## ✅✅ **THE WORK-CLOSE POLISH GATE IS CLOSED (2026-08-14, `9176f2e`) — all four passes, ZERO corpus defects.** Log: `manual-review/vol5-itinerarium-workclose-gate.md`. ▶▶▶ **THE ONLY THING LEFT AT p. 316 IS THE DEPLOY, and it is protected — it needs Wilson's explicit per-action OK.**
>
...
>
> **THE DEPLOY IS THE OPEN ITEM** (recipe at the foot of this file — note the TWO index steps before `build-content.mjs`). ⛔ **Deploy and push are BOTH protected and BOTH need Wilson's explicit per-action OK.** `master` is now **25 commits ahead of origin.** Park alongside it, to ship in the same deploy: the rewritten About page (`e3473f8`, committed local-only) and the owed "What Is Known to Be Wrong" section.
>
