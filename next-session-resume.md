# Next session — **`d30-dubia` DONE 2026-05-30 (Tier-2, commit `b280560`) — CLOSES the d.30 gap the decade polish missed. NEXT ACTION = dispatch `bon-sent-II-d31-divisio`** (COMMENTARIUS IN DISTINCTIONEM XXXI, opens raw 51530 / p.739 L-col; DIVISIO TEXTUS + TRACTATIO QUAESTIONUM; **ART I has q1/q2/q3, ART II has q1/q2/q3** per the raw header scan; offset pdf=printed+22). **CORRECTS the prior "d.30 no dubia" claim:** DISTINCTIO XXX now = littera + divisio + a1-q1/q2 + a2-q1/q2 + a3-q1/q2 + **dubia** (the octo-nominibus DUBIUM CIRCA LITTERAM). d.31 remaining skeletons after divisio: d31-a1-q1/q2/q3, d31-a2-q1/q2/q3, d31-dubia (+ a `d31-divisio-dup2` legacy dup to retire during d.31 rechunk review).
