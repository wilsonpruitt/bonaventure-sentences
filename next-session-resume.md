# Next session — **NEXT = `bon-sent-II-d30-littera` (LITTERA MAGISTRI, DISTINCTIO XXX). DISTINCTIO XXIX is now FULLY Tier-2 (all 9 units).** d.30 = *De peccato originali, quomodo transit in posteros* (DISTINCTIO XXX raw **49544** body header; chunk range opens raw **49478**; runs to DISTINCTIO XXXI raw **51357**). **d.30 structure = 8 units (NO dubia): littera (Cap. I–VI, raw 49544–49705) / divisio (DIVISIO TEXTUS + TRACTATIO QUAESTIONUM, raw 49706–49758) / ART I {a1-q1 + a1-q2} / ART II {a2-q1 + a2-q2} / ART III {a3-q1 + a3-q2}.** **⚠ CHUNKING BUG TO FIX: `a1-q2` is MISSING.** ART I has TWO quaestiones — q1 (*Circa primum… utrum…* raw ~49765) and **QUAESTIO II *Utrum natura humana merito primae transgressionis fuerit corrupta poenaliter tantum, an etiam culpabiliter* (raw ~49999)** — but the auto-chunker bundled BOTH into the single `bon-sent-II-d30-a1-q1.md` skeleton (line_start 49759 / line_end 50246, which straddles the q2 header at ~49999). When promoting ART I, CARVE OUT a new `bon-sent-II-d30-a1-q2.md` (a2-q1 starts clean at raw 50255). **Skeletons present (auto-chunked 2026-05-13):** littera, divisio, a1-q1, a2-q1, a2-q2, a3-q1, a3-q2 (7 files; a1-q2 to be created). **No d.30 dup strays.** Per Override §5, fold the short ARTICULUS openers (*Consequenter… quaeruntur…*) into each article's q1. **Offset pdf = printed + 22; d.30 littera opens printed p.710 (PDF 732).** **⚠ DECADE BOUNDARY: after d.30's last unit ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
