...
> # ▶▶▶ START HERE — **`bon-sent-I-proem-q4`** (QUAESTIO IV, *Quae sit causa efficiens sive auctor huius libri*), which opens **just below the middle of p. 14** at the bare `QUAESTIO IV.` display heading, raw L10907.
>
