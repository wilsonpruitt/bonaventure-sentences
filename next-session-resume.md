# Next session — **d27-divisio DONE 2026-05-29 (REBUILT from skeleton). COMMENTARIUS IN DISTINCTIONEM XXVII + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM**, pp. 652–653 (PDF 674–675, offset +22), raw 45573–45618. **2 apparatus entries** [^1]–[^2]: [^1] = p.652 NOTAE AD COMMENTARIUM footer ("Edd. *prioris*, incongrue; Vat...post *ubi signatur* adiicit *fit*") @ *determinatio ponitur*; [^2] = p.653 footer 1 ("Plures codd...cum ed. 1 *quae quaerit*") @ the divisio *quaeritur de comparatione gratiae ad virtutem* on p.653 (NOT the Q1 body below it). **has_scholion=FALSE**. Page-split: COMMENTARIUS header+lemma+DIVISIO opener on p.652 R-col; `<!-- page 653 -->` mid-word at *quaestionis prae-‖missae*; rest of DIVISIO + full TRACTATIO on p.653, ending before ARTICULUS I QUAESTIO I at raw 45619/body 45623. Body seam 652→653 grammatically continuous (450 dpi). **RECEIVED nothing**; **FORWARDED nothing** (a1-q1 owns Q1 body + p.653 footers 2–6). NO [?] flags. **⚠ CROSS-CHUNK GAP flagged for d27-littera:** p.652 NOTAE AD LIBR. footers **3 ("Quaest. 39. n. 1." = August. Quaest. Evang. II q.39, for littera "in secundo libro Quaestionum Evangelii") and 4 ("Cap. 2. n. 5. — Paulo inferius ante *illud quo* codd. BC et edd. 1,8 addunt *est*", for littera "aliud *illud quo* creditur")** were DROPPED from d27-littera (which ends at [^23] = p.652 footer 2). Add as littera [^24]–[^25] at d.27 polish time. Commit dca5c3f (chunk+content.json+paraphrase-audit) + this resume advance. Build **885 q / 715 translated** (+1). Audits: paraphrase **0 critical / 8 high** (all 8 = unbuilt d.27 skeletons a1-q1…q3, a2-q1…q3, dubia, dubia-dup2; divisio+littera OK); header d.27 ART 2/0/-2 QUAEST 4/0/-4 (Q-LOSS A-LOSS EXPECTED — a divisio holds COMMENTARIUS/DIVISIO/TRACTATIO not ARTICULUS/QUAESTIO bodies + Tier-2 drops line ranges; same calibration as d26-divisio); apparatus 8 SKELETON-SUSPECT = the unbuilt d.27 chunks (divisio NOT flagged).
...
## NEXT = `bon-sent-II-d27-a1-q1` — ARTICULUS I QUAESTIO I *Utrum gratia gratum faciens dividi habeat per differentias essentialiter diversas*. SKELETON exists. Per Override §5 the short ART I opener (*ARTICULUS I. De gratia in comparatione ad alium habitum.*) folds into a1-q1 — no standalone a1-divisio chunk. **ART I header at raw 45619; QUAESTIO I + Q1 body begin at raw 45623** (p.653 R-col mid-page, running head `DIST. XXVII. ART. I. QUAEST. I. 653`; opener "Circa primum sic proceditur et quaeritur, utrum gratia gratum faciens dividi habeat per differentias diversas per essentiam. Et quod sic, videtur. 1. Magister in littera…"). a1-q1 spans p.653 onward to QUAESTIO II at raw 45809. **a1-q1 owns p.653 footers 2–6** (2 "Dist. praeced. c.2 seqq…", 3 "Vers. 13…Glossam", 4 "Vers. 4", 5 "Aristot. I. Topic. c.13 et V. Ethic.", 6 "Aristot. II. Ethic. c.1") — p.653 footer 1 *quae quaerit* already taken by d27-divisio [^2]. d.27 build order: littera DONE → divisio DONE → **a1-q1 → a1-q2 → a1-q3 → a2-q1…q3 → dubia (resolve dup2)**. ⚠ **`d27-dubia-dup2` (line_start 46814) STILL TO RESOLVE at d.27-dubia** (vs canonical d27-dubia line_start 46673). d.27→d.28 (DISTINCTIO XXVIII) at raw 46924.
