...
## NEXT = `bon-sent-II-d27-a1-q2` — ARTICULUS I QUAESTIO II *Utrum gratia gratum faciens et virtus gratuita differant per essentiam* (*de gratia in comparatione ad virtutem gratuitam*). SKELETON exists. **QUAESTIO II header + body begin at raw 45809** (top of p.656 L-col, running head `SENTENTIARUM LIB. II.` even page; opener "Secundo quaeritur de comparatione gratiae ad virtutem gratuitam, et est quaestio, utrum gratia gratum faciens et virtus gratuita differant per essentiam. Et quod non, videtur: 1. Primo per illud quod Magister dicit…"). q2 owns its own p.656+ footer run (p.656 L-col footers 1ff "Dist.XXVI c.3…", "Secundum Aristot VI Topic c.3", "Sicut ostensum est quaest. praeced.", "Cfr. illud Aristot VII Topic c.1"; p.656 R-col footers for the Sed contra args "Anselmus de Concordia"…). **RECEIVED nothing** from a1-q1 (clean seam at p.656 top). Grep for QUAESTIO III boundary (*de gratia in comparatione ad gloriam* = a1-q3) to find q2's end. d.27 build order: littera DONE → divisio DONE → a1-q1 DONE → **a1-q2 → a1-q3 → a2-q1…q3 → dubia (resolve dup2)**. ⚠ **`d27-dubia-dup2` (line_start 46814) STILL TO RESOLVE at d.27-dubia** (vs canonical d27-dubia line_start 46673). d.27→d.28 (DISTINCTIO XXVIII) at raw 46924.
