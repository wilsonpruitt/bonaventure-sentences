# Next session — **d24-p1-a2-q4 DONE 2026-05-29 → next action: dispatch `bon-sent-II-d24-p1-dubia` (DUBIA CIRCA LITTERAM MAGISTRI for Pars I; skeleton, opens raw 40048 with `DUBIA CIRCA LITTERAM MAGISTRI.`, DUB. I at raw 40050; on p. 571 bottom continuing). RE-CHUNK-VERIFY DUB COUNT: raw shows DUB. I (40050) and DUB. III (40088) cleanly; DUB. II appears OCR-garbled/two-column-interleaved between them — walk the raw range with a broad regex before trusting boundaries. Pars I dubia runs raw 40048 → ~40130 (ends where running head `DIST. XXIV. P. II. ART. I. QUAEST. I.` begins at raw ~40131, p.573). Apparatus-count audit: raw=8 footers for `d24-p1-dubia`. Stray dup `d24-p1-dubia-dup2` ALREADY git-rm'd this session. Hand-off RECEIVED from a2-q4: NONE — q4 (body + SCHOLION I–III) closed self-contained at raw 40047 immediately before the dubia; the dubia open fresh on p.571 with their own footer sequence. NOTE: after Pars I dubia, Pars II numbering (p2-a*, p2-dubia) is auto-chunk-suspect — re-chunk-verify before promoting Pars II.**
> **ARTICULUS II = *De divisione potentiarum animae* (4 questions, all in Pars I), now COMPLETE; TRACTATIO (raw 39105–39130): Primo *per cognitivam et affectivam* (a2-q1, DONE 32 app); Secundo *per portionem superiorem et inferiorem* (a2-q2, DONE 18 app); Tertio *per deliberativum et naturale* (a2-q3, DONE 12 app, SCHOLION I); Quarto *per possibilem et agentem* (a2-q4, DONE — 31 apparatus entries across pp.567–571, has_scholion=true SCHOLION I–III, no hand-offs). d.24 structure: Pars I = a1 + a2 (4 q's, DONE) + p1-dubia (NEXT); Pars II = a1, a2, a3 + p2-dubia (all auto-chunk-suspect, re-chunk-verify).**
