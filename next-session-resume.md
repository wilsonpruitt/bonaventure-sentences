# Next session — **NEXT = `bon-sent-II-d30-a2-q2` (ARTICULUS II QUAESTIO II, DISTINCTIO XXX) — skeleton present, REBUILD from skeleton.** d.30 = *De peccato originali, quomodo transit in posteros*. **ARTICULUS II theme = *De quidditate originalis peccati* (already folded into a2-q1, DONE). a2-q2 QUAESTIO II title = *Utrum peccatum originale sit ignorantia* (header raw 50479); opener *Secundo quaeritur circa hoc, utrum peccatum originale sit ignorantia. Et quod sic, videtur* at raw 50481.** **a2-q2 RAW RANGE = 50479 (QUAESTIO II header) → just before ARTICULUS III raw 50602.** a2-q2 opens lower on **p.724**; offset pdf = printed + 22 (p.724 = PDF 746). **Hand-off RECEIVED into a2-q2 = p.724's two numbered footers (f1 Psalm. 24,7 Glossa anchoring the *Delicta iuventutis* fundam.; f2 Libr. 1 c. 28 Hugo) + the entire QUAESTIO II body** — FORWARDED from a2-q1 (a2-q1's SCHOLION on p.724 carried no numbered footers; p.724's two numbered footers belong to q2's body). Verify the running-head page (p.724/725) span; q2 likely pp.724–725 (PDF 746–747). **Alignment check:** q2 opener = ART II TRACTATIO item 2 (*Secundo quaeritur, utrum sit ignorantia*) ✅; STOP/report if misaligned. **q2 is the LAST quaestio of ART II — check sibling-pointer: ART II commentator-roll is at a2-q1's SCHOLION III (ends *…Dionys. Carth., de hac et seq. q. hic q. 1.*); q2 may have has_scholion=false or a short scholion — verify on the PDF.** **d.30 remaining after a2-q2 = 2 units (NO dubia): ART III {a3-q1 *utrum aliquid transeat in veritatem humanae naturae per actum generativae* + a3-q2 *…per opus nutritivae*}; ART III opener raw 50602, ART III TRACTATIO at raw ~50608; DISTINCTIO XXXI at raw 51357.** **Skeletons present:** a2-q2, a3-q1, a3-q2. **Offset pdf = printed + 22.** **⚠ DECADE BOUNDARY: after d.30's last unit (a3-q2) ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
