# Next session — **d24-p1-a1-q2 DONE 2026-05-29 → next action: dispatch `bon-sent-II-d24-p1-a2-q1` (ARTICULUS II QUAESTIO I *Utrum intellectus et affectus, sive ratio et voluntas, essentialiter differant*; skeleton, opens raw ~39131 QUAESTIO I on p. 558; ART II opener *De divisione potentiarum animae* raw 39102 folds into a2-q1 per Override §5). Hand-off RECEIVED from a1-q2: NONE (q2's SCHOLION + footers fully closed before ARTICULUS II on p.558; a2-q1 opens fresh). Crops p.558 cached (`/tmp/colcrop/vol2-p558-*`); extract p.559+ as needed.**
> **ARTICULUS II = *De divisione potentiarum animae*; TRACTATIO (raw 39105–39130, verbatim): *Consequenter quaeritur de secundo, videlicet de divisione potentiarum animae; et circa hoc possunt QUATUOR quaeri.* — Primo *de illa divisione potentiarum animae, quae est per cognitivam et affectivam, sive per rationem et voluntatem* (= a2-q1, header *Utrum intellectus et affectus, sive ratio et voluntas, essentialiter differant*); Secundo *de illa quae est per portionem superiorem et inferiorem* (= a2-q2); Tertio *de illa quae est per deliberativum et naturale* (= a2-q3); Quarto et ultimo *de illa divisione, quae est per possibilem et agentem* (= a2-q4). FOUR sub-questions → matches skeletons a2-q1..q4. NOTE: Pars II numbering (p2-a*, p2-dubia) is auto-chunk-suspect — re-chunk-verify before promoting Pars II.**
