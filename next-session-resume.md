# Next session — **`d32-littera` DONE 2026-05-30 (Tier-2, commit `509ee3b`). DISTINCTIO XXXII opened** (littera Cap. I–VIII, pp.756–758, 19 apparatus). **NEXT ACTION = dispatch `bon-sent-II-d32-divisio`** (COMMENTARIUS IN DISTINCTIONEM XXXII + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM). **d.32 divisio range:** `COMMENTARIUS IN DISTINCTIONEM XXXII.` (raw **52902**) → `DIVISIO TEXTUS.` (raw **52906**) → `TRACTATIO QUAESTIONUM.` (raw **52929** — *Primo quaeritur, utrum baptismus deleat originale; Secundo, utrum deleat quantum…; Tertio, de aequitate divinae iustitiae*) → ends immediately before **`ARTICULUS I.` `QUAESTIO I.`** (raw **≈52939** — *Circa primum sic proceditur et quaeritur, utrum… aqua et Spiritu sancto…*). Printed page **758** (running-head OCR digit mangled; offset pdf=printed+22 → PDF 780; likely spills onto p.759). Template = `vol2/bon-sent-II-d31-divisio.md`. After divisio: `d32-a1-q1` (raw ≈52939), then `ARTICULUS II. QUAESTIO I.` (raw ≈53313). **HAND-OFF into d32-divisio:** NONE from d32-littera (littera closed cleanly at bottom of p.758 R-col before COMMENTARIUS; the d.32 commentary footer block — TRACTATIO QUAESTIONUM notes etc. — all belong to the divisio/commentary, none were claimed by the littera). **No decade polish until d.40.**
