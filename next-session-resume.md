# Next session — **d27-a1-q2 DONE 2026-05-29 (REBUILT from skeleton). ARTICULUS I QUAESTIO II *Utrum gratia gratum faciens et virtus gratuita differant per essentiam*** (*de gratia in comparatione ad virtutem gratuitam*), pp. 656–659 (PDF 678–681, offset +22), raw 45809–46034. **28 apparatus entries** [^1]–[^28], split: **p.656 footers 1–9 → [^1]–[^9]** (args 1–6 + Sed contra 1,2,4); **p.657 footers 1–10 → [^10]–[^19]** (Sed contra 5–6, Opinio 1/2, the *iudicium de utraque* "improbatum supra" anchors footers 6–8 = [^15]–[^17], Opinio 3 footers 9–10 = [^18]–[^19]); **p.658 footers 1–9 → [^20]–[^28]** (Respondeo conclusiones 2–4 + replies 1,2,5,6; reply-3+4 carries [^24] *consequens*=fallacia consequentis; reply 6 carries [^26]–[^28]). **has_scholion=TRUE** (SCHOLION I+II+III — begins foot of p.658 R-col, continues across top of both p.659 columns ending "…differre a sententia Scoti" above the QUAEST III divider; the scholion carries NO footnote anchors — all citations inline parenthetical, so all 28 [^N] are body/reply footnotes). Page-split: p.656 = ART I/Q II openers + args 1–6 + Sed contra 1–4 (SC4 *differentias dividentes* breaks at page foot); p.657 = SC 5–6 + Conclusio + Respondeo (Opinio 1, Opinio 2, iudicium, Opinio 3 start; breaks at *et sicut ‖ unum lumen*); p.658 = Respondeo conclusiones 2–4 + replies 1,2,3+4,5,6 + Scholion I+II start; p.659 = Scholion II tail + III. Body seams 656→657 / 657→658 / 658→659 grammatically continuous (450 dpi). **⚠ p.659 L-col footers 1–5 (Hebr.11,6; Ex cod.cc; Dist.26 q.4; Sicut ostensum I Sent. d.17; Vers.8) belong to QUAESTIO III (a1-q3), NOT q2 — do NOT re-consume; they are a1-q3's first footer run.** **RECEIVED nothing** (clean seam, q1 closed on p.655); **FORWARDED nothing** (a1-q3 / QUAESTIO III opens fresh at raw 46035, foot of p.659 L-col). NO [?] flags. Marker pairing OK (28 La = 28 En = 28 defs). Commit ed43fc3 (chunk+content.json+paraphrase-audit) + this resume advance. Build **885 q / 717 translated** (+1). Audits: paraphrase **0 critical / 6 high** (all 6 = remaining unbuilt d.27 skeletons a1-q3, a2-q1…q3, dubia, dubia-dup2; a1-q2 now OK); header d.27 a1-q2 NOT flagged (single-quaestio calibration); apparatus 6 SKELETON-SUSPECT = the remaining unbuilt d.27 chunks (a1-q2 NOT flagged).
...
**TRACTATIO question-list (verbatim, 450 dpi):** Two principal Qs = the two articles — (ART. I) *Et primo quaeritur de gratia in comparatione ad alium habitum.* / (ART. II) *Secundo vero quaeritur de gratia in comparatione ad merendi exercitium.* ARTICULUS I three sub-Qs ("Circa primum quaeruntur tria"): (1) *Primo quaeritur de una differentia gratiae in comparatione ad aliam* = a1-q1 (*Utrum gratia gratum faciens dividi habeat per differentias essentialiter diversas*); (2) *Secundo vero quaeritur de ipsa gratia in comparatione ad virtutem gratuitam* = a1-q2; (3) *Tertio vero quaeritur de ipsa gratia in comparatione ad gloriam* = a1-q3. ARTICULUS II three-Q list ("Circa secundum…") prints at the ART II opener (raw ~46173) — record verbatim when a2-q1 is built.

---

## NEXT = `bon-sent-II-d27-a1-q3` — ARTICULUS I QUAESTIO III *de gratia in comparatione ad gloriam* (LAST q of ARTICULUS I). SKELETON exists. **QUAESTIO III header + body begin at raw 46035** (foot of p.659 L-col; opener "Tertio quaeritur de gratia in comparatione ad gloriam…", running head `DIST. XXVII. ART. I. QUAEST. III.`). **RECEIVED nothing** from a1-q2 (clean seam — q2's SCHOLION fully closes above the QUAEST III divider on p.659). **q1-q3 owns p.659 L-col footers 1–5 as its first footer run** (Hebr.11,6 → for arg "Hebr. 11, 6"; Ex cod.cc *supplevimus ad finem*; Dist.26 q.4 et praeced. in corp.; Sicut ostensum I Sent. d.17 p.I q.3; Vers.8) — these were verified at a1-q2 build as belonging to q3 and were NOT consumed there. Grep for ARTICULUS II opener (raw ~46173, three-Q list "Circa secundum…") to find q3's end. d.27 build order: littera DONE → divisio DONE → a1-q1 DONE → a1-q2 DONE → **a1-q3 → a2-q1…q3 → dubia (resolve dup2)**. ⚠ **`d27-dubia-dup2` (line_start 46814) STILL TO RESOLVE at d.27-dubia** (vs canonical d27-dubia line_start 46673). d.27→d.28 (DISTINCTIO XXVIII) at raw 46924.
