# Next session — **d25-p1-divisio DONE 2026-05-29 (REBUILT to Tier-2). Pars I COMMENTARIUS IN DISTINCTIONEM XXV + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM (ARTICULUS UNICUS 6-question list), pp. 591–592, 1 apparatus def [^1] (NOTAE AD COMMENTARIUM, variant removet/movet — hand-off received from d25-p2-littera), has_scholion=false. Next = `bon-sent-II-d25-p1-a1-q1` (ARTICULUS UNICUS QUAESTIO I; per Override §5 the short ARTICULUS UNICUS opener folds into a1-q1). QUAESTIO I begins p.592, raw ~41437: "Utrum liberum arbitrium sit in solis habentibus rationem, an etiam sit in animalibus brutis."**
>
...
> - **PARS I** (COMMENTARIUS at raw ~41383; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~41437), II (~41653), III (~41811), IV (~41986), V (~42150), VI (~42281) = **6 quaestiones**, then **DUBIA** (DUB. I ~42449; verify DUB count at PDF). EXISTING skeletons (all unbuilt, **NEXT to rebuild starting with divisio**): `d25-p1-divisio` (+stray `-dup2` to git rm), `d25-p1-a1-q1..q6` (q1/q2 each have stray `-dup2`), `d25-p1-dubia`.
> - **PARS II** (Pars II at raw ~42603; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~42641), II (~42801), III (~42903), IV (~43043), [q5 expected — verify], VI (~43375) = ~**6 quaestiones**, then **DUBIA** (DUB. I ~43695, DUB. II ~43728) = **2 DUB**. `d25-p2-littera` **DONE** (pp. 589–591). EXISTING skeletons: `d25-p2-divisio` (recovered 2026-05-29 from the mis-IDed `d25-p1-divisio-dup2`, raw 42608–42636), `d25-p2-a1-q3`, `d25-p2-a1-q4`, `d25-p2-a1-q6`, `d25-p2-dubia`. **MISSING:** `d25-p2-a1-q1`, `d25-p2-a1-q2`, `d25-p2-a1-q5`.
> - **⚠ DUP CLEANUP for d.25:** stray auto-chunker dups to `git rm` during the d.25 pass (verify byte-identical/lower-quality first): `d25-p1-a1-q1-dup2.md`, `d25-p1-a1-q2-dup2.md`. (`d25-p1-divisio-dup2.md` RESOLVED 2026-05-29 — was NOT a dup; renamed → `d25-p2-divisio.md`. **Re-verify the two remaining q-dups are true byte-near dups, not mis-IDed siblings, before git rm.**)
