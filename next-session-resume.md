...
- *Utrum luminaria habeant diversitatem perfectionum.*,
  pp. 357 (after q3 SCHOLION terminus at line 25253: ARTICULUS II
  opener *De luminaribus in comparatione ad ea, in quae agunt.* +
  sub-divisio *Et circa hoc quaeruntur tria* folded into q1 per
  locked Vol II convention; QUAESTIO I opener + Fundamenta args 1–4)
  → 358 (L+R full: Sed contra args 1–4 + Conclusio + Respondeo
  opener through Ratio 3 *materia* closing at *secundum diversum*
  before page break) → 359 (L mid → R mid: Ratio 3 close, Ratio 4
  *forma,* Concedendae conclusion, Solutio op. args 1, 2.3, 4
  through *complete salvatur,* then 3-section SCHOLION terminating
  immediately before QUAESTIO II opener at line 25397). 10 apparatus
  entries continuously renumbered: p. 357 footer notes 2–4 =
  [^1]–[^3] (note 1 = *Plures codd. et Vat. hunc.* already consumed
  by q3 [^19], verified no double-count; [^3] bundles the unnumbered
  *Ratio addita … Cfr. supra pag. 103, nota 3.* R-footer addendum
  with the numbered *Hoc arg. ponitur in libro de Causis* note 4 per
  Quaracchi shared-anchor practice at *specie* in arg 3); p. 358
  footer notes 1–5 = [^4]–[^8] (all anchor in q1 body); p. 359 footer
  notes 1–2 = [^9]–[^10] (Codd. ACO eius variant at Ratio 4 *cuius*
  + In Vat. additur variant at Solutio 4 *ad eas*). p. 359 footer
  note 3 (*Cap. 6, ubi textus originalis: Non usquequaque absurde*)
  hands forward to `d14-p2-a2-q2` (anchors at q2 arg 1 Augustine
  quote *quinto de Civitate Dei*, line 25404). 3-section SCHOLION
  preserved + translated; SCHOLION III is a *De praedictis q.*
  bibliography that handles the article-level commentator list (Alex.
  Hal., Scot., S. Thom., B. Albert., Petr. a Tar., Richard., Ægid.,
  Henr., Durand., Dionys., Biel). No `[?]` flags — all 10 anchors
  crisp at 450 dpi. Apparatus-count audit: q1 not flagged (raw=14
  chunk=10 diff=+4 — heuristic counts p. 359 footer note 3 which
  forwards to q2 plus 2-3 OCR noise opens). Paraphrase audit OK
  (Jaccard 0.60, length 0.19, no smell flag). Header audit clean.
  Build: 581 → 582 translated.

## Prior session (2026-05-24, latest)

Promoted `d14-p2-a1-q3` Tier-2 (manual-rescue):
- *Utrum conveniat alicui orbi moveri absque stellis.*,
  pp. 354 R bottom (QUAESTIO III opener after q2 Solutio op. close)
  → 355 (L+R full, Ad opp. arg 3 completes through Ad opp. arg 4 and
  Contra/Fundamenta args 1–4 and Quaestio incidens 1+2 and Conclusio
  and Respondeo opener) → 356 (L+R full, Sufficientia septenarii +
  II. Caelum proprie + Triplex numeratio + Sufficientia horum
  numerorum + 3-caeli/7-caeli/10-caeli reductio + Conclusio 2 +
  Solutio op. 1+2 opener) → 357 L+R top (Solutio op. 1+2 close,
  Ad 3, Ad 4 close, Ad ultima close, 2-section SCHOLION I+II
  terminating immediately before ARTICULUS II opener at line 25253).
  19 apparatus entries continuously renumbered: p. 354 footer notes
  3–5 = [^1]–[^3] (note 3 = the *Cfr. supra d. 2. p. II. a. 1. q. 1.*
  hand-off forwarded from q2, body-anchored at *uniformitatem* in
  Ad opp. arg 1); p. 355 footer notes 1–8 = [^4]–[^11]; p. 356 footer
  notes 1–7 = [^12]–[^18]; p. 357 footer note 1 = [^19] (*Plures codd.
  et Vat. hunc.*, anchored at *hunc* in Ad 4 close). p. 357 footer
  notes 2+ hand forward to `d14-p2-a2-q1` (anchors visibly in ART. II
  body immediately below the SCHOLION). 2-section SCHOLION preserved
  + translated: SCHOLION I treats q3 commentator list (Albert, Petr.
  Tar., Richard, S. Thom.); SCHOLION II is a *De numero caelorum*
  bibliography handling the incidental-question commentator list.
  No `[?]` flags — all 19 anchors crisp at 450 dpi. Apparatus-count
  audit: q3 not flagged (chunk=19 vs raw=20 diff=+1). Header audit
  clean for d.14. Paraphrase audit OK (Jaccard 0.67, length 0.19 —
  clean prose with literal English, no smell flag). Build: 580 → 581
  translated.
...
- `d14-p1-a1-q2` — *Utrum firmamentum sit idem cum ignis elemento,*
  pp.338–341, 2,201 Lat words, 29 apparatus continuously renumbered
  across pp.338–341 footers (p.338: 4 entries per the cross-chunk
  split convention; p.339: 12; p.340: 9; p.341: 4 closing with *Vide
  scholion ad praecedentem quaest.*), NO scholion (q1's Scholion III is
  the *pro quaest. seq.* forward-pointer per Vol II convention), 1 `[?]`
  flag clustering markers [^1][^2][^3] at end of *auctoritatem Scripturae*
  in arg 1 (in-line positions unrecoverable at 450 dpi). See chunk
  Notes for a discrepancy memo on the p.338 footer-split — only ⁴ is
  unambiguously q2; ¹ and ² also have valid anchors in q1's Corollarium
  body — to reconcile in the d.11–d.20 polish-blocker.

Build: 568 → 572 translated.
