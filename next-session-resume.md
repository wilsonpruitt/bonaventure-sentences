# Next session — **d24-p1-a2-q1 DONE 2026-05-29 → next action: dispatch `bon-sent-II-d24-p1-a2-q2` (ARTICULUS II QUAESTIO II *Utrum superior et inferior portio potentiarum sint diversae potentiae* [= *per portionem superiorem et inferiorem*]; skeleton, opens raw 39461 QUAESTIO II on p. 563). Hand-off RECEIVED from a2-q1: NONE (a2-q1's SCHOLION closes at the top of p.563 carrying no footers; the p.563 footers ¹–⁴+ [Cfr. I Sent. d.3 + Alex. Hal.; de Trin.; de Trin. XII; de Gen. contra Manich.] OPEN the a2-q2 footer sequence — a2-q2 must pick them up). Body opener: *Secundo quaeritur de illa divisione potentiarum animae, quae est per superiorem et inferiorem portionem; et est quaestio, utrum superior portio et inferior sint diversae potentiae* (raw 39463+, top of p.563 R-col). Extract pp.563-? crops as needed (`/tmp/colcrop/vol2-p563-*` cached for body+footers).**
> **ARTICULUS II = *De divisione potentiarum animae* (4 questions, all in Pars I); TRACTATIO (raw 39105–39130, verbatim): Primo *per cognitivam et affectivam, sive per rationem et voluntatem* (= a2-q1, DONE); Secundo *per portionem superiorem et inferiorem* (= a2-q2, NEXT); Tertio *per deliberativum et naturale* (= a2-q3); Quarto *per possibilem et agentem* (= a2-q4). NOTE: Pars II numbering (p2-a*, p2-dubia) is auto-chunk-suspect — re-chunk-verify before promoting Pars II. Stray dups still pending cleanup: `d24-p1-dubia-dup2` (apparatus audit flags it — git rm when its real chunk is promoted).**
