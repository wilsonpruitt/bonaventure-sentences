# Next session — **NEXT = `bon-sent-II-d30-a1-q2` (ARTICULUS I QUAESTIO II, DISTINCTIO XXX) — MUST BE CREATED (no skeleton; carved out of the mis-ranged a1-q1 skeleton).** d.30 = *De peccato originali, quomodo transit in posteros*. **QUAESTIO II title = *Utrum natura humana merito primae transgressionis fuerit corrupta poenaliter tantum, an etiam culpabiliter* (header raw 49998, p.717); q2 body opener *Secundo quaeritur, utrum merito primae transgressionis humana natura fuerit corrupta poenaliter tantum, an etiam culpabiliter* at raw 50001.** **q2 RAW RANGE = 49998 → just before ARTICULUS II at raw 50247 (a2-q1 boundary).** q2 spans pp. **717–721** (q2 opens on p.717 R foot below q1's SCHOLION; runs 718–721; ARTICULUS II *De quidditate originalis peccati* opens lower on p.721). **q2 structure (eyes-on the skeleton + 450 dpi):** 6 fundamenta (1 Rom.5,12 per-unum-hominem / 2 Ioan.3 renatus-ex-aqua / 3 si-tota-natura-in-una-persona / 4 venenato-fonte / 5 innocens-respectu-innocentis / 6 Adam-mortalis-genuit-mortales) + 6 Sed contra (1 Ezech.18 filius-non-portabit / 2 nuptiae-bonae / 3 corrupta-re-minus-nobili / 4 malum-habitum-praecedit-malus-actus / 5 nullum-naturale-culpabile / 6 nullum-necessarium-voluntarium) + Conclusio + Respondeo (triplex manifestatio: visionis-Dei-carentia / rationalis-erubescentia / concupiscentiae-praedominantia; then *a quo corrupta* = ab Adam, triplex conditio concurrens) + Ad 1–6. **has_scholion=TRUE** — q2 has its OWN SCHOLION I+II on p.721 (I = Conclusio de fide, Concil. Arausic.II + Trident., anti-Durand; II = q2 commentator-roll Alex.Hal/Scot/S.Thom/Albert/Petr.a.Tar/Richard/Aegid/Dionys/Biel). **q2 footers:** p.717 footer block from q2's fundam.1 downward (the first 3 p.717 footers = q1's Ad5/6, already taken by a1-q1 [^23]–[^25]) + pp.718–721 footer blocks. **NO cross-chunk hand-off RECEIVED into q2 beyond the footer-claim boundary** (a1-q1 took p.717 footers 1–3; q2 takes p.717 footers from fundam.1 onward). **After a1-q2: a2-q1** (ARTICULUS II *De quidditate originalis peccati*, opener *Consequenter quaeritur de secundo… quid sit originale peccatum*, q1 *utrum originale peccatum sit concupiscentia*, raw 50247). **d.30 remaining after a1-q2 = 4 units (NO dubia): ART II {a2-q1 + a2-q2} / ART III {a3-q1 + a3-q2}; DISTINCTIO XXXI at raw 51357.** **Skeletons present:** a2-q1, a2-q2, a3-q1, a3-q2 (a1-q2 still to be created). **Offset pdf = printed + 22.** **⚠ DECADE BOUNDARY: after d.30's last unit ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
