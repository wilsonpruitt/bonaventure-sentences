# Next session — **NEXT = `bon-sent-II-d30-a2-q1` (ARTICULUS II QUAESTIO I, DISTINCTIO XXX) — skeleton present, REBUILD from skeleton.** d.30 = *De peccato originali, quomodo transit in posteros*. **ARTICULUS II theme = *De quidditate originalis peccati* (header raw 50247, opens lower on p.721); opener *Consequenter quaeritur de secundo, videlicet quid sit originale peccatum. Et circa hoc duo quaeruntur.* Per Override §5 fold the short ART II opener into a2-q1.** **ART II TRACTATIO sub-question list (verbatim, verified raw 50253–50255):** q1 = *Primo quaeritur, utrum originale peccatum sit concupiscentia*; q2 = *Secundo quaeritur, utrum sit ignorantia*. **a2-q1 QUAESTIO I title = *Utrum peccatum originale sit concupiscentia* (header raw 50256); opener *Circa primum sic proceditur et quaeritur, utrum originale peccatum sit concupiscentia. Et quod sic, videtur* at raw 50258.** **a2-q1 RAW RANGE = 50247 (ART II header) → just before a2-q2 (raw TBD — grep next QUAEST II header).** a2-q1 opens on p.721; offset pdf = printed + 22 (p.721 = PDF 743). **Hand-off RECEIVED into a2-q1 = NONE** (a1-q2 closed clean at SCHOLION II end *…Biel, de hac et seqq. qq. hic q. 2.* immediately before ART II raw 50247; the p.721 SCHOLION carries no numbered footers; ART II opens fresh lower on p.721). Per SCHOLION I of a1-q2: *Essentia peccati originalis magis explicatur infra a. 2. q. I* — confirms a2-q1 is the substance-of-original-sin question. **d.30 remaining after a2-q1 = 3 units (NO dubia): a2-q2 (utrum sit ignorantia) / ART III {a3-q1 + a3-q2}; DISTINCTIO XXXI at raw 51357.** **Skeletons present:** a2-q1, a2-q2, a3-q1, a3-q2. **Offset pdf = printed + 22.** **⚠ DECADE BOUNDARY: after d.30's last unit ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
