# Next session — **d25-p1-a1-q5 DONE 2026-05-29 (REBUILT to Tier-2). ARTICULUS UNICUS QUAESTIO V "Utrum liberum arbitrium addat aliquid supra rationem et voluntatem", pp. 602–604, 15 apparatus entries (p.602 footers 4–7 → [^1]–[^4] RECEIVED via hand-off from a1-q4; p.603 footers 1–8 → [^5]–[^12]; p.604 footers 1–3 → [^13]–[^15]). has_scholion=FALSE (the article's commentator-roll scholion is held under a1-q4 SCHOLION I–III; q4's SCHOLION II/III forward-point to q5). Alignment confirmed (opener "Quinto quaeritur, utrum liberum arbitrium aliquid addat supra rationem et voluntatem" = sub-q 5; boundary to QUAESTIO VI at raw ~42281, p.604). Respondeo three-modes passage was OCR-cascade-shattered → re-set from 450 dpi PDF column bands per Vol II override. RECEIVED from q4: p.602 footers 4–7 (Quaest.praeced./Aug.83Qq major-minor note; Cfr.pag.600 n.8; ostensum supra q.3 ad 1; In hac determinatione/Aristot. II Ethic.) → q5 [^1]–[^4]. FORWARDED to q6: p.604 footers 4–8 (habitualis cross-refs, Aristot. Polit./Ethic., Boethius "liberum de voluntate iudicium" definition, "quam penes voluntatem" variant, "infra p.II huius dist.") belong to q6's body. Commit a87d058 (chunk+content.json) + this resume advance. Build 885 q / 694 translated. Audits: q5 clean (dropped off apparatus-flag list — 15 entries; out of paraphrase HIGH bucket); remaining d.25 flags are pre-existing unbuilt skeletons (9 HIGH paraphrase, header Q-LOSS now from unbuilt q6+dubia, apparatus SKELETON/INCOMPLETE-SUSPECT = p1-a1-q6 + p1-dubia + p2 siblings). Next = `bon-sent-II-d25-p1-a1-q6` (ARTICULUS UNICUS QUAESTIO VI "Utrum liberi arbitrii facultas insit principalius rationi, an voluntati"; SKELETON exists; LAST quaestio of Pars I ART UNICUS → Pars I DUBIA follows; opens raw ~42281, p.604, "Sexto et ultimo est quaestio, cum liberum arbitrium sit habitus sive facultas residens penes rationem et voluntatem coniunctim; penes quam istarum potentiarum principalius nobis insit"). ⚠ q6 RECEIVES the forwarded p.604 footers 4–8 (q6 source/variant notes — habitualis, Aristot. Polit./Ethic., Boethii definitio, voluntatem variant); q6 body runs p.604 into following pages — verify span at PDF + grep for the Pars I DUBIA boundary (DUB. I ~42449).**
>
