# Next session — **`d31-divisio` DONE 2026-05-30 (Tier-2, commit `7153783`). NEXT ACTION = dispatch `bon-sent-II-d31-a1-q1`** (ARTICULUS I QUAESTIO I, opens raw 51575/51577 / p.740 head; offset pdf=printed+22). **ARTICULUS I theme = *Utrum originale peccatum traducatur mediante sensibili portione* (raw 51577); per Override §5 the short ART I opener folds into a1-q1.** **ALIGNMENT CHECK for a1-q1:** ART I TRACTATIO (from the divisio, verbatim) lists **q1 = *Primo quaeritur, utrum sensibilis anima in hominibus sit a generante*** (= QUAESTIO I, raw 51582) / q2 = *Secundo quaeritur, cui parti animae primo insit peccatum originale* / q3 = *Tertio quaeritur, utrum per originale maior fiat in nobis corruptio generativae quam alterius potentiae*. STOP/report if the a1-q1 opener does not match q1. ARTICULUS II theme = *Utrum traduci habeat mediante carne* (its three quaestiones print at the ART II opener, not in the divisio TRACTATIO; raw header scan shows ART II also has QUAESTIO I/II/III). d.31 remaining skeletons after divisio: d31-a1-q1/q2/q3, d31-a2-q1/q2/q3, d31-dubia.
