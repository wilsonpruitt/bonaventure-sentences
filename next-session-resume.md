...
**NEXT = `bon-sent-II-d29-divisio`** (COMMENTARIUS IN DISTINCTIONEM XXIX + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM — skeleton, `auto-chunked 2026-05-13`. **SECOND unit of d.29.**). **COMMENTARIUS begins at raw 48383** (full-width header `COMMENTARIUS IN DISTINCTIONEM XXIX`, immediately after the littera closes at foot of p.693 R "…quibus nomina imposuit."); **DIVISIO TEXTUS at raw 48388**, **TRACTATIO QUAESTIONUM at raw 48403**, **QUAESTIO I at raw 48417**. Likely opens p.694; offset +22. **d.29 = DISTINCTIO XXIX** (raw **48282** → DISTINCTIO XXX at raw **49478**), theme *Utrum homo ante peccatum eguerit gratia operante et cooperante* (cap. I) — **the original-justice / pre-lapsarian-virtue distinction.** **d.29 structure** (littera ✅ DONE; remaining 9 chunks are auto-chunked skeletons): **divisio** = DIVISIO TEXTUS + TRACTATIO QUAESTIONUM (raw 48383–48416, NEXT) → **ARTICULUS I** q1 (raw 48417) / q2 (raw 48624) → **ARTICULUS II** q1 (raw 48787) / q2 (raw 48957) → **ARTICULUS III** q1 (raw 49088) / q2 (raw 49214) → **dubia** (raw 49356) + **dubia-dup2** (raw 49404, likely another over-range dup to merge/`git rm` at the d.29 dubia build — INSPECT first, like the d.28 dubia-dup2 pattern). Single-pars distinction (no p1/p2). Offset +22. **DISTINCTIO XXX boundary at raw 49478.** **Decade-polish gate:** d.29 is NOT a decade boundary (next polish-blocker is after d.30 ships — d.21–d.30 pass). Proceed straight to d.29 divisio.
