...
**NEXT = `bon-sent-II-d29-a2-q2`** (ARTICULUS II QUAESTIO II *Utrum homo simul tempore conditus fuerit in gratuitis et naturalibus* — skeleton, `auto-chunked 2026-05-13`. **SIXTH unit of d.29; second/last quaestio of ARTICULUS II.**). **QUAESTIO II opener at raw 48957** (p.702, header *QUAESTIO II. Utrum homo simul tempore conditus fuerit in gratuitis et naturalibus*; opener *Secundo quaeritur, utrum homo simul tempore conditus fuerit in gratuitis et naturalibus. Et quod sic, videtur* — arg1 *Per textum Genesis primo: Faciamus hominem ad imaginem…*). **VERIFY alignment:** confirm the q2 opener matches ART II TRACTATIO item 2 (*utrum simul tempore conditus fuerit in gratuitis et naturalibus*) before promoting. **RECEIVES from a2-q1:** the SCHOLION **sibling-pointer** — a2-q1's joint SCHOLION I–IV (*Utramque huius articuli quaest.* / *Quoad hanc (1.) quaest.* / *In solvenda altera (2.) quaest.* / *De utraque quaest.*) IS the commentator-roll for BOTH q1 and q2, physically at a2-q1's tail on p.702 → **set a2-q2 has_scholion=false and point its scholion note at a2-q1** (same pattern as a1-q1/q2 + d.21-a2). No body-footer hand-off received (a2-q1's [^16] closed Ad5 on p.701). Grep raw 48957 onward for the q2 body + p.702–703+ footers + the ARTICULUS III boundary (header raw 49080, theme *De quantitate gratiae in statu innocentiae*). Offset +22. **d.29 = DISTINCTIO XXIX** (raw **48282** → DISTINCTIO XXX at raw **49478**), theme *De gratia secundum statum naturae institutae* — **the original-justice / pre-lapsarian-grace distinction. 3 articles = 3 principal questions** (ART I necessity of grace / ART II whether grace was had before sin / ART III quantity of grace), each with 2 sub-questions. **d.29 structure** (littera ✅ DONE, divisio ✅ DONE, a1-q1 ✅ DONE, a1-q2 ✅ DONE; remaining 6 chunks are auto-chunked skeletons): **ARTICULUS I** q1 ✅ (raw 48417) / q2 ✅ (raw 48624) → **ARTICULUS II** (folded opener into a2-q1, theme *De gratia ante peccatum habita*; TRACTATIO: q1 *utrum habuerit gratiam ante lapsum* / q2 *utrum simul tempore conditus fuerit in gratuitis et naturalibus*) q1 ✅ (raw 48787, *Utrum homo ante lapsum habuerit gratiam gratum facientem*, holds joint SCHOLION I–IV) / q2 (raw 48957, NEXT, QUAESTIO II *Utrum homo simul tempore conditus fuerit in gratuitis et naturalibus*, sibling-points to a2-q1 scholion) → **ARTICULUS III** (header raw 49080, theme *De quantitate gratiae in statu innocentiae*; opener *quantam gratiam primus homo habuerit* → q1 *quantum ad donorum multitudinem*, q2 *quantum ad donorum magnitudinem*) q1 (raw ~49088, QUAESTIO I *Utrum homo habuerit tot virtutes ante lapsum, quot habuit post lapsum*) / q2 (raw 49214) → **dubia** (raw ~49356) + **dubia-dup2** (raw ~49404, likely another over-range dup to merge/`git rm` at the d.29 dubia build — INSPECT first, like the d.28 dubia-dup2 pattern). Single-pars distinction (no p1/p2). Offset +22. **DISTINCTIO XXX boundary at raw 49478.** **Decade-polish gate:** d.29 is NOT a decade boundary (next polish-blocker is after d.30 ships — d.21–d.30 pass). Proceed straight to d.29 a2-q2.
