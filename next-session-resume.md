# Next session — **NEXT = `bon-sent-II-d29-dubia` (DUBIA CIRCA LITTERAM MAGISTRI).** DUBIA opens raw **49354** (*DUBIA CIRCA LITTERAM MAGISTRI*), bodies begin p.708 bottom, span pp.708–709 (PDF 730–731, offset +22). **4 dubia:** DUB. I (raw 49356, *Adam non tunc habuisse virtutes, quando peccavit* — distinguishes inchoatio vs consummatio peccati; iuxta hoc: utrum sapiens vel stultus), DUB. II (raw ~49368, *Nunc ergo, ne forte mittat manum suam et sumat de ligno vitae* — verbum rigoris/misericordiae; Alia solutio), DUB. III (raw 49427, *paradisus Ecclesiae* / lignum vitae locus), DUB. IV (raw 49427 R-col, *ad quaestionem* — utility of the question). DUBIA ends before DISTINCTIO XXX raw **49478**. **Strays to resolve:** `bon-sent-II-d29-dubia` (skeleton) + `bon-sent-II-d29-dubia-dup2` (stray dup, apparatus-audit SKELETON-SUSPECT raw=19 — resolve/delete one). **Hand-off RECEIVED from a3-q2:** p.708 footer block is SHARED — footers **1** (*Cfr. supra dist. 23. a. 2. q. 3. ad 4*) + **2** (*Vide scholion ad praecedentem quaest.*) are a3-q2's tail (captured there as [^17]/[^18]); the dubia claims **only p.708 footers 3+** (3 *Codd. Y aa addunt sed causa* / 4 *Dist. 17. p.I. a.2. q.I. seqq.* = DUB I / 5 Gen.2,17 = DUB II / 6 Vide August.VIII de Gen.ad lit. = DUB II) **plus** p.709's full footer block. Do NOT re-claim p.708 footers 1–2. **DISTINCTIO XXIX structure (8 units, all Tier-2):** littera / divisio / a1-q1 / a1-q2 / a2-q1 / a2-q2 / a3-q1 / **a3-q2 (DONE this session)** → next = dubia (9th unit, closes d.29). **DISTINCTIO XXX boundary raw 49478.**
