# Next session — **d25-p1-a1-q3 DONE 2026-05-29 (REBUILT to Tier-2). ARTICULUS UNICUS QUAESTIO III "Utrum liberum arbitrium complectatur simul rationem et voluntatem", pp. 597–600, 26 apparatus entries (p.597 footers 1–6 → [^1]–[^6]; p.598 footers 1–12 → [^7]–[^18]; p.599 footers 1–5 → [^19]–[^23]; p.600 q3-portion footers 1–3 → [^24]–[^26]). has_scholion=FALSE — q3 has no own scholion; body ends "Et sic patent obiecta" then QUAESTIO IV; p.600 footer [^26] "Vide scholion ad praecedentem quaest." defers q3's commentator-roll to q2's SCHOLION (deferral, not dropout). RECEIVED from q2: the p.597 footer-1 *quod faciat*/*ipsum→ipsam* variant tail → [^1] (q2 kept the "Hic q.5" infra-pointer head as its [^15]). FORWARDED to q4: the p.600 footer sequence from footnote 4 onward (Anselm/Augustine q4 source-notes); q4 opens raw ~41992 "Quarto quaeritur, utrum liberum arbitrium complectatur rationem et voluntatem per modum potentiae, an per modum habitus". Commit b29edbc (chunk+content.json) + this resume advance. Build 885 q / 692 translated. Audits: q3 clean (not flagged); remaining d.25 flags are pre-existing unbuilt skeletons (11 HIGH paraphrase, header Q-LOSS, apparatus SKELETON/INCOMPLETE-SUSPECT = p1-a1-q4/q5/q6 + p1-dubia + p2 siblings). Next = `bon-sent-II-d25-p1-a1-q4` (ARTICULUS UNICUS QUAESTIO IV "Utrum liberum arbitrium sit nomen habitus, vel potentiae" / per modum potentiae an per modum habitus; SKELETON exists; opens raw ~41992, p.600).**
>
