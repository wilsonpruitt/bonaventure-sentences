...
> ## ▶▶ **NEXT CHUNK = `bon-itin-c2`** (division 2, `capitulum: 2`, index claims pp. 299–303 — **a claim, not a span; close the end positively on the `Cap. III.` heading**). **Hand-off it inherits from `bon-itin-c1` — re-derive every item, do not adopt:**
