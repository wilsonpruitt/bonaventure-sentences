...
>
> **Hand-off `bon-itin-scholion` inherits from `bon-itin-c7` — re-derive it, do not adopt it:**
> - **★★ IT INHERITS NO APPARATUS FROM p. 313. ALL SIX of that page's footer notes are Cap. VII's** — every one answers to a Cap. VII anchor (nn. 1–3 in § 5's Dionysian quotation, LEFT column; nn. 4–6 in § 6, RIGHT) — **and the Scholion's own text carries NO footnote anchors on p. 313 at all**, citing its authorities inline instead (*supra pag. 47*, the 1883 Collegio S. Bonaventurae edition). **A reader dividing the register by where the text sits on the page would take three notes that are not his.** ⚠ **Whether the no-anchors fact holds on pp. 314–316 is UNVERIFIED — check each leaf's footer against the Scholion's text rather than assuming it.**
> - **★★ TAKE p. 313's GUTTER AS 1161 FOR THE SCHOLION REGION, NOT 1166.** The page has **two** (see the region rule below); 1166 is Cap. VII's and 1161 is the Scholion's. On pp. 314–316 the Scholion is probably the only region, in which case the page value *is* the region value — **but profile per region to find that out, don't assume it.**
> - **`KNOWN_TOTALS` is fed through p. 313** (six notes). pp. 314–316 are unread.
> - **The Scholion region carries NO marginalia** on p. 313.
> - **⚠ Do NOT re-log p. 312 n. 6 or p. 313 n. 3** — both are in the ledger under `bon-itin-c7`.
> - **The `## Notes` will need the work-close hand-off**: after the scholion, the work is finished and **the polish gate + the deploy boundary both fall at p. 316** (see the cadence line below).
>
