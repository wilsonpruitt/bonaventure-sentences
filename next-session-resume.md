# Next session — **d25-p1-a1-q1 DONE 2026-05-29 (REBUILT to Tier-2). ARTICULUS UNICUS QUAESTIO I "Utrum liberum arbitrium sit in solis habentibus rationem et voluntatem", pp. 592–594, 20 apparatus entries (p.592 footers 1–8 → [^1]–[^8]; p.593 footers 1–7 → [^9]–[^15]; p.594 footers 1–5 → [^16]–[^20]), has_scholion=true (SCHOLION I–III). ARTICULUS UNICUS opener + TRACTATIO 6-question list folded into q1 per Override §5. No hand-offs received/forwarded; q2 opens on a fresh footer sequence. ⚠ DUP RESOLUTION: the stray `d25-p1-a1-q1-dup2.md` was NOT a dup — its body (raw 42641, "Utrum liberum arbitrium sit aeque in omnibus") is the genuine Pars II QUAESTIO I, previously MISSING. Renamed → `d25-p2-a1-q1.md` (id+pars corrected, still skeleton). d25-p2-a1-q1 is no longer missing. Commit 3d0b106 (chunk+content.json+rename) + this resume advance. Build 885 q / 690 translated. Next = `bon-sent-II-d25-p1-a1-q2` (ARTICULUS UNICUS QUAESTIO II "Utrum liberum arbitrium sit potentia distincta a ratione et voluntate"; opens raw ~41654, p.594). ⚠ git rm the stray `d25-p1-a1-q2-dup2.md` during that pass (re-verify it is a true byte-near dup, NOT a mis-IDed Pars II sibling, before git rm — the q1-dup2 turned out to be a real p2 sibling).**
>
...
> - **PARS I** (COMMENTARIUS at raw ~41383; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~41437), II (~41653), III (~41811), IV (~41986), V (~42150), VI (~42281) = **6 quaestiones**, then **DUBIA** (DUB. I ~42449; verify DUB count at PDF). Built so far: `d25-p1-divisio` **DONE**, `d25-p1-a1-q1` **DONE** (2026-05-29). EXISTING skeletons (unbuilt): `d25-p1-a1-q2..q6` (q2 still has stray `-dup2` to verify+git rm), `d25-p1-dubia`. (q1's `-dup2` RESOLVED → renamed to `d25-p2-a1-q1`.)
> - **PARS II** (Pars II at raw ~42603; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~42641), II (~42801), III (~42903), IV (~43043), [q5 expected — verify], VI (~43375) = ~**6 quaestiones**, then **DUBIA** (DUB. I ~43695, DUB. II ~43728) = **2 DUB**. `d25-p2-littera` **DONE** (pp. 589–591). EXISTING skeletons: `d25-p2-divisio` (recovered 2026-05-29 from the mis-IDed `d25-p1-divisio-dup2`, raw 42608–42636), `d25-p2-a1-q1` (recovered 2026-05-29 from the mis-IDed `d25-p1-a1-q1-dup2`, raw 42641–42800), `d25-p2-a1-q3`, `d25-p2-a1-q4`, `d25-p2-a1-q6`, `d25-p2-dubia`. **MISSING:** `d25-p2-a1-q2`, `d25-p2-a1-q5`.
> - **⚠ DUP CLEANUP for d.25:** remaining stray to handle during the d.25 pass: `d25-p1-a1-q2-dup2.md`. (`d25-p1-divisio-dup2.md` RESOLVED 2026-05-29 — renamed → `d25-p2-divisio.md`; `d25-p1-a1-q1-dup2.md` RESOLVED 2026-05-29 — was NOT a dup, was the genuine Pars II q1, renamed → `d25-p2-a1-q1.md`.) **Re-verify the remaining `d25-p1-a1-q2-dup2` is a true byte-near dup, not a mis-IDed Pars II sibling, before git rm — both prior "dups" turned out to be real p2 siblings.**
