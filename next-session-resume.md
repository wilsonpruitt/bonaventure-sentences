# Next session — **`d31-littera` DONE 2026-05-30 (Tier-2, commit `af38e1f`). NEXT ACTION = dispatch `bon-sent-II-d30-dubia` — the octo-nominibus DUBIUM CIRCA LITTERAM MAGISTRI of DISTINCTIO XXX** (raw 51367–51383, p.737 L-col TOP band, BEFORE the second DISTINCTIO XXXI header; offset pdf=printed+22). It is d.30's *dubium circa litteram* (references d.30 c.8 *Nunc superest videre… octo nominibus*: originale-peccatum / lex-carnis / concupiscibilitas / concupiscentia / fomes / lex-membrorum / languor-naturae / tyrannus), NOT an opener of d.31. **Picks up p.737 L-col footers 2–5** = the forwarded 3–5 from d30-a3-q2 (f3 *Cap.8* octo-nominibus / f4 *inclinatur* / f5 *De-hoc-dubio Alex.Hal.*) **plus f2 *Vide scholion ad praecedentem quaest.*** After it: `bon-sent-II-d31-divisio` (COMMENTARIUS IN DISTINCTIONEM XXXI, opens raw 51530 / p.739 L-col).
