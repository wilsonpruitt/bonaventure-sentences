# Next session — **d25-p2-littera DONE 2026-05-29 (NEWLY CREATED — auto-chunker omitted). Littera Magistri, Distinctio XXV Pars II, Cap. V–IX (de libero arbitrio), pp. 589–591, 16 apparatus defs [^1]–[^16], has_scholion=false. Next = `bon-sent-II-d25-p1-divisio` (PARS I COMMENTARIUS + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM; SKELETON exists + stray `d25-p1-divisio-dup2` to git rm).**
>
...
> - **PARS II** (Pars II at raw ~42603; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~42641), II (~42801), III (~42903), IV (~43043), [q5 expected — verify], VI (~43375) = ~**6 quaestiones**, then **DUBIA** (DUB. I ~43695, DUB. II ~43728) = **2 DUB**. `d25-p2-littera` **DONE** (pp. 589–591). EXISTING skeletons: `d25-p2-a1-q3`, `d25-p2-a1-q4`, `d25-p2-a1-q6`, `d25-p2-dubia`. **MISSING:** `d25-p2-divisio`, `d25-p2-a1-q1`, `d25-p2-a1-q2`, `d25-p2-a1-q5`.
> - **⚠ DUP CLEANUP for d.25:** stray auto-chunker dups to `git rm` during the d.25 pass (verify byte-identical/lower-quality first): `d25-p1-a1-q1-dup2.md`, `d25-p1-a1-q2-dup2.md`, `d25-p1-divisio-dup2.md`.
