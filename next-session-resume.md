# Next session — **d24-p2-a3-q1 DONE 2026-05-29 (EXISTING skeleton rebuilt to Tier-2; commit `3e5dab7`). ARTICULUS III opener + TRACTATIO folded + QUAESTIO I. Next action: dispatch `bon-sent-II-d24-p2-a3-q2` (EXISTING skeleton — rebuild). LAST quaestio of d.24 Pars II ARTICULUS III → Pars II DUBIA (`p2-dubia`, skeleton) follows. ART III QUAESTIO II *Utrum in sensualitate possit esse mortale [peccatum]* — body opener at raw 40952 (header `QUAESTIO II. Utrum in sensualitate possit esse mortale peccatum`), opens on p.585 (PDF 607, +22) fresh with its own footer set (no hand-off received from a3-q1 — a3-q1 closed after SCHOLION II on p.584). Runs to where Pars II DUBIA begins (`DUBIA CIRCA…`, raw ~41032). Verify the *Secundo quaeritur, utrum in sensualitate possit esse mortale* opener alignment against TRACTATIO sub-q2. HAND-OFF RECEIVED from a3-q1: NONE. Use `vol2/bon-sent-II-d24-p2-a3-q1.md` as the structural template (it carries the ART III opener/TRACTATIO; q2 needs no opener fold).**
>
...
>
> **CORRECTED PARS II BUILD ORDER (after a3-q1 done): p2-divisio ✓ → p2-a1-q1 ✓ → p2-a1-q2 ✓ → p2-a2-q1 ✓ → p2-a2-q2 ✓ → p2-a3-q1 ✓ → p2-a3-q2 (skel, rebuild, NEXT) → p2-dubia (skel, rebuild).** EXISTING skeletons to rebuild: `d24-p2-a3-q2` (NEXT), `d24-p2-dubia`.
