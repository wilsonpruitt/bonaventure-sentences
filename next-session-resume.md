# Next session — **d24-p2-a1-q2 DONE 2026-05-29 (NEW chunk created — auto-chunker dropped it; commit `880c8c6`). LAST quaestio of Pars II ART I. Next action: dispatch `bon-sent-II-d24-p2-a2-q1` (MUST BE CREATED — auto-chunker dropped it). ARTICULUS II opener *Circa secundum principale, scilicet quo quaeritur, quomodo peccatum habeat fieri et esse in inferiori parte rationis, quaeruntur duo* (raw 40432, p.577) + QUAESTIO I *Utrum aliquod peccatum habeat esse in inferiori parte rationis absque sensualitate* opens raw 40437/40439 (PDF 599, +22), body opener *Circa primum sic proceditur et ostenditur, quod nullum peccatum possit esse in inferiori parte rationis absque sensualitate* (raw 40441). Per Override §5 the short ART II opener ("…quaeruntur duo") FOLDS into a2-q1 — no standalone a2-divisio chunk. FULL quaestio (args + Sed contra + CONCLUSIO + Respondeo), spanning pp.577–~579 to where QUAESTIO II opener (*Secundo quaeritur, utrum peccatum mortale possit esse in ea parte rationis, superiori non peccante*, raw 40433/40582) begins. Verify the body opener alignment (*Circa primum… absque sensualitate*). HAND-OFF RECEIVED from a1-q2: p.577 footers ⁵–⁷ migrate to a2-q1's body (⁵ *rationis* supplet → ART II q1 arg; ⁶ Libr II de Trin c.14 n.21 / *aliud* omittunt; ⁷ Vat. *sensualis* var.) — these anchor in the ART II q1 body that opens on p.577 below a1-q2; lead the a2-q1 apparatus with them. Use `vol2/bon-sent-II-d24-p2-a1-q1.md` or `a1-q2.md` as the structural template.**
>
...
>
> **CORRECTED PARS II BUILD ORDER (after a1-q2 done): p2-divisio ✓ → p2-a1-q1 ✓ → p2-a1-q2 ✓ → p2-a2-q1 (NEW, NEXT) → p2-a2-q2 (skel, rebuild) → p2-a3-q1 (skel, rebuild) → p2-a3-q2 (skel, rebuild) → p2-dubia (skel, rebuild).** MISSING (auto-chunker gaps, must be CREATED): `d24-p2-a2-q1` (NEXT). EXISTING skeletons to rebuild: `d24-p2-a2-q2`, `d24-p2-a3-q1`, `d24-p2-a3-q2`, `d24-p2-dubia`.
