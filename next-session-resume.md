...
## NEXT = `bon-sent-II-d27-a2-q1` — ARTICULUS II QUAESTIO I *Utrum per gratiam contingat mereri ipsum gratiae donum iam habitum* (*de gratia in comparatione ad meriti exercitium*; ART II = FIRST q of ART II). SKELETON exists. Per **Override §5** the ART II opener (*Consequenter quaeritur… Et circa hoc quaeruntur tria*, raw ~46165, p.661) + the TRACTATIO 3-q list FOLD INTO a2-q1 — no standalone divisio chunk. **ART II three-Q list (verbatim, see TRACTATIO note above):** (1) *utrum per gratiam contingat mereri ipsum gratiae donum* = a2-q1; (2) *utrum contingat mereri gratiae augmentum* = a2-q2; (3) *utrum per gratiam contingat mereri ipsius gratiae complementum, videlicet gloriae praemium* = a2-q3. **QUAESTIO I body begins raw ~46177** (p.661 R-col foot, opener "Circa primum sic proceditur et quaeritur, utrum per gratiam contingat mereri ipsum gratiae donum iam habitum"). **RECEIVED from a1-q3: the ARTICULUS II opener + p.661 footers 3+ (ART II Q I footer run: footer 3 *augmentum* variant, footer 4 *strenuus*; footers 1–2 = d.26/cognitione were q3's, already consumed there). Lead a2-q1 apparatus with p.661 footers 3+.** Grep for QUAESTIO II opener (a2-q2 = *mereri gratiae augmentum*) to find a2-q1's end. d.27 build order: littera DONE → divisio DONE → a1-q1 DONE → a1-q2 DONE → a1-q3 DONE → **a2-q1 → a2-q2 → a2-q3 → dubia (resolve dup2)**. ⚠ **`d27-dubia-dup2` (line_start 46814) STILL TO RESOLVE at d.27-dubia** (vs canonical d27-dubia line_start 46673). d.27→d.28 (DISTINCTIO XXVIII) at raw 46924.
