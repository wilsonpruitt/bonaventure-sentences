# Next session — **DISTINCTIO XXXIII a3-q1 now Tier-2** (2026-05-30 — `bon-sent-II-d33-a3-q1`, ART III *De poena peccati originalis*, QUAEST I *Utrum parvuli decedentes in solo originali puniantur poena ignis materialis*, commit `77b5ac3`; range raw 55221–55414, **printed pp.792–795** (PDF 814–817), **19 apparatus entries** [p.792 footer 8 `adiicit Dei` received from a2-q2 → ^1; p.793 footers 1–8 → ^2–^9; p.794 footers 1–9 → ^10–^18; p.795 footer 1 → ^19]; **has_scholion=TRUE** (items I–II, article-level, cover BOTH questions per Override §5). **Alignment CONFIRMED** (`Circa primum sic proceditur et quaeritur, utrum parvuli decedentes in solo originali puniantur poena ignis materialis. Et quod sic, videtur.`). **CORRECTION to prior brief:** the a2-q2 chunk had already claimed p.792 footers 1–7 (Gen 2,24; d.26; Cap 3 seq pag 722; Epist 187 ad Dardanum; + 5–7) as its own [^12]–[^18] anchored in its Solutio 5 body — so ONLY p.792 footer 8 (`adiicit Dei`) was genuinely forwarded to a3-q1 (verified against a2-q2 `## Notes`). ART III opener folded into a3-q1 per Override §5. **NEXT ACTION = dispatch `bon-sent-II-d33-a3-q2`** (ARTICULUS III, QUAESTIO II = *Utrum parvuli decedentes in solo originali puniantur aliquo dolore interiore*). **d.33-a3-q2 range:** QUAESTIO II header raw **≈55418** (opener `Secundo quaeritur, utrum parvuli decedentes in solo originali puniantur aliquo dolore interiori. Et quod sic, videtur:`) → ends at raw **≈55585**, immediately before `DUBIA CIRCA LITTERAM MAGISTRI. / DUB. I.` (raw **55586**, opener `In parte ista sunt quaestiones circa litteram…`). **Printed page:** q2 opens p.795 R-col lower (running head `DIST. XXXIII. ART. III. QUAEST. II.`), runs onward (verify span via running heads — likely pp.795–796/797). **VERIFY the Secundo-quaeritur alignment at promotion.** **HAND-OFF into d33-a3-q2 (from a3-q1):** the p.795 footer block BELOW footer 1 — footer 2 = `Adhort. I. ad Theodorum lapsum, n. 9: A tantis autem excidisse bonis tantum infert doloris…` (← q2 arg 1 *Ioannis Chrysostomi*), plus the rest of p.795's footers — is forwarded to a3-q2; a3-q1 claimed only p.795 footer 1 (`Codd. F1KLO… impassibilitatem`). q2 likely **has_scholion=FALSE** (article scholion held in a3-q1 covers both). Template = `vol2/bon-sent-II-d32-a1-q1.md` (quaestio) / `d33-a3-q1.md` (just-completed; article scholion held in the FIRST question). After a3-q2, the remaining d.33 units are **divisio** + **littera** + **dubia** (DUB. I–III, raw 55586+). **No decade polish until d.40.**
