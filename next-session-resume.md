# Next session — **d25-p1-littera DONE 2026-05-29 (NEWLY CREATED — auto-chunker omitted). Littera Magistri, Distinctio XXV Pars I, Cap. I–IV (de libero arbitrio), pp. 588–589, 7 apparatus defs [^1]–[^7], has_scholion=false. Next = `bon-sent-II-d25-p2-littera` (Lombard Cap. V–IX, Pars II, MISSING — create fresh next).**
>
> **d25-p1-littera verification:** Cap. boundaries confirmed at 450 dpi — Pars I = Cap. I (*Definitio liberi arbitrii secundum philosophos*), II (*Qualiter in Deo accipitur liberum arbitrium*), III (*Quod Angeli et Sancti habent liberum arbitrium*), IV (*Quod liberius erit liberum arbitrium, quando peccare non poterit*). Cap. IV ends "…quod ex ratione decreverit." just before Cap. V (which opens **Pars II**). Apparatus [^1]–[^6] = p.588 NOTAE AD LIBR. SENTENTIARUM footers 1–6; [^7] = p.589 Ioan.8,34 serving Cap. IV. The p.588 body footers 1–2 (Psalm 48,13; *sacrae Scripturae*) confirmed owned by d24-p2-dubia [^16]. Build 884 q / 687 translated. Paraphrase/header/apparatus audits: only pre-existing d.25 skeleton flags (15 high paraphrase = unbuilt q1–q6/dubia/divisio + dups; littera does not flag).
>
> ## NEXT TARGET = **`bon-sent-II-d25-p2-littera`** (MISSING — must be CREATED). Lombard Cap. V–IX, Pars II. **Pars II littera begins at raw ~41228** (the "Pars It" header at raw line ~41229 / printed p.589 mid-L-column, "Cap. V. *De differentia libertatis arbitrii secundum diversa tempora*"). Use `d24-p1-littera` or this `d25-p1-littera` as template. Pars II caps span pp. 589–590(–591); the COMMENTARIUS IN DISTINCTIONEM XXV (Pars I) opens at raw ~41383 (printed p.591, "DIST. XXV. P. I. DIVISIO TEXTUS" running head). **Hand-off TO d25-p2-littera:** p.589 footers 2–5 (Ita in codd. *plene*; Luc. 10,30 + Ambr./Beda; Cap. 30 n.9; Bernard. de Gratia et lib. arbitrio c.3 n.7) + Hugone source-note tail of p.589 footer ¹ serve Cap. V–VIII and start its apparatus.
>
...
> - **LITTERA (Lombard):** Pars I = Cap. I–IV (**DONE** = `d25-p1-littera`); Pars II = Cap. V–IX ("Pars II" / DIST. XXV. P. II at raw ~41210–41228). ⇒ remaining **`d25-p2-littera`** (caps V–IX, **MISSING**). Note: Cap. IX heading appears at raw ~41369; verify Pars II littera ends before the Pars I COMMENTARIUS (raw ~41383).
> - **PARS I** (COMMENTARIUS at raw ~41383; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~41437), II (~41653), III (~41811), IV (~41986), V (~42150), VI (~42281) = **6 quaestiones**, then **DUBIA** (DUB. I ~42449; verify DUB count at PDF). EXISTING skeletons: `d25-p1-divisio` (+stray `-dup2`), `d25-p1-a1-q1..q6` (q1/q2 each have stray `-dup2`), `d25-p1-dubia`. **MISSING:** `d25-p1-littera`.
> - **PARS II** (Pars II at raw ~42603; DIVISIO TEXTUS; TRACTATIO QUAESTIONUM; **ARTICULUS UNICUS**): QUAESTIO I (~42641), II (~42801), III (~42903), IV (~43043), [q5 expected — verify], VI (~43375) = ~**6 quaestiones**, then **DUBIA** (DUB. I ~43695, DUB. II ~43728) = **2 DUB**. EXISTING skeletons: `d25-p2-a1-q3`, `d25-p2-a1-q4`, `d25-p2-a1-q6`, `d25-p2-dubia`. **MISSING:** `d25-p2-littera`, `d25-p2-divisio`, `d25-p2-a1-q1`, `d25-p2-a1-q2`, `d25-p2-a1-q5`.
