# Next session — **d24-p1-dubia DONE 2026-05-29 → d.24 PARS I now FULLY Tier-2. Next action: dispatch the FIRST Pars II chunk = `bon-sent-II-d24-p2-divisio` (MUST BE CREATED — auto-chunker dropped it). Pars II opens raw 40134 with `COMMENTARIUS IN DISTINCTIONEM XXIV. PARS II. De ordine et progressu peccati...` on p.573 top (PDF 595, +22). The p2-divisio chunk holds: COMMENTARIUS opener + DIVISIO TEXTUS (raw ~40134–40171) + TRACTATIO QUAESTIONUM + ARTICULUS I's single QUAESTIO I folded in per Override §5 (ART I title *Qualiter peccatum habeat fieri in superiori parte rationis*; QUAESTIO I at raw 40172, running head `DIST. XXIV. P. II. ART. I. QUAEST. I.`). VERIFY the ART I "quaeruntur"/Primo-Secundo opener count when building — ART I appears to have only 1 question.**
> **⚠ PARS II RE-CHUNK-VERIFY (done 2026-05-29 from raw 40134–41154): TRUE structure = ART I (1 q, raw 40172, folded into p2-divisio) · ART II *Qualiter peccatum habeat fieri in inferiori parte rationis* = 2 q (q1 raw 40437 *utrum aliquod peccatum habeat esse in inferiori parte rationis absque sensualitate*; q2 raw 40582 *utrum peccatum mortale possit esse in ea parte rationis, superiori non peccante*; ART II opener "quaeruntur duo" at raw 40428) · ART III *Quomodo peccatum habeat fieri et esse in sensualitate* = 2 q (q1 *utrum in sensualitate possit esse peccatum veniale*; q2 *utrum in sensualitate possit esse mortale*; ART III opener "duo quaeruntur" at raw 40784) · p2-dubia = 3 DUB (raw ~41032; DUB. I/II raw 41094/DUB. III raw 41116) ending where DISTINCTIO XXV begins raw 41154. EXISTING Pars II skeletons: `d24-p2-a2-q2`, `d24-p2-a3-q1`, `d24-p2-a3-q2`, `d24-p2-dubia`. MISSING (auto-chunker gaps, must be created): `d24-p2-divisio` (NEXT) and `d24-p2-a2-q1`. So the full Pars II build order = p2-divisio (NEW, +ART I q1) → p2-a2-q1 (NEW) → p2-a2-q2 → p2-a3-q1 → p2-a3-q2 → p2-dubia. Offset pdf=printed+22; Pars II runs pp.573–~578.**
