...
**NEXT = `bon-sent-II-d29-a1-q1`** (ARTICULUS I QUAESTIO I *Utrum absque dono gratiae homo esset Deo acceptus in statu innocentiae* — skeleton, `auto-chunked 2026-05-13`. **THIRD unit of d.29; first quaestio.**). **ARTICULUS I header at raw 48413** (`ARTIGULUS I.` garbled, theme *De necessitate gratiae ante peccatum primorum hominum*); **QUAESTIO I header at raw 48417**; **QUAESTIO I body opener at raw 48419** (*Circa primum sic proceditur et quaeritur, utrum absque dono gratiae homo esset Deo acceptus in statu innocentiae. Et quod sic, videtur.*), p.694 R-col foot. Per Override §5 the short ARTICULUS I opener (title + theme) folds into a1-q1 — no standalone article-opener chunk. **VERIFY alignment:** the divisio TRACTATIO (verbatim) gives ART I *Circa primum quaeruntur duo* = q1 *utrum homo in statu innocentiae, circumscripto dono gratiae, esset Deo acceptus* (= a1-q1 title above) / q2 *utrum absque gratia posset exire in opus meritorium*. Confirm the a1-q1 opener matches item 1 before promoting. **RECEIVES from divisio:** p.694 footers 2–4 anchor in a1-q1's argument chain — footer 2 (*Vers. 31* = Gen.1,31 *Vidit Deus cuncta…valde bona*, arg.1), footer 3 (*Vers. 25, ubi pro Domine Vulg. quae sunt* = Wisd. *Diligis omnia Domine…*, arg.2), footer 4 (*Vers. 17 — Ratio minori addita: quia rectus erat, respicit illud Eccl. 7,30: Solummodo hoc inveni, quod Deus fecerit hominem rectum* = Prov.8,17 *Ego diligentes me diligo*, arg.3); a1-q1's apparatus OPENS with these as [^1]–[^3]… (the divisio's footer 1 *praedictis* stays in divisio). Likely runs pp.694–696ish; offset +22. **d.29 = DISTINCTIO XXIX** (raw **48282** → DISTINCTIO XXX at raw **49478**), theme *De gratia secundum statum naturae institutae* — **the original-justice / pre-lapsarian-grace distinction. 3 articles = 3 principal questions** (ART I necessity of grace / ART II whether grace was had before sin / ART III quantity of grace), each with 2 sub-questions. **d.29 structure** (littera ✅ DONE, divisio ✅ DONE; remaining 8 chunks are auto-chunked skeletons): **ARTICULUS I** q1 (raw 48417, NEXT) / q2 (raw 48624) → **ARTICULUS II** (folded opener, theme *De gratia ante peccatum habita*; TRACTATIO: q1 *utrum habuerit gratiam ante lapsum* / q2 *utrum simul tempore conditus fuerit in gratuitis et naturalibus*) q1 (raw ~48787, QUAESTIO I *Utrum homo ante lapsum habuerit gratiam*) / q2 (raw 48957) → **ARTICULUS III** (header raw 49080, theme *De quantitate gratiae in statu innocentiae*; opener *quantam gratiam primus homo habuerit* → q1 *quantum ad donorum multitudinem*, q2 *quantum ad donorum magnitudinem*) q1 (raw ~49088, QUAESTIO I *Utrum homo habuerit tot virtutes ante lapsum, quot habuit post lapsum*) / q2 (raw 49214) → **dubia** (raw ~49356) + **dubia-dup2** (raw ~49404, likely another over-range dup to merge/`git rm` at the d.29 dubia build — INSPECT first, like the d.28 dubia-dup2 pattern). Single-pars distinction (no p1/p2). Offset +22. **DISTINCTIO XXX boundary at raw 49478.** **Decade-polish gate:** d.29 is NOT a decade boundary (next polish-blocker is after d.30 ships — d.21–d.30 pass). Proceed straight to d.29 a1-q1.
