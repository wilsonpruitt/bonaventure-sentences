# Next session — **DISTINCTIO XXXIII a1-q2 now Tier-2** (2026-05-30 — `bon-sent-II-d33-a1-q2`, ART I, QUAEST II *Utrum primus parens potuerit satisfacere pro posteris, sicut potuit eos ex culpa sua vitiare*, commit `f30e18d`; range raw 54670–54852, **printed pp.784–787** (PDF 806–809; OCR page-number scramble corrected: q2 opens at p.784 bottom-right, NOT p.785 as the auto-skeleton implied), **20 apparatus entries** [p.784 footers 3–6 received from a1-q1 → ^1–^4; p.785 footers 1–8 → ^5–^12; p.786 footers 1–8 → ^13–^20], scholion **I only** (item II absent; this is q2's own scholion, distinct from a1-q1's I–III); hand-off received from a1-q1 [p.784 footers 3–6]). Alignment CONFIRMED at promotion. **NEXT ACTION = dispatch `bon-sent-II-d33-a2-q1`** (ART II = *De quantitate originalis peccati* — NOTE the correct ART II title is *De quantitate originalis peccati*, NOT "De originali quoad causam concomitantem" as an earlier note had it; QUAESTIO I = *Utrum originale peccatum reperiatur in omnibus aequaliter*). **d.33-a2-q1 range:** raw **≈54853** (`ARTICULUS II. / De quantitate originalis peccati.` then the short article opener `Consequenter circa secundum articulum quaeritur de quantitate originalis. Et circa hoc quaeruntur duo. Primo quaeritur de ipso originali sub ratione quantitatis continuae… Secundo quaeritur quantum ad rationem quantitatis discretae…`, then `QUAESTIO I. / Utrum originale peccatum reperiatur in omnibus aequaliter.`) → ends before ART II QUAESTIO II opener (raw ≈55064). The ART II short opener (two-question listing) folds into a2-q1 per Override §5 (no standalone divisio chunk). Printed page begins **787** (offset pdf=printed+22). **HAND-OFF into d33-a2-q1 (from a1-q2):** on the shared printed **p.787**, a1-q2 claimed NO footer (its reply-6 tail carries no marker); the entire p.787 footer block is FORWARDED to a2-q1 — footer **1** (`De divisione quantitatis in continuam et discretam cfr. Aristot., de Praedicam. c. de Quanto`, anchors at a2-q1 opener *quantitatis continuae*), footer **2** (`Ubi textus originalis sic sonat: « Quod [originale peccatum] propter praedictas aestimo rationes in omnibus infantibus naturaliter propagatis esse aequale »…`, Anselm), footer **3** (`Dist. 30. a. 2. q. 1, d. 32. a. 1. q. 1. et a. 3. q. 1. — De hoc arg. cfr. Anselm., de Conceptu virgin. et orig. pecc. c. 24`), footer **4** (`Anselm., loc. cit. eandem rationem affert his verbis: Sicut peccatum Adae, quod est causa, cur [infantes] nascantur in illo, ad omnes pertinet aequaliter`), footer **5** (`Anselm., loc. cit. c. 27: Et omnes, qui in illo [originali]…`). **VERIFY the Primo/Secundo-quaeritur alignment at promotion** (a2 q1 opener after the short article-listing must read `Circa primum sic proceditur et quaeritur, utrum originale in omnibus reperiatur aequaliter`). **d.33 commentary structure** (mirrors d.32 — 3 art × 2 q): ART I q1 (raw ≈54508) / q2 (raw ≈54670) → ART II q1 (raw ≈54863) / q2 (raw ≈55064) → ART III q1 (raw ≈55243) / q2 → DUBIA. Template = `vol2/bon-sent-II-d32-a1-q1.md` (quaestio) / `d33-divisio.md` (just-completed divisio). **d.33–40 skeletons were REGENERATED 2026-05-30 with a FIXED auto-chunker** (commits `95b6a45` tooling + `d5bec59` skeletons) — the d.32-class chunker bugs are now fixed, so the old `d33-divisio-dup2`/`d33-dubia-dup2` dups are GONE and every d.33–40 distinction has a clean 1 littera + 1 divisio + 1 dubia + correct quaestio count. **Still ALWAYS run the Primo/Secundo-quaeritur alignment check at promotion** (cheap insurance), but the gross structural misses are pre-cleared. Template = `vol2/bon-sent-II-d32-divisio.md` (divisio) / `d32-littera.md` (littera). **No decade polish until d.40.**
