# Next session — **d25-p1-a1-q4 DONE 2026-05-29 (REBUILT to Tier-2). ARTICULUS UNICUS QUAESTIO IV "Utrum liberum arbitrium sit nomen habitus, vel potentiae" (= per modum potentiae an per modum habitus), pp. 600–602, 18 apparatus entries (p.600 footers 4–8 → [^1]–[^5] RECEIVED via hand-off from a1-q3; p.601 footers 1–10 → [^6]–[^15]; p.602 footers 1–3 → [^16]–[^18]). has_scholion=TRUE (SCHOLION I–III, printed p.602; SCHOLION II/III forward-point to q5). Alignment confirmed (opener "Quarto quaeritur… per modum potentiae, an per modum habitus" = sub-q 4). RECEIVED from q3: p.600 footers 4–8 (Anselm Cap.3 / Bernardus / Augustine Hypognosticon / Augustine Enchiridio / Lit.Magistri c.3). FORWARDED to q5: p.602 footers 4+ ("Quaest. praeced. — De maiori cfr. August., 83 Qq…") belong to q5's body. Commit ddca49a (chunk+content.json) + this resume advance. Build 885 q / 693 translated. Audits: q4 clean (NOT flagged in apparatus audit — 18 entries); remaining d.25 flags are pre-existing unbuilt skeletons (10 HIGH paraphrase, header Q-LOSS from unbuilt q5/q6/dubia, apparatus SKELETON/INCOMPLETE-SUSPECT = p1-a1-q5/q6 + p1-dubia + p2 siblings). Next = `bon-sent-II-d25-p1-a1-q5` (ARTICULUS UNICUS QUAESTIO V "Utrum liberum arbitrium addat aliquid supra rationem et voluntatem" / utrum habitus ille addat aliquid per essentiam; SKELETON exists; opens raw ~42150, p.602, "Quinto quaeritur, utrum liberum arbitrium aliquid addat supra rationem et voluntatem"). ⚠ q5 RECEIVES the forwarded p.602 footers 4+ (q5 source/variant notes); q5 body runs p.602 into following pages — verify span at PDF + grep for QUAESTIO VI boundary (~42281).**
>
