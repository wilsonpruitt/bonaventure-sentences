...
**NEXT = `bon-sent-II-d29-a2-q1`** (ARTICULUS II QUAESTIO I *Utrum homo ante lapsum habuerit gratiam* — skeleton, `auto-chunked 2026-05-13`. **FIFTH unit of d.29; first quaestio of ARTICULUS II.**). **Per Override §5 the short ARTICULUS II opener FOLDS into this a2-q1** — no standalone article-opener chunk. **ART II opener at raw 48764** (p.699 R foot), theme *Utrum homo ante peccatum habuerit gratiam gratum facientem*; the **ART II TRACTATIO (verbatim):** *Consequenter quaeritur, utrum homo in statu innocentiae habuerit gratiam gratum facientem. Et circa hoc quaeruntur duo. Primo quaeritur, utrum habuerit gratiam ante lapsum. Secundo quaeritur, utrum simul tempore conditus fuerit in gratuitis et naturalibus.* → **a2-q1 = QUAESTIO I *Utrum homo ante lapsum habuerit gratiam*** (header raw **48787**, on p.700) / a2-q2 = *utrum simul tempore conditus fuerit in gratuitis et naturalibus* (raw 48957). **VERIFY alignment:** confirm the q1 opener (*Circa primum sic proceditur et quaeritur…*) matches TRACTATIO item 1 before promoting. **RECEIVES from a1-q2:** no body-footer hand-off (a1-q2 closed clean raw 48763, owns its pp.697–699 footers incl. footer [^20] *Vide scholion ad praecedentem quaest.* on its last word). Grep raw 48787 onward for the q1 body + footers + the q2 boundary (raw 48957). Offset +22. **d.29 = DISTINCTIO XXIX** (raw **48282** → DISTINCTIO XXX at raw **49478**), theme *De gratia secundum statum naturae institutae* — **the original-justice / pre-lapsarian-grace distinction. 3 articles = 3 principal questions** (ART I necessity of grace / ART II whether grace was had before sin / ART III quantity of grace), each with 2 sub-questions. **d.29 structure** (littera ✅ DONE, divisio ✅ DONE, a1-q1 ✅ DONE, a1-q2 ✅ DONE; remaining 6 chunks are auto-chunked skeletons): **ARTICULUS I** q1 ✅ (raw 48417) / q2 ✅ (raw 48624) → **ARTICULUS II** (folded opener into a2-q1, theme *De gratia ante peccatum habita*; TRACTATIO: q1 *utrum habuerit gratiam ante lapsum* / q2 *utrum simul tempore conditus fuerit in gratuitis et naturalibus*) q1 (raw 48787, NEXT, QUAESTIO I *Utrum homo ante lapsum habuerit gratiam*) / q2 (raw 48957) → **ARTICULUS III** (header raw 49080, theme *De quantitate gratiae in statu innocentiae*; opener *quantam gratiam primus homo habuerit* → q1 *quantum ad donorum multitudinem*, q2 *quantum ad donorum magnitudinem*) q1 (raw ~49088, QUAESTIO I *Utrum homo habuerit tot virtutes ante lapsum, quot habuit post lapsum*) / q2 (raw 49214) → **dubia** (raw ~49356) + **dubia-dup2** (raw ~49404, likely another over-range dup to merge/`git rm` at the d.29 dubia build — INSPECT first, like the d.28 dubia-dup2 pattern). Single-pars distinction (no p1/p2). Offset +22. **DISTINCTIO XXX boundary at raw 49478.** **Decade-polish gate:** d.29 is NOT a decade boundary (next polish-blocker is after d.30 ships — d.21–d.30 pass). Proceed straight to d.29 a2-q1.
