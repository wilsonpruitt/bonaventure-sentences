# Next session — **NEXT = `bon-sent-II-d30-divisio` (COMMENTARIUS + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM, DISTINCTIO XXX). The DISTINCTIO XXX Littera Magistri is now Tier-2.** d.30 = *De peccato originali, quomodo transit in posteros*. **COMMENTARIUS IN DISTINCTIONEM XXX begins at raw 49699** (running head *DIST. XXX. DIVISIO TEXTUS* at raw 49687, printed p.713; opener *Utrum et quid sit peccatum originale* + *In superioribus insinuatum est etc.* + *DIVISIO TEXTUS*). The divisio chunk holds the COMMENTARIUS + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM. **d.30 remaining = 7 units (NO dubia): divisio (COMMENTARIUS raw 49699 → ART I q1 opener) / ART I {a1-q1 + a1-q2} / ART II {a2-q1 + a2-q2} / ART III {a3-q1 + a3-q2}; DISTINCTIO XXXI at raw 51357.** **⚠ CHUNKING BUG TO FIX (when promoting ART I): `a1-q2` is MISSING.** ART I has TWO quaestiones — q1 (*Circa primum… utrum…* raw ~49765) and **QUAESTIO II *Utrum natura humana merito primae transgressionis fuerit corrupta poenaliter tantum, an etiam culpabiliter* (raw ~49999)** — but the auto-chunker bundled BOTH into the single `bon-sent-II-d30-a1-q1.md` skeleton (line_start 49759 / line_end 50246, which straddles the q2 header at ~49999). When promoting ART I, CARVE OUT a new `bon-sent-II-d30-a1-q2.md` (a2-q1 starts clean at raw 50255). **Skeletons present (auto-chunked 2026-05-13):** divisio, a1-q1, a2-q1, a2-q2, a3-q1, a3-q2 (6 files; a1-q2 to be created). **No d.30 dup strays.** Per Override §5, fold the short ARTICULUS openers (*Consequenter… quaeruntur…*) into each article's q1. **Offset pdf = printed + 22.** **⚠ DECADE BOUNDARY: after d.30's last unit ships, the d.21–d.30 polish-blocker (three passes — [?]-flag resolution, full-corpus style audit, cross-chunk boundary sweep) FIRES before any d.31 dispatch.**
