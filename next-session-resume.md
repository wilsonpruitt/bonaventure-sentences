# Next session — **DISTINCTIO XXXIII a2-q1 now Tier-2** (2026-05-30 — `bon-sent-II-d33-a2-q1`, ART II, QUAEST I *Utrum originale peccatum reperiatur in omnibus aequaliter*, commit `c60cef7`; range raw 54857–55061, **printed pp.787–790** (PDF 809–812), **28 apparatus entries** [p.787 footers 1–6 (1–5 received from a1-q2's forwarded p.787 block) → ^1–^6; p.788 footers 1–10 → ^7–^16; p.789 footers 1–10 → ^17–^26; p.790 q1-share: note 5 + et-variant → ^27–^28], scholion **I–II** (commentator roll for BOTH questions of the article — `solutio utriusque quaestionis huius articuli non habet difficultatem`, so q2 may legitimately lack its own scholion); folded ART II short opener per Override §5. Alignment CONFIRMED (`Circa primum sic proceditur et quaeritur, utrum originale in omnibus reperiatur aequaliter`); hand-off received from a1-q2 [entire p.787 footer block]). **NEXT ACTION = dispatch `bon-sent-II-d33-a2-q2`** (ART II, QUAESTIO II = *Utrum ponendum sit peccatum originale unum, vel plura*). **d.33-a2-q2 range:** raw **≈55064** (`QUAESTIO II. / Utrum ponendum sit peccatum originale unum, vel plura.` then body opener `Secundo quaeritur, utrum sit ponere unum originale, vel plura. Et quod unum solum, videtur:`) → ends before ART III QUAESTIO I opener (raw **≈55243**). Printed page begins **790** (q2 opens p.790 right column; offset pdf=printed+22). **HAND-OFF into d33-a2-q2 (from a2-q1):** on the shared printed **p.790**, a2-q1 claimed only the q1-share footers (note 5 + et-variant). The QUAESTIO II footer share is FORWARDED to a2-q2 — p.790 left-block note **1** (`Vat. cum edd. 3, 4 sunt`, q2 arg 1 *non sit nisi unum solum*), note **3** (`Hic c. 2. — Quantum ad reliqua argg., quae sequuntur, cfr. fundam. 2-4. quaest. praeced.`, q2 arg 1 Magister *Alioquin*), note **4** (`Aristot., V. Topic. c. 3. (c. 5.). De eo, quod status sit per reductionem ad unum, cfr. supra pag. 99, nota 3. — In principio huius arg. codd. T bb ee et alii omittunt in ante comparatione, codd. cc et ed. 1 legunt per comparationem`, q2 arg 4), and right-block note **6** (`Psalm. 50. 7. — Glossa est interlinearis et habetur apud Lyranum…`, q2 Sed contra 1). **CAUTION on the p.790 *et*-variant note** (`Codd. aa ee omittunt et, pro quo cod. A substituit etiam, Vat. et etiam`): a2-q1 claimed it as its [^28] (q1's Ad-6 `et… in eodem genere peccati`). If q2 arg-4's `et status est per reductionem` also needs an *et*-variant note, it is a DISTINCT note — verify against the PDF p.790 footer at the q2 build; do not double-count a2-q1's [^28]. **VERIFY the Secundo-quaeritur alignment at promotion** (q2 body opener must read `Secundo quaeritur, utrum sit ponere unum originale, vel plura`). **d.33 commentary structure** (mirrors d.32 — 3 art × 2 q): ART I q1 (raw ≈54508) / q2 (raw ≈54670) → ART II q1 (raw ≈54857) / q2 (raw ≈55064) → ART III q1 (raw ≈55243) / q2 → DUBIA. Template = `vol2/bon-sent-II-d32-a1-q1.md` (quaestio) / `d33-divisio.md` (just-completed divisio). **d.33–40 skeletons were REGENERATED 2026-05-30 with a FIXED auto-chunker** (commits `95b6a45` tooling + `d5bec59` skeletons) — the d.32-class chunker bugs are now fixed, so the old `d33-divisio-dup2`/`d33-dubia-dup2` dups are GONE and every d.33–40 distinction has a clean 1 littera + 1 divisio + 1 dubia + correct quaestio count. **Still ALWAYS run the Primo/Secundo-quaeritur alignment check at promotion** (cheap insurance), but the gross structural misses are pre-cleared. Template = `vol2/bon-sent-II-d32-divisio.md` (divisio) / `d32-littera.md` (littera). **No decade polish until d.40.**
