...
quaestio: 1
type: quaestio
title_la: "Utrum timor servilis sit donum Spiritus sancti divinitus datum"
title_en: "Whether servile fear is a gift of the Holy Spirit divinely given"
printed_pages: [753, 754, 755, 756]
pdf_pages: [775, 776, 777, 778]
source: "S. Bonaventurae, Opera Omnia, Tomus III (Quaracchi, 1887), pp. 753–756"
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from 450 dpi PDF column bands (Vol III two-column PDF-priority inversion; raw 52311–52539), fresh literal English, 11-entry NOTAE AD COMMENTARIUM (per-page restart, leading with p.753 n.5 hand-off), own article-master scholion §I–III body-then-scholion LAST (2026-06-12)"
format_version: 1
---

# bon-sent-III-d34-p2-a1-q1 — Pars II, Art. I, Q. I
...
1. *Primo* per Glossam super illud ad Romanos octavo[^1]: *Non accepistis spiritum servitutis iterum in timore;* ibi Glossa: «Cave, ne ex eo quod ait spiritum servitutis et spiritum adoptionis, diversum intelligas spiritum, cum sit unus atque idem Spiritus»: si ergo spiritus adoptionis est donum Spiritus sancti, ex hac Glossa videtur necessario posse concludi, quod ab eodem sit timor servilis.
...
> The numbered footnotes below correspond to markers in both the Latin body above and the English translation. **La.** gives the Quaracchi editors' note verbatim; **En.** translates it.

[^1]: **La.** Vers. 15. — De Glossa, quae apud Petr. Lombard. integra, apud Strabum autem et Lyranum ex parte tantum habetur; vide August., II. Qq. in Pentateuch. q. 55. — Superius post *timor scilicet* edd. repetunt *timor servilis.*
    **En.** Verse 15. — Concerning the Gloss, which is found complete in Peter Lombard, but only in part in Strabo and Lyra; see Augustine, *Questions on the Pentateuch* II, q. 55. — Above, after *timor scilicet,* the editions repeat *timor servilis.*

[^2]: **La.** Cod. U *aeternus.* Paulo inferius post *sic: donum Dei est* codd. A U subdunt *nosse,* et dein pro *refugere* substituunt *fugere.*
    **En.** Codex U reads *aeternus.* A little below, after *sic: donum Dei est,* codices A and U add *nosse,* and then for *refugere* substitute *fugere.*

[^3]: **La.** Cap. 63, 17. — Locus Psalmi est Ps. 118, 120.
    **En.** Chapter 63, 17. — The passage of the Psalm is Ps. 118 [119], 120.

[^4]: **La.** Verba Glossae *ordinariae,* delibatae ex August., Enarrat. in Ps. 118, 120. serm. 25. n. 7. haec sunt: «Timor namque iste, qui non amatur iustitia, sed timetur poena, servilis est, quia carnalis est; et ideo non crucifigit carnem. Vivit enim peccandi voluntas, quae tunc apparet in opere, quando speratur impunitas. Cum vero poena creditur secutura, latenter vivit tamen. Mallet enim licere, et dolet non licere, quod lex vetat; quia non spiritualiter delectatur eius bono, sed carnaliter malum metuit quod minatur». Et paulo ante (n. 6.) Augustinus dicit: *Cognita itaque Dei gratia, quae sola liberat a praevaricatione, quae legis cognitione committitur, orando dicit: Confige clavis a timore tuo carnes meas.* — Pro *et timetur divina iudicia* edd. *et timetur divina iustitia.*
    **En.** The words of the *Ordinary* Gloss, drawn from Augustine, *Enarration on Ps. 118 [119], 120,* sermon 25, n. 7, are these: «For this fear, in which justice is not loved but punishment is feared, is servile, because it is carnal; and therefore it does not crucify the flesh. For the will to sin lives, which then appears in the deed, when impunity is hoped for. But when punishment is believed to be about to follow, it still lives in secret. For he would prefer that it were lawful, and grieves that what the law forbids is not lawful; because he is not spiritually delighted in its good, but carnally fears the evil which it threatens». And a little before (n. 6) Augustine says: *Having therefore come to know the grace of God, which alone frees from the transgression which is committed through the knowledge of the law, he says in prayer: Pierce thou my flesh with the nails of thy fear.* — For *et timetur divina iudicia* the editions read *et timetur divina iustitia.*

[^5]: **La.** Quaest. 3.
    **En.** Question 3.

[^6]: **La.** Cfr. I. Sent. d. 36, a. 3. q. 2. — Aliquanto superius pro *quod si* multi codd. incongrue *quod etsi.* Paulo inferius pro *non erigitur* cod. A *non erigutur.*
    **En.** Cf. I Sent., d. 36, a. 3, q. 2. — Somewhat above, for *quod si* many codices incongruously [read] *quod etsi.* A little below, for *non erigitur* codex A [reads] *non erigutur.*

[^7]: **La.** Vide Aristot., III. Ethic. c. 7. — In fine solut. pro *licet* nonnulli codd. et Vat. *sed.*
    **En.** See Aristotle, *Ethics* III, c. 7. — At the end of the solution, for *licet* some codices and the Vatican edition [read] *sed.*

[^8]: **La.** In multis codd. deest *sicut,* in codd. U V etiam *beneficia.* Inferius pro *contemnunt* codd. U Z *despiciunt.*
    **En.** In many codices *sicut* is lacking; in codices U and V also *beneficia.* Below, for *contemnunt* codices U and Z [read] *despiciunt.*

[^9]: **La.** Cfr. August., de sancta Virginitate c. 38. n. 39.
    **En.** Cf. Augustine, *On Holy Virginity* c. 38, n. 39.

[^10]: **La.** Codd. U X Z *suspendium.* Paulo inferius pro *iuvetur* edd. *timeat.* De timore latronis cfr. August., Serm. 169. [alias serm. 15. de verbis Apostoli] c. 6. n. 8.
    **En.** Codices U, X, Z read *suspendium.* A little below, for *iuvetur* the editions [read] *timeat.* On the fear of the thief cf. Augustine, *Sermon* 169 [otherwise sermon 15, on the words of the Apostle], c. 6, n. 8.

[^11]: **La.** Hic cod. S adiungit solutiones ad arg. supra (pag. 754, nota 8.) in eodem relato. — Ad sextum: quod loquitur ibi de timore desperationis; et iste non est timor servilis, quia per eum non vitatur peccatum, sed in omne peccatum inciditur, secundum illud Ieremiae decimo octavo [12.]: *Desperavimus; post cogitationes enim... ibimus, et unusquisque pravitatem cordis sui mali faciemus.*
    **En.** Here codex S adds the solutions to the arguments reported above (p. 754, note 8) in the same place. — To the sixth: that it there speaks of the fear of despair; and that is not servile fear, because through it sin is not avoided, but one falls into every sin, according to that text of Jeremiah chapter eighteen [12]: *We have despaired; for after our own thoughts we will go, and we will do every one the wickedness of his evil heart.*

## Notes

**Provenance.** Latin re-set from the 450 dpi PDF column bands (`/tmp/colcrop/vol3-p75{3,4,5,6}-{L,R}-{0,1,2}.png`, PDF pp. 775–778 = printed 753–756, offset +22), per the Vol III two-column PDF-priority inversion. Running-head text (`DIST. XXXIV. P. II. ART. I. QUAEST. I.`) was trusted over OCR'd verso page-digits, which are mangled (`734`→754, `733`→753). Raw OCR span 52311–52539 used as the base for clean running prose (the *Fundamenta* / *Sed contra* arguments and the small-type cod.-S argument block) and for footnote-marker spacing; the Respondeo, replies, scholion, and all footer bands were re-set from the bands. Opener-alignment **PASS 1:1**: TRACTATIO *Primum* (*de timore servili per comparationem ad suum principium*) = QUAESTIO I (*Utrum timor servilis sit donum Spiritus sancti divinitus datum*); the title matches the opener (*Circa primum sic proceditur... per comparationem ad eius principium*) and the d34-p2-divisio hand-off.

**Page-split map (per-page footnote restart, renumbered continuous).** 11-entry NOTAE AD COMMENTARIUM:
- **p.753 R-col** n.5 → `[^1]` — the **PICKED-UP hand-off** from d34-p2-divisio (Rom. 8,15 Glossa; anchors arg 1 *Romanos octavo⁵*). p.753 n.4 (*In Vat. desunt verba fuit timor...*) belongs to the divisio (its `[^4]`), NOT re-claimed.
- **p.754** — no footnote band (pure argument continuation, args 2–14 + Sed contra).
- **p.755 L-col** (small-type band) nn.1–3 → `[^2]`–`[^4]` — anchor the Respondeo markers *futuras¹* / *Isaias²* / *Glossa³*. `[^4]` carries the long Ordinary-Gloss quotation verbatim.
- **p.755 R-col** (Respondeo/replies band) nn.4–7 → `[^5]`–`[^8]` — `[^5]`=*Quaest. 3* (anchors Ad-1 *infra⁴ melius manifestabitur*); `[^6]`=I Sent. d.36 + *quod si* variant; `[^7]`=Aristot. *Ethic.* III (anchors Ad-4 *sicut⁷*); `[^8]`=*suspendium* variant (anchors Ad-5 *supplicium⁸*).
- **p.756** nn.1–3 → `[^9]`–`[^11]` — `[^9]`=Augustine *de Virginitate* (anchors Ad-4 *amore¹*); `[^10]`=*suspendium* codd. + Augustine Serm.169 (anchors Ad-5 *supplicium²*); `[^11]`=*hinc et inde³* note carrying the cod.-S extra-solutions opener (Jerem. 18 *Desperavimus*).

Marker pairing **11/11 clean** (every `[^N]:` def has a matching anchor in both Latin and English bodies).

**Scholion disposition.** `has_scholion: true` — q1 carries an **OWN article-master SCHOLION §I–III** (p.756, both columns, body-then-scholion LAST): **§I** = Trent Sess. VI c.6 + can.8 + Alexander VIII / Quesnel / Pistoia condemned propositions on servile fear, with the q1 dossier (S.Thom. q.2 a.2 quaestiunc.1; B.Albert; Petr. a Tar.; Richard. a Med.; Durand.; Dionys. Carth.). **§II FORWARDS to q2** (*In seq. (2.) quaestione...* — the *servilitas*-mala-but-*actus*-bonus point + q2 dossier). **§III FORWARDS to q3** (*Ad 3. quaestionem...* — servile fear remaining without servility when grace supervenes; *Plura vide infra a. 2. q. 3* + q3 dossier). So **a1-q2 and a1-q3 are expected to carry NO own scholion — REDIRECT to this §II / §III respectively** (same pattern as p.I a1-q1's §III/§IV → q2/q3).

**Footer hand-offs.** PICKED UP: p.753 n.5 from d34-p2-divisio (= `[^1]`). FORWARDED to **d34-p2-a1-q2**: NOTHING of the NOTAE AD COMMENTARIUM family — q1 closes clean on p.756 R-col (scholion §III tail at *...hic a. 2. q. 3.*); the QUAESTIO II band opens fresh on p.757 (running head `DIST. XXXIV. P. II. ART. I. QUAEST. II.`, raw 52540). The scholion §II forwarded to q2 is a redirect target (q2 likely `has_scholion: false`).

**`[?]` flags.** NONE — all four pages legible at 450 dpi; the OCR-garbled Respondeo / cod.-S small-type block were fully re-set from the bands.
