**Respondeo:** Ad praedictorum intelligentiam est notandum, quod aliqui dicere voluerunt, quod nulla persona incarnari potuit nisi persona Verbi. Et rationem huius assignant: quia, si alia persona incarnaretur, nasceretur quaedam Trinitatis confusio, dum plures in Trinitate Filii dicerentur[^9]. Nasceretur etiam quaedam aequalitatis diminutio, dum duo Filii essent in Trinitate, quorum unus haberet excellentiorem nativitatem[^10] quam alter. Nasceretur etiam quaedam oppositorum indistinctio, quia tunc unus et idem Filius genitus et ingenitus diceretur, si Pater incarnaretur[^11]. Et haec omnia sunt inconvenientia; et quia nihil inconveniens potest poni in Deo et circa Deum: ideo dixerunt, quod nulla alia persona a persona Filii poterat incarnari, non propter defectum potentiae, sed propter dignitatem potentiae, quae non admittit aliquod indecens circa opus suum. — Sed licet videantur in hac positione sequi beatum Anselmum, ipsum tamen veraciter non sequuntur, pro eo quod nec Anselmus vult hoc dicere, esse impossibile apud Deum, aliam personam a Filio incarnari; sed vult hoc ostendere, quod non est ita decens de alia persona, sicut de persona Filii: et hoc verum est, sicut melius videbitur infra[^12].
...
**Provenance.** Latin re-set from the 450 dpi PDF column bands of printed pp.16–18 (PDF 38–40; offset pdf = printed + 22), with the IA djvu OCR (raw lines 1787–1910) as base for clean prose and footnote-marker spacing. The Respondeo, replies, and all footers were verified column-by-column against the crops (Vol II/III PDF-priority override). Literal English, paragraph-for-paragraph. **19-entry apparatus.** This is the **LAST question of ARTICULUS I**.

**Alignment result: PASS.** Opener = `Quarto quaeritur, utrum quaelibet trium personarum possit incarnari per se ipsam. Et quod sic, videtur.` = TRACTATIO q4 (*Quarto quaeritur … incarnari per se ipsam*). No q-swap. (Note: the TRACTATIO listed *potuerit*; the body prints *possit* — same question, minor mood variance; title_la follows the TRACTATIO/INDEX wording *potuerit*.)

**Scholion disposition: NONE.** On the PDF crops, q4's last reply (reply 4) ends grammatically complete at `…propterea illa ratio non concludit⁷.` (p.18 R-col), and the **very next printed line is `ARTICULUS II.`** — no `SCHOLION` block prints for q4. (The earlier over-claim that a1-q1's Scholion "covers q2/q3/q4" was already corrected at q3, which carried its own scholion; q4, however, genuinely has none. Confirmed: p.18 footer 7 `Vide scholion ad praecedentem quaest.` is a *forward-reference belonging to the ART. II opener*, not a q4 scholion.) Set `has_scholion: false`.

**Page-split / running heads.** p.16 `… SENTENTIARUM LIB. III.` (R-col head trimmed in crop); p.17 `DIST. I. ART. I. QUAEST. IV. 17`; p.18 `18 … SENTENTIARUM LIB. III.` The QUAESTIO IV heading prints at the bottom of p.16 L-col; the opener + fund. 1–2 run down p.16 R-col; fund. 3–4 + Sed contra 1–4 + Conclusio + Respondeo span p.17; the Respondeo tail + replies 1–4 finish on p.18 (L-col → R-col), immediately followed by ARTICULUS II.

**Footer split (per-page restart, continuous unique slugs 1–19).**
- **p.16 footers 5–6 INHERITED from the q3→q4 boundary** (q3 consumed p.16 f.1–4 as its `[^15]`–`[^18]`): f.5 = `Pro et (Vat. etiam)… in` → `[^1]` (anchors fund-1 `quod et⁵`); f.6 = `Cfr. Ioan. 5, 19. seqq.` → `[^2]` (anchors fund-2 `a Patre⁶`). Both verified against the p.16 R-col footer band.
- **p.17 footers 1–10 → `[^3]`–`[^12]`** (anchors: ³*faciendam* ⁴*eo ipso quo* ⁵*Cur Deus homo* ⁶*Augustinus* ⁷*alteri convenire* ⁸*praecedentibus* [Sed-contra-4] ⁹*dicerentur* ¹⁰*nativitatem* ¹¹*incarnaretur* ¹²*infra*). Footer 6 (`Quaest. 1, 2`-style note `sed altera persona alteram naturam assumsit…`) **wraps from the L-col foot to the R-col foot** — the wrap tail (`Spiritus sanctus naturam columbae… A destructione consequentis ad destructionem antecedentis.`) was joined into `[^8]`. The OCR's stray alphabetic `a Anselm…` footer = the printed numbered footer **9** (no separate lettered footer exists).
- **p.18 footers 1–7 → `[^13]`–`[^19]`** (anchors: ¹³*in littera* ¹⁴*eam* ¹⁵*secundum se malum* ¹⁶*incarnatio* ¹⁷*destruendo* ¹⁸*praecedentibus* [reply-4] ¹⁹*concludit*). **p.18 footer 8** (`Plurimi codd. et edd. 1, 2 dignitatem… congruitatem`) anchors the ART. II opener `congruitatem⁸` and is therefore **OUT OF SCOPE — FORWARDED to d1-a2-q1**, omitted here rather than rendered anchorless.

**Marker pairing: 19 La = 19 En = 19 defs, 0 anchorless / 0 defless.**

**Incoming hand-off (picked up):** p.16 footers 5–6 (the only shared-page footers at the q3→q4 seam) rendered as q4's `[^1]`–`[^2]`. q4's opening (`Quarto quaeritur…`) is grammatically continuous after q3's Scholion III tail (`…Dionys. Carth., hic q. 5.`, p.16 R-col, raw ~1786).

**Forward hand-off → `bon-sent-III-d1-a2-q1`:** q4 ends grammatically complete at `…illa ratio non concludit⁷.` (p.18 R-col, raw ~1910). `ARTICULUS II.` (subtitle *De incarnatione Verbi quantum ad congruitatem*; opener `Consequenter quaeritur de secundo principali, videlicet de incarnatione Verbi quantum ad congruitatem⁸. Et circa hoc quaeruntur quatuor.` + the four-question list `Primo … utrum in opere incarnationis servetur debita congruentia / Secundo, quae sit incarnationis ratio praecipua / Tertio, quae sit personarum trium ad incarnationem magis idonea / Quarto … quae hora temporis magis fuerit congrua`) begins raw ~1911, printed p.18 bottom L-col → p.19. The short ART. II opener **FOLDS INTO d1-a2-q1** (no standalone articulus chunk). `QUAESTIO I. Utrum in opere incarnationis servetur debita congruentia ex parte Dei.` (opener `Circa primum sic proceditur et quaeritur, utrum in opere incarnationis servetur debita congruentia ex parte Dei. Et quod sic, videtur.` fund-1 `Infinita potentia, sapientia et bonitas debet se perfecte manifestare…`) begins raw ~1944, printed p.19. **FOOTER SPLIT forwarded:** p.18 footer **8** (`Plurimi codd. et edd. 1, 2 dignitatem, sed supra in principio dist. recte habent congruitatem.`) belongs to a2-q1 (anchors the ART. II opener `congruitatem⁸`); the long p.18 footer **5** (Petr. Hispan. topic note) is q4's `[^17]`, fully consumed here. **ART. II scholion check:** p.18 footer 7 = `Vide scholion ad praecedentem quaest.` — verify in a2-q1 whether the ART. II scholion prints as `pro quaest. seq.` (i.e. whether a2-q1 carries a scholion forwarding to the next question) per the locked Vol II convention.
