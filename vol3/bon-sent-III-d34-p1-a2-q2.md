...
quaestio: 2
type: quaestio
title_la: "Utrum sit aliquis ordo et combinatio in donis Spiritus sancti"
title_en: "Whether there is any order and combination in the gifts of the Holy Spirit"
printed_pages: [747, 748, 749]
pdf_pages: [769, 770, 771]
source: "S. Bonaventurae, Opera Omnia, Tomus III (Quaracchi, 1887), pp. 747–749"
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from 450 dpi PDF column bands (Vol III two-column PDF-priority inversion: the cascade-shattered Respondeo triplex-ratio + every footer band re-set from the bands; OCR used only for clean videtur/contra running prose + footnote-marker spacing; offset pdf = printed + 22, running-head TEXT trusted over OCR'd digits), fresh literal English, own SCHOLION §I–II captured body-then-scholion LAST, 14-entry NOTAE AD COMMENTARIUM per-page restart renumbered continuous (leading with p.747 nn.4–9 picked up from a2-q1; p.749 nn.1–2 = q2's share of a page footer shared with a2-q3), no [?] flags, RENAMED from bon-sent-III-d34-p1-a1-q2-dup2.md + promoted (2026-06-12)"
format_version: 1
---

# bon-sent-III-d34-p1-a2-q2
## *Utrum sit aliquis ordo et combinatio in donis Spiritus sancti*
...
Secundo quaeritur de donorum ordine et combinatione, quae duo valde signanter innuit Isaias in praedictorum donorum enumeratione, undecimo capitulo[^1], ubi sic ait de Christo: *Requiescet super eum spiritus Domini: spiritus sapientiae et intellectus, spiritus consilii et fortitudinis, spiritus scientiae et pietatis; et replebit eum spiritus timoris Domini.*

**Argumenta contra ordinem:**

1. *Primo* obiicitur contra ordinem: quia, cum progressus ordinatus debeat esse[^2] ab inferiori ad superius, et donum sapientiae sit maximum, donum vero timoris minimum: cum ergo donum sapientiae ponat primo loco, donum vero timoris postremo; non videtur dona ordinare ordine recto.

2. Item, habitus spectans ad cognitionem praecedit habitum, qui spectat ad affectionem: cum ergo sapientia, a sapore[^3] dicta, spectet ad potentiam affectivam, intellectus vero spectet ad potentiam cognitivam; videtur, quod donum intellectus esset dono sapientiae praeponendum.

3. Item, aut dona ordinantur secundum ordinem dignitatis maioris et minoris, aut secundum ordinem prioritatis et posterioritatis[^4]. Si primo modo: ergo cum maioris perfectionis sit fortitudo quam consilium, et pietas quam scientia, deberent ei praeponi et non postponi. Si secundum ordinem prioritatis et posterioritatis; sic, cum illud quod est ex parte cognitivae praecedat illud quod est ex parte affectivae; videtur, quod intellectus praeponi debeat sapientiae. Quodsi tu dicas, quod intellectus praeponitur sapientiae in ascendendo; tunc similiter quaeritur: quare non praeponitur scientia pietati, et consilium fortitudini in ascendendo, sed magis e contrario?
...
6. Item, cum quodlibet donum spectans ad affectionem habeat suum directivum[^5], videtur, quod et donum timoris deberet suum directivum habere, cum quo combinaretur; quod si non habet, videtur, quod nec alia deberent habere.

Quaeritur ergo, quae sit ratio combinandi et ordinandi[^6] dona; et quare magis huiusmodi combinatio et ordo assignantur in habitibus donorum quam in differentiis aliorum habituum gratuitorum.
...
6. Likewise, since every gift regarding affection has its own directive[^5], it seems that the gift of fear too should have its own directive, with which it would be combined; but if it does not have one, it seems that neither should the others have one.

It is asked therefore, what is the reason for combining and ordering[^6] the gifts; and why this sort of combination and order is assigned in the habits of the gifts rather than in the differences of other gratuitous habits.
...
[^2]: **La.** Cod. Z *incipere*.
    **En.** Cod. Z reads *incipere*.

[^3]: **La.** Cfr. supra pag. 612, nota 3. — Edd. perperam *sapere*.
    **En.** Cfr. above pag. 612, nota 3. — The editions wrongly read *sapere*.

[^4]: **La.** Vide Aristot., de Praedicam. c. *de Priori*, et V. Metaph. text. 16. (IV. c. 11.).
    **En.** See Aristotle, *Categories*, the chapter *On the Prior*, and *Metaphysics* V, text 16 (IV, c. 11).

[^5]: **La.** Edd. adiiciunt *cum quo combinetur*.
    **En.** The editions add *with which it would be combined*.

[^6]: **La.** Cod. A subdit *potius*.
    **En.** Cod. A adds *potius* (rather).

[^7]: **La.** Libr. I. c. 4. n. 11: *Sed interest ordinis; nam ibi [in Isaia] enumeratio ab excellentioribus coepit, hic [in Matth. 5, 3.] vero ab inferioribus. Ibi namque incipit a sapientia et desinit ad timorem Dei; sed initium sapientiae timor Domini [Eccli. 1, 16.] est* etc. Cfr. Gregor., II. Homil. in Ezech. homil. 7. n. 7. — Mox pro *a primo* Vat. substituit *ab infimo* et paulo inferius post *Uterque* interserit cum edd. 1, 2 *tamen*.
    **En.** Book I, c. 4, n. 11: *But it makes a difference of order; for there [in Isaiah] the enumeration began from the more excellent, but here [in Matt. 5:3] from the lower. For there it begins from wisdom and ends at the fear of God; but the beginning of wisdom is the fear of the Lord [Eccli. 1:16]*, etc. Cfr. Gregory, *Homilies on Ezechiel* II, homily 7, n. 7. — Shortly, for *a primo* the Vatican edition substitutes *ab infimo*, and a little below after *Uterque* it inserts with edd. 1, 2 *tamen*.

[^8]: **La.** Vide supra pag. 747, nota 6.
    **En.** See above pag. 747, nota 6.

[^9]: **La.** Vat. *dupliciter assignatur* vel *est duplex*.
    **En.** The Vatican edition reads *dupliciter assignatur* or *est duplex*.

[^10]: **La.** Quaest. praeced. et a. 1. q. 1.
    **En.** The preceding question and a. 1, q. 1.

[^11]: **La.** Edd. *maiori*.
    **En.** The editions read *maiori*.

[^12]: **La.** B. Albert., hic a. 4: *Glossa quaedam super Isaiam*; sed Glossa ordinaria apud Strabum et Lyranum in Isai. 11, 2. (sumta ex Hieronymo) nihil huiusmodi dicit. A re autem non multum aliena esse videntur illa verba Gregorii, I. Moral. c. 32. n. 45: «Valde inutilis intellectus est, si ex sapientia non subsistat, quia, cum altiora sine sapientiae pondere penetrat, sua illum levitas gravius ruiturum levat». Idem Gregorius, II. Homil. in Ezech. homil. 7. n. 7. verba Isai. 11, 2. exponens, de intellectu et sapientia dicit: *Ab intellectu ergo ascendatur ad sapientiam, ut hoc quod acute intellectus invenit, sapientia mature disponat*. Cfr. infra lit. Magistri, d. XXXV. c. 2. et ibid. Comment. q. 1. et 3. — Superius pro *alio regulante* codd. H K Z *aliquo regulante*.
...
[^13]: **La.** Sic Vat. rectius quam codd. et edd. 1, 2, qui exhibent *fortitudinis*.
    **En.** So the Vatican edition, more correctly than the codices and edd. 1, 2, which present *fortitudinis*.

[^14]: **La.** Cfr. hic lit. Magistri, c. 5. — De ratione seq. vide supra d. 26. a. 2. q. 1. ad 1. et 2. — Inferius pro *habitus cognitivos* codd. A F H I L V Z aa bb *habitus cognitionis*.
    **En.** Cfr. here the text of the Master, c. 5. — On the reason of what follows see above d. 26, a. 2, q. 1, ad 1 and 2. — Below, for *habitus cognitivos* codd. A F H I L V Z aa bb read *habitus cognitionis*.

## Notes

**Provenance.** RENAMED from `bon-sent-III-d34-p1-a1-q2-dup2.md` (auto-chunked 2026-06-02, mislabeled `a1`) and promoted to Tier 2 (2026-06-12) via `git mv` (history preserved). The `-dup2` triple is ARTICULUS II's q1/q2/q3; this is the correctly-located **a2-q2** (ART. II *Secundo*, *de ordine et combinatione donorum*). Latin re-set from 450 dpi PDF column bands (`/tmp/colcrop/vol3-p{747,748,749}-{L,R}-{0,1,2}.png`) per the Vol III two-column PDF-priority inversion: the IA djvu OCR (raw 51892–52039) is cascade-shattered through the Respondeo *triplex-ratio* and across every footer band, so the column-band PDF read is authoritative there; the OCR served only the clean *videtur* / *contra* running args and footnote-marker spacing. Offset pdf = printed + 22; running-head TEXT (`DIST. XXXIV. P. I. ART. II. QUAEST. II/III.`) trusted over OCR'd digits (raw running heads were intact this span).

**Opener alignment.** PASS 1:1. ART. II *Secundo* (TRACTATIO member *de ordine et combinatione*) = QUAESTIO II header *De donorum ordinatione et combinatione*; body opener *Secundo quaeritur de donorum ordine et combinatione, quae duo valde signanter innuit Isaias…*. The header gloss-line and the opener match the TRACTATIO's second member exactly. `title_la` is composed as a standard *Utrum*-question from the matter (the source prints a topical gloss-title, not an *Utrum*); `title_en` mirrors it short.

**Argument numbering note.** The printed text numbers the six fundamenta 1–3 (*contra ordinem*) then 4–6 (*contra combinationem*), each block flagged by a marginal heading (`Argg. contra ordinem.` / `Argg. contra combinationem.`). The IA OCR garbled the second block's openers (printed `4.` rendered as the bullet `(').`, and the printed `5.`/`6.` shifted); the PDF column bands give the clean 1-2-3 / 4-5-6 sequence reproduced here.

**Page span / page-split map.** Body opens p.747 (R-col QUAESTIO II header beside a2-q1's tail; the q2 opener + six fundamenta fill p.747 both columns below the a2-q1 SCHOLION), CONCLUSIO + Respondeo *triplex-ratio* on p.748, replies + the incident *Quaestio* + this q2's own SCHOLION §I–II on p.749 (closing just before the `QUAESTIO III.` header = sibling a2-q3, raw 52040). Per-page footer map (NOTAE AD COMMENTARIUM, Quaracchi per-page restart, renumbered continuous here):
- **p.747** nn.4–9 → `[^1]`–`[^6]` (PICKED UP — a2-q1 took p.747 nn.1–3; these six anchor the q2 opener + fundamenta: n.4 `capitulo⁴`, n.5 `esse⁵`, n.6 `sapore⁶`, n.7 `posterioritatis⁷`, n.8 `directivum⁸`, n.9 `assignantur` in the closing *Quaeritur ergo*).
- **p.748** nn.1–6 → `[^7]`–`[^12]` (n.1 `monte¹`, n.2 `Philosophus²`, n.3 `duplex est³`, n.4 `praecedentibus⁴`, n.5 `magna⁵`, n.6 `Glossa⁶`; n.1 and n.6 are long composite notes spanning into the R-col footer).
- **p.749** nn.1–2 → `[^13]`–`[^14]` (CROSS-QUESTION SPLIT: the p.749 page footer is shared with a2-q3. n.1 `fortitudine¹` [*Ad 3*] and n.2 `fidei²` / *habitus cognitivos* [incident *Quaestio*] anchor THIS q2's replies; the remaining p.749 footers nn.3–7 anchor a2-q3's *Fundamenta* and are forwarded to it). The SCHOLION carries no apparatus markers.

**Apparatus count = 14.** 6 (p.747) + 6 (p.748) + 2 (p.749) = 14 physical Quaracchi footer notes anchored in this q2's body. Every rendered `[^N]` has a matching anchor in BOTH the Latin and English bodies (14/14 markers pair clean). All markers anchor inside the fundamenta / Respondeo / replies body; the SCHOLION carries none.

**Scholion disposition.** `has_scholion: true`. q2 carries its **OWN** SCHOLION §I–II (printed p.749, OCR `SCHOLION.` at raw ~52023; §I in p.749 L-col bottom, §II bridging L→R-col bottom), placed body-then-scholion LAST in each language block per the parser rule. This was diagnosed (not assumed): a2-q1's master scholion §II was q1-specific (a *De eadem quaestione* dossier on q.1 a.2, NOT a `pro quaest. seq.` forward), so q2 was expected to carry its own — confirmed by the `SCHOLION.` header inside q2's range. **§I** = the *ordo dignitatis* + *combinatio* framing of THIS question (S. Thom. S. I.II q.68 a.7 on Isaiah's order; the two-by-two coupling to *Spiritus* except *timor*; B. Albert, Petr. a Tar.). **§II** opens *Circa seq. (3.) quaestionem…* — it is a forward note ABOUT a2-q3's matter (whether the gifts remain in the Beati: S. Thom./Durand. dispute, then a *De hac (3.) quaestione* cross-ref dossier). This §II is q2's printed scholion text (it physically prints under q2's body, before the QUAESTIO III header) but its content previews q3; it is NOT a redirect that q3 should point back to for its own scholion, so a2-q3 still carries whatever scholion prints in its own range.

**Footer hand-offs.** PICKED UP from a2-q1: the p.747 footer band nn.4–9 (→ `[^1]`–`[^6]`); a2-q1 kept p.747 nn.1–3 (its *Ad 5* tail + *Ad 6*). FORWARDED to `d34-p1-a2-q3`: the **p.749 page footer splits at the q2/q3 seam** — q2 keeps p.749 nn.1–2 (`[^13]`–`[^14]`, anchoring its *Ad 3* + incident-*Quaestio*); **a2-q3 should pick up p.749 nn.3–7** (n.3 `Hic c. 2`; n.4 `Vers. 2. Cfr. hic lit. Magistri c. 3… possunt`; n.5 `Dist. 33. q. 6. — Maior probata est supra…`; n.6 `Psalm. 18, 10… permanens`; n.7 `Art. 1. q. 1… ibi`) anchoring its *Fundamenta* (its `littera²`, `undecimo⁴`, `Psalmo⁶`, `supra⁷` markers). Note n.2/`[^14]` here also carries the *lit. Magistri c. 5* clause which Quaracchi prints once on the shared page; a2-q3's own *Fundamenta* arg 1 (`littera²`) cross-refers the same lit. Magistri material — when building a2-q3, anchor its `littera²` to that page's note independently rather than re-claiming this `[^14]`. The SCHOLION §II is a forward preview of q3's matter, not a redirect target.

**`[?]` flags.** NONE — all three PDF pages (747–749) legible at 450 dpi; the cascade-shattered OCR Respondeo and footer regions were fully recoverable from the column bands.
