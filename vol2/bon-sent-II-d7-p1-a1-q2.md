...
title_en: "Whether in demons there is a continuation of evil will"
printed_pages: [178, 179, 180]
pdf_pages: [200, 201, 202]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 178–180 (Comm. in II Sent., Dist. VII, Pars I, Art. I, Quaest. II; opens lower on p.178 below the preceding question's editorial Scholion tail; SCHOLION I–III runs to the foot of p.180, ending before QUAESTIO III)"
has_scholion: true
has_apparatus: true
line_start: 12993
line_end: 13179
word_count_latin: 2456
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR base (raw 12993–13179) over the 450 dpi pp.178–180 column-band crops (PDF 200–202), read L-then-R per page, body then footer; fresh literal English; SCHOLION I–III (editorial, no numbered apparatus); 17-entry apparatus renumbered continuously (Quaracchi restarts per page: p.178 ¹–⁹ → [^1]–[^9]; p.179 ¹–⁴ → [^10]–[^13]; p.180 ¹–⁴ → [^14]–[^17]). INCOMING a1-q1→a1-q2 split at p.178 RECEIVED clean (no backfill): per committed bon-sent-II-d7-p1-a1-q1 Notes, a1-q1's last numbered apparatus is p.177 [^29], the editorial SCHOLION I–II tail spans p.178 with no numbered apparatus, and QUAESTIO II opens lower on p.178 — all of p.178's footer (¹ Vers. 15 … ⁹ Libr. II. de Serm. Domini) anchors this chunk's videtur/contra, so it is wholly this chunk's; bon-sent-II-d7-p1-a1-q1 not modified. OUTGOING a1-q2→a1-q3 CLEAN (no split): this chunk's last numbered apparatus is p.180 [^17]; the editorial SCHOLION I–III tail carries no numbered apparatus and ends before QUAESTIO III (raw 13180); p.180 footer note ⁵ (Isidorus, Libr. I. c. 10. n. 8) anchors QUAESTIO III's Fundamentum, so it is the next chunk's (bon-sent-II-d7-p1-a1-q3's), no backfill here. No [?] flags — all 17 superscripts + 3 page-footers verified on the 450 dpi column-band crops; raw-OCR digit/word garbles corrected against the crops (e.g. raw 'QU.\\EST10' = QUAESTIO; 'aquilonem^' = Isai. 14,13; 'Wirabilibus' = Mirabilibus; p.180 footer 'pag. 1.59' = pag. 159) (2026-05-19)"
format_version: 1
---

# bon-sent-II-d7-p1-a1-q2
...
1. Secundae ad Corinthios sexto[^1]: *Quae conventio Christi ad Belial?* Glossa: « Sicut Christus omnia bene facit, ita diabolus omnia male »; sed semper facit aliquid, quia est substantia spiritualis, non lassata in operando: ergo etc.

2. Item, primae Ioannis tertio[^2]: *Diabolus ab initio peccat;* Glossa: « Ab initio suae creationis incipiens, peccat continue usque in praesens ».

3. Item, Augustinus, *de Fide ad Petrum*[^3], loquens de daemonibus dicit: « Nec mala possunt voluntate carere nec poena ». *Si tu dicas,* quod loquitur de habitu, non de actu; *obiicitur,* quod de actu, per Hieronymum[^4], qui dicit, quod « diabolus adhuc idem sibi arrogat, quod prius praesumserat ».
...
6. Item, si[^5] posset ab actu malae voluntatis desistere, posset aliquo modo se ad gratiam praeparare, quia dimittere actum peccati est praeparare se ad gratiam; sed ipse nullo modo hoc potest, sicut supra[^6] probatum est: ergo etc.

**Contra:** 1. Iacobi secundo[^7]: *Daemones credunt et contremiscunt;* sed credere et timere non sunt actus malae voluntatis: ergo videtur, quod aliquando moventur sine obliquitate, et ita aliqua est interpolatio.

**On the contrary:** 1. James 2[^7]: *The demons believe and tremble;* but to believe and to fear are not acts of evil will: therefore it seems that they are sometimes moved without obliquity, and so there is some interruption.

2. Likewise, if they tremble, and fear draws [them] back from an evil act, then it seems that they sometimes desist.

3. Likewise, 2 Peter 2[^8]: *The demons do not bring against themselves an execrable judgment;* the Gloss: "Terrified by the magnitude of the punishments, they desist from the judgment of presumption": therefore it seems that the perversity of presuming has ceased in them, at least as to act.

4. Likewise, demons naturally love God, whence Augustine says[^9] that "no one's conscience can hate God"; and even if he did not say [it], it seems true, because "vice does not destroy the last traces of nature." If, therefore, to love God is natural, then they are still capable and apt for this act. Grant, then, that they go forth into act, since they are not moved by several motions at once; then, as it seems, they cease from the act of evil will.
...
[^8]: **La.** Vers. 11. — Glossam refert Strabus loc. cit.

    **En.** Verse 11. — Strabo reports the Gloss in the place cited.

[^9]: **La.** Libr. II. de Serm. Domini, c. 14. n. 48. Vide supra d. 5. dub. 1. — Sequens textus est August., XIX. de Civ. Dei, c. 12. n. 2: Nullum quippe vitium ita contra naturam est, ut naturae deleat etiam extrema vestigia.

    **En.** Book II of *On the Lord's Sermon [on the Mount]*, ch. 14, n. 48. See above, d. 5, dub. 1. — The following text is Augustine, *City of God* XIX, ch. 12, n. 2: "For no vice is so contrary to nature that it destroys even the last traces of nature."

[^10]: **La.** Libr. I. c. 2: Praeterea quoque ad cumulum diabolici peccati illud accidit, quod statim postquam peccavit, foveam desperationis incurrit.

    **En.** Book I, ch. 2: "Moreover, this too belongs to the heap of the devil's sin, that immediately after he sinned, he fell into the pit of despair."

[^11]: **La.** Isai. 14, 13. Cfr. supra pag. 137, nota 5.

    **En.** Isaiah 14, 13. Cf. above, p. 137, note 5.

[^12]: **La.** In cod. I (cod. bb a secunda manu) propter subnexa non male additur *sicut.*

    **En.** In codex I (codex bb by a second hand), on account of what follows, *sicut* is not badly added.

[^13]: **La.** Supple: a malo actu. — Vat. paulo ante *timet* pro *timent.* Circa finem solutionis cod. T *ita ipso timore* pro *in ipso timore.*

    **En.** Supply: *a malo actu* (from the evil act). — The Vatican edition, a little before, [reads] *timet* for *timent.* Near the end of the solution codex T [reads] *ita ipso timore* for *in ipso timore.*

[^14]: **La.** Vat. cum nonnullis mss. omittit *et ab omni; in interiori potest cessare ab hoc;* quibus omissis propositio redditur falsa. In his verbis, contextu postulante, ante *interiori* supplevimus particulam *in,* quae in codd. et ed. 1 desideratur et facile excidere potuit.

    **En.** The Vatican edition with several manuscripts omits *et ab omni; in interiori potest cessare ab hoc;* with these omitted the proposition is rendered false. In these words, as the context requires, before *interiori* we have supplied the particle *in,* which is wanting in the manuscripts and the first edition and could easily have fallen out.

[^15]: **La.** Cod. cc et ed. 1 *perversa.*

    **En.** Codex cc and the first edition [read] *perversa.*

[^16]: **La.** Cfr. supra pag. 159, nota 3. et scholion ad eandem quaest.

    **En.** Cf. above, p. 159, note 3, and the scholion to the same question.

[^17]: **La.** Plures codd. cum ed. 1 *idem;* cod. A *illud idem.*

    **En.** Several manuscripts with the first edition [read] *idem;* codex A [reads] *illud idem.*

---

## Notes

- This chunk is **ARTICULUS I, QUAESTIO II** of the COMMENTARIUS on Distinction VII, **Pars I** (*De obstinationis malignitate quoad malos spiritus*) — *Utrum in daemonibus sit malae voluntatis continuatio* (whether, granted that the demonic will admits no rectification, there is nonetheless a *continuation* of evil will in them). Structure: a *Supposito… quaeritur secundo* opener tying back to a1-q1's conclusion + 6 *videtur* (2 Cor. 6 / 1 John 3 / Aug. *de Fide ad Petrum* with the *Si tu dicas… obiicitur* habitus-vs-actus exchange / *ratione* on obstinacy = confirmation in prior evil / the parallel with angels confirmed in good / the "if he could desist he could prepare for grace" reductio) + **Contra** in 7 members (the 4th and 7th the load-bearing ones: *naturaliter diligunt Deum* and the *dilectio* vs *appetitus* distinction) + *Conclusio* (blockquote) + a tripartite **Respondeo** (evil will *quantum ad deformitatem / pronitatem / actualitatem* — only deformity is strictly invariant; proneness and actuality continue but vary in mode/kind) + a 7-member **Solutio** (the *actus bonus/malus dupliciter ex se / ex adiuncto* analysis; the latro-and-gallows simile; the avarus-and-beatitudo example for the deformed natural act; the *appetitus absolutus/deliberatus* vs *appetitus velleitatis* resolution of the last objection) + editorial **Scholion I–III**.
- **Source discipline (Vol II override).** Latin re-set from the IA djvu OCR base (raw 12993–13179) over the 450 dpi pp.178–180 column-band crops (`tools/extract-pages.py --volume vol2 --pages 179-180 --dpi 450`; p.178 image + colcrops were already cached from the a1-q1 build; `tools/colcrop.py vol2 {178,179,180}`), read **Left column top→bottom, then Right column**, body bands then footer band, reflowed column-by-column (not raw-line order). The Respondeo + Solutio + every page-footer are the cascade-shattered regions where the column-band PDF read is authoritative (raw OCR for this chunk shattered the Solutio especially badly — e.g. raw `Solutio op-positorum` / `Duplex actus bonus et ma-lus` / `Ad aiion;m` blocks diagonally fragment one-token-per-line); the videtur/contra running prose is clean OCR base. Editorial marginal glosses bleeding inline (*Fundamenta, Ad oppositum, Distinctio, Conclusio 1/2/3, Solutio oppositorum, Duplex actus bonus et malus, Solutio aliorum, Alia solutio, Notabile exemplum, Duplex causa, Duplex appetitus, Ad aliorum suppositionem*) trimmed per CLAUDE.md.
- **`has_scholion: true`.** The editorial SCHOLION I–III (Scotus on the unprovable impossibility of demons eliciting morally-good non-meritorious acts; the Richard of Mediavilla *demeritum/poena acta non inflicta* citation; the cross-doctor survey for the *intensio malitiae* question taken up in the next quaestio) carries **no numbered apparatus** — only inline parenthetical cross-refs (infra d. 28 a. 2 q. 3; infra d. 36 d. 5; supra d. 6 a. 2 q. 4; infra d. 8 p. I a. 1 q. 2; Scot. Report. here q. 3; Alex. Hal. S. p. II q. 101–102; B. Albert. S. p. II tr. 3 q. 23). Consistent with the Vol II editorial-scholion pattern (a1-q1's Scholion I–II; d4-a1-q1; d5-a1-q1).
- **Cross-chunk footer — INCOMING a1-q1→a1-q2 at p.178 (RECEIVED clean, no backfill).** The committed `bon-sent-II-d7-p1-a1-q1` Notes document the OUTGOING side: a1-q1's last numbered apparatus is p.177 [^29] (`Plures codd. ut C H R S incurabili corporali…`); the editorial SCHOLION I–II tail spans the top of p.178 carrying **no** numbered apparatus; QUAESTIO II opens lower on p.178. So **all of p.178's footer is this chunk's** — p.178 ¹ `Vers. 15. — Glossa… apud Petrum Lombardum…` → [^1] (videtur 1, 2 Cor. 6:15), ² `Vers. 8.` → [^2] (videtur 2, 1 John 3:8), ³ `Cap. 3. n. 33. Cfr. supra pag. 175, nota 7.` → [^3] (videtur 3, *de Fide ad Petrum*), ⁴ `Cfr. Comment. in Iob. 24, 17…` (its L→R footer runover `operibus vitam agens… — Liber hic non est S. Hieronymi.` recombined) → [^4] (videtur 3, *per Hieronymum*), ⁵ `Supple cum cod. Q…` → [^5] (videtur 6 *si*), ⁶ `Quaest. praeced.` → [^6] (videtur 6 *supra*), ⁷ `Vers. 19.` → [^7] (Contra 1, James 2:19), ⁸ `Vers. 11. — Glossam refert Strabus…` → [^8] (Contra 3, 2 Pet. 2:11), ⁹ `Libr. II. de Serm. Domini, c. 14. n. 48…` → [^9] (Contra 4, Augustine). Verified by lemma on the cached p.178 crops; `bon-sent-II-d7-p1-a1-q1` not modified, no backfill.
- **Cross-chunk footer — OUTGOING a1-q2→a1-q3 at p.180 (CLEAN, no split).** This chunk's last numbered apparatus is **p.180 [^17]** (`Plures codd. cum ed. 1 idem; cod. A illud idem.`, Solutio 7 *se ad illud*). The editorial SCHOLION I–III tail spans the foot of p.180 carrying **no** numbered apparatus; QUAESTIO III (*Utrum mala voluntas in daemonibus intendatur* — next chunk `bon-sent-II-d7-p1-a1-q3`) opens at the very foot of p.180 (raw 13180). p.180 footer note **⁵** (`Libr. I. c. 10. n. 8, ubi textus originalis Diabolus non solum hoc contentus, quod etc.`) anchors QUAESTIO III's Fundamentum (*Isidorus de Summo Bono⁵*), so it is **`bon-sent-II-d7-p1-a1-q3`'s** — no backfill here; flagged for that chunk's build (p.180's ¹ → this chunk's [^14], ² → [^15], ³ → [^16], ⁴ → [^17]; ⁵ to a1-q3). The clean no-apparatus-scholion-tail boundary pattern (as a1-q1→a1-q2, d4-a1-q1→a1-q2, d5-a1-q1→a1-q2).
- **Apparatus crosswalk:** p.178 ¹–⁹ → [^1]–[^9]; p.179 ¹–⁴ → [^10]–[^13] (¹ Aug. *de Mirabilibus sacrae Scripturae* Libr. I. c. 2 — note the *Liber hic non est S. Hieronymi* clause belongs to the *prior page's* Job note [^4], not here; ² Isai. 14,13; ³ cod. I *sicut* addition; ⁴ *Supple a malo actu* + *timet/timent* + cod. T variant); p.180 ¹–⁴ → [^14]–[^17] (¹ the editorially-supplied *in interiori* + *et ab omni* omission note; ² cod. cc *perversa*; ³ supra pag. 159 + scholion cross-ref; ⁴ *idem* / *illud idem* variant).
- **No `[?]` flags.** All 17 body superscripts + the 3 page-footers verified on the 450 dpi column-band crops. Raw-OCR garbles silently corrected against the crops: heading `QU.\EST10 II.` = QUAESTIO II; `Wirabilibus` = Mirabilibus; `aquilonem^` superscript = the Isai. 14,13 marker [^11]; `^"` / `*` / `'` footer openers on p.178 R disambiguated to ⁷ ⁸ ⁹ by the cached R-2 crop; p.180 footer `pag. 1.59` (raw-OCR dotted) confirmed *pag. 159* on the p.180 R-2 crop. The cascade-shattered Solutio (p.179 R / p.180 L–R) reflowed entirely from the column-band crops, not raw-line order.
