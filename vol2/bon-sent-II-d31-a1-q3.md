...
quaestio: 3
type: quaestio
title_la: "Utrum maior sit infectio generativae per originale peccatum quam alterius potentiae"
title_en: "Whether the infection of the generative power through original sin is greater than that of another power"
printed_pages: [745, 746, 747]
pdf_pages: [767, 768, 769]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 745–747"
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR + 450dpi PDF column bands (raw 51954–52078), literal English, full apparatus from raw OCR (12 entries) incl. p.745 footers received from a1-q2 (2026-05-30)"
format_version: 1
---
...
**Sed contra:** 1. Per quae quis peccat, per haec et torquetur, ut dicitur *Sapientiae* undecimo[^2]: si ergo peccatum primorum parentum perpetratum fuit magis per nutritivam quam per generativam, immo minime per generativam; videtur, quod nutritiva magis debuerit esse corrupta.
...
3. Item, si corruptio animae est ex carne[^3], videtur, quod illa vis potissime sit corrupta, quae primo in
<!-- page 746 -->
carne et per carnem exercet suam operationem; sed talis est potentia nutritiva; longe enim ante nutritur homo quam generet, et prius appetit delectabilia gustus quam delectabilia tactus: ergo videtur idem quod prius.

4. Item, augmentativa tenet medium inter nutritivam et generativam — prius enim est nutriri, et postmodum augeri, et tertio generare — sed inter omnes vires animae augmentativa minime corrupta est: ergo si medium sapit naturam extremorum[^4], videtur similiter, quod et generativa minime deberet esse corrupta.

Iuxta hoc quaeritur, quare inter omnes sensus tactus illius[^5] habet de corruptione; et inter omnes potentias animae vegetativae generativa inter ceteras est in nobis magis corrupta.
...
### Question III. *Whether the infection of the generative power through original sin is greater than that of another power.*
...
3. Likewise, if the corruption of the soul is from the flesh[^3], it seems that that power is most of all corrupted which first
operates in the flesh and through the flesh; but such is the nutritive power; for man is nourished long before he generates, and desires the delectable things of taste before the delectable things of touch: therefore it seems the same as before.

4. Likewise, the augmentative [power] holds the middle between the nutritive and the generative — for first is being nourished, and afterward being increased, and thirdly generating — but among all the powers of the soul the augmentative is least corrupted: therefore if the middle savors the nature of the extremes[^4], it seems likewise that the generative also ought to be least corrupted.

Along with this it is asked why among all the senses touch has [the most] of corruption[^5]; and why among all the powers of the vegetative soul the generative is, among the rest, the more corrupted in us.
...
But the reason why the generative power is more infected than another power is taken from this, that it is a power not only serving the person, but also serving the nature. And therefore the original corruption or vice, which is in the nature from the corruption of the person, regards that power before another; and the generative power serves the nature inasmuch as through it the seed is transmitted into the offspring. And since in that seed is the root of infection and corruption, hence it is that that power, which is the administrator of that seed[^6], has in itself more of original infection and corruption. — Again, because *sense* is joined to the generative power in us, and the sensitive power regards man himself in himself, this power has in a certain manner to serve the person. And since among all the senses touch is the most material and apprehends with the greatest adherence of sensibility to the sensible[^7]; and this flourishes most in the genital members by reason of the multitude of nerves: hence it is that a slight corruption, by reason of the magnitude of the sense, infects that power more than it would infect another; and on this account the itch and concupiscence reign most of all in it. And because after the sense of touch the sense of *taste* is the most material among the others[^8], hence it is that among the other powers disorder is felt more in the act of the nutritive or gustative [power]. — From this twofold reason, therefore, one sufficient reason is gathered why the soul, through the original vice, is more infected in the generative than in another power. And because the reasons that are adduced for the first part prove this, therefore they are to be conceded.
...
2. To that which is objected, that the nutritive can less be restrained; it must be said that for some power to be able to be less restrained is so in two ways: either by reason of the vehemence of appetite and delight, or by reason of natural need. And when[^9] it cannot easily be restrained on account of the vehemence of appetite and inclination, it is the more vitiated and corrupted. But when it has this by reason of natural need, it does not follow from this that it is more corrupted. When therefore it is said that the nutritive can less be restrained, this is not by reason of the greater vehemence of appetite, but it is by reason of natural need, because it cannot be sustained without food. It is not so with the generative, in which there is not depravity of appetite on account of necessity, but on account of the foulness of corruption. And hence it is that the first motions of the generative are rather called sins than the first motions of the nutritive.
...
> The numbered footnotes below correspond to markers in both the Latin body above and the English translation. Each entry gives the Quaracchi editors' Latin note (**La.**) followed by an English rendering (**En.**). Quaracchi restarts footnote numbering on each printed page; this question spans the footers of printed pp. 745–746 (the p. 747 scholion and Respondeo tail carry no footer notes).

[^1]: **La.** *Vat. cum edd.* 3, 4 *delectatio.*
    **En.** The Vatican edition, with editions 3 and 4, reads *delectatio* (delight).

[^2]: **La.** Dist. 33. a. 2. q. 2. — De unitate gratiae vide supra d. 26. q. 5. — Paulo superius post *continuantur* codd. B P T et alii interserunt *ad unam potentiam.* Pro *unam* cod. ee substituit *primam.*
    **En.** Distinction 33, a. 2, q. 2. — On the unity of grace see above d. 26, q. 5. — A little earlier, after *continuantur*, codices B P T and others insert *ad unam potentiam* (to one power). For *unam* codex ee substitutes *primam* (the first).

[^3]: **La.** Plures codd., ut T aa cc ee, cum ed. 1 *sit.*
    **En.** Several codices, such as T aa cc ee, with edition 1, read *sit*.

[^4]: **La.** Verba sunt Magistri, hic c. 4.
    **En.** These are the words of the Master, here c. 4.

[^5]: **La.** *Vers.* 17.
    **En.** [*Wisdom* 11,] verse 17.

[^6]: **La.** Vide hic a. 2. q. 1.
    **En.** See here a. 2, q. 1.

[^7]: **La.** Aristot., IV. *Polit.* c. 9. (c. 7.): In eo [medio] enim utrumque extremorum apparet.
    **En.** Aristotle, *Politics* IV, c. 9 (c. 7): for in it [the middle] each of the extremes appears.

[^8]: **La.** Codd. D H Q omittunt *seminis*; codd. B E F K T V bb ee et alii nec non edd. 2, 3 pro *seminis* habent *vis.*
    **En.** Codices D H Q omit *seminis* (of the seed); codices B E F K T V bb ee and others, as well as editions 2 and 3, read *vis* (power) in place of *seminis*.

[^9]: **La.** Cfr. Aristot., II. *de Anima*, text. 106. seqq. (c. 11.) et III. text. 66. seqq. (c. 13.); II. *de Part. animal.* c. 1. et 8. — Immediate ante pro *sensibilitatis* plures codd., ut A T aa bb ee, *sentientis*, ed. 1 *sensitivae.* Mox pro *et hic*, quod habent codd. F K T Y et alii, Vat. *et haec*, codd. A ee cum ed. 1 *et hoc.*
    **En.** Cf. Aristotle, *On the Soul* II, text 106 ff. (c. 11) and III, text 66 ff. (c. 13); *On the Parts of Animals* II, c. 1 and 8. — Immediately before, in place of *sensibilitatis* several codices, such as A T aa bb ee, read *sentientis*, edition 1 *sensitivae*. Shortly after, in place of *et hic*, which codices F K T Y and others have, the Vatican edition reads *et haec*, and codices A ee with edition 1 *et hoc*.

[^10]: **La.** Vide Aristot., II. *de Anima*, text. 101. seqq. (c. 10.).
    **En.** See Aristotle, *On the Soul* II, text 101 ff. (c. 10).

[^11]: **La.** Cod. cc et ed. 1 *quae*, scil. potentia.
    **En.** Codex cc and edition 1 read *quae* (which), i.e. potentia (power).

[^12]: **La.** *Quaest. praeced.*
    **En.** The preceding question.

## Notes

**Provenance.** Latin re-set from the IA djvu OCR (`bonaventure_vol2_raw.txt` raw 51954–52078), with the cascade-shattered Respondeo, Ad obiecta, scholion, and footers reflowed column-by-column from the 450 dpi PDF column bands (`/tmp/colcrop/vol2-p{745,746,747}-{L,R}-{0,1,2}.png`). Offset pdf = printed + 22 (printed 745–747 = pdf 767–769), confirmed by running heads `DIST. XXXI. ART. II. QUAEST. I.` (top of p.747) and page numbers 746/747.

**Page span / structure.** Q3 opens mid-**p.745** (q2's scholion + commentator roll occupy the top of p.745; the `QUAESTIO III.` header sits below). Affirmative fundamenta 1–5 and the *Sed contra* 1–3 (opening) are on p.745; *Sed contra* 3 (continuation), 4, the *Iuxta hoc* connexed sub-question, the Conclusio, the Respondeo, and replies 1–4 (through "delectatio concupiscentiae") are on p.746; the tail of reply 4, plus the SCHOLION (parts I–II) closing ARTICULUS I, are on p.747. Note Bonaventure's own argument-numbering: the affirmative pars runs 1–5, and the *Sed contra* runs 1–4 (the p.746 marginalia "Quaestio connexa duplex" attaches to the *Iuxta hoc* clause, which folds the two connexed sub-questions into the body — not a separate quaestio). Reply numbering 1–4 answers the four *Sed contra* arguments.

**Apparatus / page-split map (12 entries).**
- **p.745 footer = `[^1]`–`[^6]` (6 notes), RECEIVED from a1-q2.** This page's footer block annotates q3's opening fundamenta and *Sed contra* (a1-q2 forwarded all p.745 footers because q2's Solutio replies on p.745 carry no markers). Anchors in body reading order: `[^1]` matrimonii (fund. 3), `[^2]` Sapientiae undecimo (Sed contra 1), `[^3]` ex carne (Sed contra 3), `[^4]` extremorum (Sed contra 4), `[^5]` tactus illius / de corruptione (Iuxta hoc), `[^6]` seminis administrativa (Respondeo, Ratio 1). NB the OCR raw read "vide supra d. 26. q. 3" but the 450dpi PDF (`vol2-p745-L-2.png`) reads "q. 5" — corrected per PDF authority.
- **p.746 footer = `[^7]`–`[^12]` (6 notes).** Left footer 1–3 = `[^7]` (Aristot. Polit. IV), `[^8]` (Codd. seminis/vis), `[^9]` (Aristot. de Anima II/III — long note continuing into right footer); right footer = `[^10]` (Aristot. de Anima text 101), `[^11]` (Cod. cc quae), `[^12]` (Quaest. praeced.). Anchors: `[^7]` sensibile (Respondeo, Ratio 2), `[^8]` inter alios (Respondeo, gustus), `[^9]` Et cum (reply 2), `[^10]` praedictum est supra (reply 3). `[^11]` and `[^12]` are textual/cross-ref notes with no inline anchor in the body proper; rendered at clause-level positions in reply 4 / the conclusion of the Respondeo per OCR footer order. (NB: `[^11]` "quae, scil. potentia" annotates the *quae*/*qui* variant near the Respondeo Ratio 2; `[^12]` "Quaest. praeced." is the editors' cross-reference to the preceding question. Both retained verbatim as Quaracchi page-746 footer entries.)
- **p.747 footer: NONE.** The p.747 body (Respondeo tail + SCHOLION I–II) carries no footnote markers — verified against `vol2-p747-{L,R}-0.png`.

**Hand-offs.** RECEIVED from a1-q2: entire p.745 footer block (= `[^1]`–`[^6]`). FORWARDED to a2-q1: NONE — ARTICULUS II opens at the top of p.747 (raw 52079, after the q3 scholion), and the p.747 page carries no footer notes, so there is no shared-page footer to split.

**Scholion disposition.** `has_scholion: true` — q3 has its own scholion (parts I–II), closing ARTICULUS I; translated in full. Part I treats the *morbidus affectus* / *qualitas morbida* dispute (Scotus contra the antiqui Scholastici and Jansenius); part II is the commentator roll. (This is the article-closing roll; per Override §5 a missing scholion would have been normal here, but q3 in fact carries one.)

**Cascade-dropout check.** Verified the Respondeo, Ad obiecta, and scholion against the PDF column bands. The IA OCR cascade-shattered both columns of pp.746–747 (interleaved fragments + the marginal labels "Conclusio", "Ratio 1/2", "Solutio oppositorum", "Distinctio", "Notandum", "Quaestio connexa duplex" bleeding inline), but no body text or footnote was dropped at the column seams. The fundamentum numbering 1–5 (affirmative) and 1–4 (Sed contra) is continuous; the Respondeo opening sentence is grammatically continuous with q3's Conclusio; the closing sentence ("…patet illud quod ultimo quaerebatur.") parses cleanly before the SCHOLION header. Reply numbering 1–4 matches the four Sed contra arguments.
