...
quaestio: 3
type: quaestio
title_la: "Utrum omnis compositio sit a Deo"
title_en: "Whether every composition is from God"
printed_pages: [867, 868]
pdf_pages: [889, 890]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 867–868"
line_start: 60343
line_end: 60447
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR + 450dpi PDF column bands (raw 60343–60447), literal English, full apparatus from raw OCR (14 entries: p.867 footers 1–8 + p.868 footers 1–6), no scholion (refers to previous question's scholion per p.868 footer 6) (2026-05-30)"
format_version: 1
---

# bon-sent-II-d37-a1-q3
## *Articulus I, Quaestio III — Utrum omnis compositio sit a Deo*
...
1. Ubicumque est aliqua compositio, ibi est aliqua componentis actio[^1]; sed omnis actio est a Deo: ergo omnis compositio est a Deo.
...
1. Wherever there is any composition, there is some action of a composer[^1]; but every action is from God: therefore every composition is from God.
...
3. Likewise, wherever there is composition, there is some union; and wherever there is union, there is some unity; but every unity is from the first unity[^2]; but the first and highest unity is God: therefore every composition is from God.

4. Likewise, Augustine *On True Religion*[^3]: « Every thing has these three, namely that it be some *one* thing, and be discerned by its proper *species*, and not exceed the *order* of things »; but, as Augustine says in the eleventh [book] *On the City of God*, « from him is every *mode*, and every *species*, and every *order*, without which nothing can exist or be conceived »: therefore if every composite and every composition in some manner exists, it seems therefore that every composition is from God.
...
[^2]: **La.** Boeth., de Unitate et uno: *Unitas est descendens a prima Unitate, quae creavit eam. Prima enim et una Unitas, quae est unitas sibi ipsi, creavit aliam unitatem, quae est infra eam.* Cfr. August., de Vera Relig. c. 36. n. 66. et 11. de Morib. Manich. c. 6. n. 8., et Dionys. de Div. Nom. c. 1. § 1. et c. 13. § 2.
    **En.** Boethius, *On Unity and the One*: *Unity is something descending from the first Unity, which created it. For the first and one Unity, which is unity to itself, created another unity, which is below it.* Cfr. Augustine, *On True Religion* c. 36. n. 66. and 11. *On the Morals of the Manichees* c. 6. n. 8., and Dionysius, *On the Divine Names* c. 1. § 1. and c. 13. § 2.

[^3]: **La.** Cap. 7. n. 13. Vide supra pag. 829, nota 4. — Seq. textus est loc. cit. c. 1-5, ubi textus originalis sic: *sine quibus nihil rerum inveniri vel cogitari potest.*
    **En.** Chapter 7. n. 13. See above p. 829, note 4. — The following text is from the cited place, c. 1-5, where the original text [reads] thus: *without which nothing of things can be found or conceived.*

[^4]: **La.** Vers. 4. — Glossa, quae est *ordinaria* et secundum August., in Ioan. Evang. tr. 1. n. 13, habetur apud Strabum et Lyranum. In secunda propositione Glossae post *creaturis* Vat. nec non codd. F T et alii adiiciunt *facta*.
    **En.** Verse 4. — The Gloss, which is the *ordinary* [Gloss] and is according to Augustine, in [his commentary] on the Gospel of John, tractate 1. n. 13, is found in Strabus and in Lyranus. In the second clause of the Gloss, after *creaturis* ("in creatures") the Vatican [edition] as well as codd. F T and others add *facta* ("made").

[^5]: **La.** Vide supra pag. 808, nota 4. — In fine arg. pro *sit* edd., excepta 1, substituunt *possit esse.*
    **En.** See above p. 808, note 4. — At the end of the argument, for *sit* ("be") the editions, except 1, substitute *possit esse* ("can be").

[^6]: **La.** Edd. praeter 1 cum nonnullis codd. *commisceretur.*
    **En.** The editions besides 1, with several codices, [read] *commisceretur.*

[^7]: **La.** Ut cum dicitur: *haec res est facilis, vel difficilis ad dissolvendum* etc.
    **En.** As when it is said: *this thing is easy, or difficult, to dissolve* etc.

[^8]: **La.** Secundum Aristot., II. Ethic. c. 6. Cfr. tom. I. pag. 32, nota 6. — In propos. seq. post *quemadmodum actio* non pauci codd., ut C F H L S (T a prima manu) etc., cum edd. 1, 2 omittunt *quae*; mendose, nisi etiam pariter omittitur *est* post *coniuncta*, quae lectio sic moderata habetur in codd. bb et T (a secunda manu). Subinde codd. V X *sive inordinatio* pro *et inordinatio.*
    **En.** According to Aristotle, II. *Ethics* c. 6. Cfr. tom. I. p. 32, note 6. — In the following clause, after *quemadmodum actio* not a few codices, such as C F H L S (T by a first hand) etc., with edd. 1, 2 omit *quae*; mistakenly, unless *est* after *coniuncta* is likewise omitted, which reading thus moderated is found in codd. bb and T (by a second hand). Then codd. V X [read] *sive inordinatio* ("or disorder") for *et inordinatio* ("and disorder").

[^9]: **La.** Vat. expunxit hoc *secundum quod.*
    **En.** The Vatican [edition] struck out this *secundum quod* ("insofar as").

[^10]: **La.** Edd., excepta 1, cum nonnullis codd. *Unde.*
    **En.** The editions, except 1, with several codices, [read] *Unde* ("Whence").

[^11]: **La.** Vat. cum edd. 3, 4 nec non codd. F ee et pauci alii *impossibilia*; econtra cod. bb etiam infra *incompossibilia.*
    **En.** The Vatican [edition] with edd. 3, 4 as well as codd. F ee and a few others [read] *impossibilia*; on the contrary cod. bb [reads] also below *incompossibilia.*

[^12]: **La.** Cfr. I. Sent. d. 41. a. 2. q. 1.
    **En.** Cfr. I. Sent. d. 41. a. 2. q. 1.

[^13]: **La.** Pro *annexam deformitatem*, quam lectionem in codd. A E K L M Q W X Y bb et aliis invenimus, codd. H U *monstruositatis deformitatem*, cod. D *luxuriam et deformitatem*, codd. C S T *luxuriam deformitatem* (!), cod. ee *luxuriam deformantem*, edd. praeter 1 *luxuriam deordinantem*, ed. 1 *deformitatem* tantum. Paulo inferius pro *quae venit* (scil. deformitas) Vat. *qui venit.* Cfr. Aristot., IV. de Generat. animal. c. 4.
    **En.** For *annexam deformitatem* ("attached deformity"), which reading we find in codd. A E K L M Q W X Y bb and others, codd. H U [read] *monstruositatis deformitatem*, cod. D *luxuriam et deformitatem*, codd. C S T *luxuriam deformitatem* (!), cod. ee *luxuriam deformantem*, the editions besides 1 *luxuriam deordinantem*, ed. 1 *deformitatem* only. A little below, for *quae venit* (namely the deformity) the Vatican [edition reads] *qui venit.* Cfr. Aristotle, IV. *On the Generation of Animals* c. 4.
...
**Provenance.** Latin re-set from IA djvu OCR (raw 60343–60447), with the cascade-fragmented two-column Respondeo (the *Tripliciter dicitur compositio / Conclusio / Notandum / Corollarium / Solutio oppositorum / Distinctio / Notanda solutio* marginalia spliced mid-line in the OCR) and all page-footers verified against 450 dpi PDF column bands (printed pp. 867–868, offset pdf = printed + 22 → pdf pp. 889–890). Read Left column top→bottom then Right column for each page; body bands then footer bands. The marginal annotations were stripped and the text reflowed column-by-column from the PDF.

**Boundary (coordinator-verified, held).** This chunk = ARTICULUS I, QUAESTIO III only. Opens at the full-width `QUAESTIO III. / Utrum omnis compositio sit a Deo` header (raw 60343, p.867 top below the `DIST. XXXVII. ART. I. QUAEST. III. 867` running head), body "Tertio quaeritur, utrum omnis compositio sit a Deo." Alignment VERIFIED: opener matches ART I topic 3. The ARTICULUS I header is not repeated (carried by sibling a1-q1 per Override §5). The chunk ENDS at raw 60447, immediately before the `ARTICULUS II. / Utrum actio defectiva sit Deo attribuenda` header (raw 60448, p.868 bottom full-width) — everything from ARTICULUS II onward is d37-a2-q1.

**Page-split / footer map.** Spans printed pp. 867–868 (running heads: p.867 `DIST. XXXVII. ART. I. QUAEST. III. 867`; p.868 verso `SENTENTIARUM LIB. II.`). The QUAESTIO III header + all 4 *Fundamenta* + Sed contra 1–4 + Conclusio + Respondeo (first part) sit on p.867; the Respondeo *Corollarium* tail + Solutiones 1–4 fall on p.868.
- p.867: *Fundamenta* 1–4 (L-col, footers 1–3 anchor here: [^1] *componentis actio* Richard. a S. Vict.; [^2] *prima unitate* Boeth.; [^3] *de Vera Religione* Augustine) + Augustine fundamentum 4 + Sed contra 1–4 + Conclusio + Respondeo opener (R-col, footers 4–8: [^4] *idolum nihil est* Glossa 1 Cor 8; [^5] *praeter intentionem* (monstruositate, Vide pag.808); [^6] *commisceretur* (homo commisceatur bruto); [^7] *rei compositae dispositio* (haec res facilis…); [^8] *coniunctae malo* Aristot. II Ethic. c.6). Footers 1–8 → continuous [^1]–[^8].
- p.868 (verso): Respondeo *Corollarium* tail ("voluntatis; sic compositio…") + Solutio oppositorum replies 1–4. Footers 1–6 → continuous [^9]–[^14]: [^9] *quod a Deo est* (reply 1, Vat. expunxit *secundum quod*); [^10] *quoniam* (reply 1, edd. *Unde*); [^11] *incompossibilia* (reply 2, Vat. *impossibilia*); [^12] *cooperari* (reply 2, I. Sent. d.41 a.2 q.1); [^13] *annexam deformitatem* (reply 3, the long variant note + Aristot. de Gen. animal.); [^14] *non attribuatur* (reply 4, "Vide scholion ad praecedentem quaest.").

**Hand-off received.** NONE. q2 closed mid-p.866 at its own scholion; all p.867 footers anchor in this q3's *Fundamenta* (the *componentis actio*, *prima unitate*, *de Vera Religione* markers etc.) — q3 starts fresh at the top of p.867 with its own footer block.

**Hand-off forwarded to d37-a2-q1.** ARTICULUS II (`Utrum actio defectiva sit Deo attribuenda`, with the article opener `Consequenter quaeritur circa secundum articulum de actione defectiva… Et circa hoc quaeruntur tria` + QUAESTIO I `Utrum actio iniusta, secundum quod iniusta, sit a Deo`) begins at the bottom of p.868 (full-width) and continues on p.869. q3 claims NO footer on p.869 (the p.869 footer block — `s Vide scholion…` already consumed here as [^14]'s twin is actually p.868's footer 6; the ARTICULUS II footers begin fresh on p.869) — all p.869 footers anchor in a2-q1's body and are forwarded entirely to d37-a2-q1. The short ARTICULUS II opener (`Consequenter quaeritur circa secundum articulum… Et circa hoc quaeruntur tria. Primo quaeritur…`) folds into a2-q1 per Override §5.

**Scholion disposition.** ABSENT. q3 has NO scholion of its own — p.868 footer 6 ([^14], anchored at the end of reply 4) reads « Vide scholion ad praecedentem quaest. » ("See the scholion to the preceding question"), directing the reader to q2's scholion. This is the normal Override §5 case (a quaestio legitimately lacking its own scholion). q2's scholion item III already anticipated the sparse commentator coverage for this 3rd question (Alex. Hal., B. Albert). `has_scholion: false`.

**Cascade-dropout check.** PASSED. Both column bands of each of pp. 867–868 read top→bottom. The p.867/868 seam falls inside the Respondeo, between the *Attendendum* paragraph tail ("…sed a defectu creaturae, utpote liberae" — p.867 R-col bottom) and the *Corollarium* continuation ("voluntatis; sic compositio, cui iuncta est deformitas…" — p.868 L-col top): grammatically continuous (the genitive phrase "liberae voluntatis" is split across the page break). No mid-paragraph splice signature found. The p.867 footer block (1–8) is fully present; the p.868 footer block (1–6) is fully present; the p.869 footers belong wholly to a2-q1 (forwarded).
