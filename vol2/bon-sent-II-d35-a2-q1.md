...
quaestio: 1
type: quaestio
title_la: "Utrum modus, species et ordo per quodlibet malum corrumpantur simul et inseparabiliter"
title_en: "Whether mode, species, and order are corrupted by any evil simultaneously and inseparably"
printed_pages: [828, 829, 830]
pdf_pages: [850, 851, 852]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 828–830"
line_start: 57641
line_end: 57819
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR + 450dpi PDF column bands (raw 57641–57819), literal English, full apparatus from raw OCR (12 entries: p.828 footers 1–5 + p.829 footers 1–5 + p.830 footers 1–2), scholion I–II (2026-05-30)"
format_version: 1
---

# bon-sent-II-d35-a2-q1
## *Articulus II, Quaestio I — Utrum modus, species et ordo per quodlibet malum corrumpantur simul et inseparabiliter*
...
Consequenter quantum ad secundum principale quaeritur de modo corrumpendi bonum per peccatum. Et cum dicat Augustinus[^1], quod « malum sit corruptio modi, speciei et ordinis », circa hoc quaeruntur tria.
...
1. Primo per definitionem mali, quam ponit Augustinus[^2]: « Malum est privatio modi, speciei et ordinis ». Si enim haec ratio recta est, ergo debet convenire cuilibet malo: ergo quodlibet malum est privativum istorum trium.

2. Item, impossibile est, esse modum sine specie et ordine, et e converso[^3]; sed quae necessario se concomitantur in esse, necessario se concomitantur in privatione. Si ergo malum est privatio alicuius horum, necesse est, quod simul illa tria habeat corrumpere.

3. Item, maior est connexio in his tribus, videlicet modo, specie et ordine, quam sit in habitibus virtutum, qui sunt diversi formaliter secundum speciem[^4]; sed propter connexionem habituum, cum amittitur unus habitus, necessario et omnes perduntur: ergo multo fortius, cum per malum privatur ordo, privatur simul species et modus.
...
4. Et per hoc patet responsio ad ultimum. Nam etsi modus, species et ordo videantur esse tria bona, non tamen sunt diversa per essentiam, sed dicunt tres comparationes eiusdem boni. — Patet etiam illud quod ultimo quaerebatur, quare scilicet culpa non est in omnibus, in quibus reperitur modus[^14], species et ordo, quia non est privatio illorum trium, secundum quod in eis consistit generalis ratio vestigii, et consistunt circa omnem creaturam, sed prout consistunt circa voluntatem deliberativam.
...
Consequently, with respect to the second principal point, it is asked concerning the manner of corrupting the good through sin. And since Augustine says[^1] that « evil is the corruption of mode, species, and order », concerning this three things are asked.
...
1. First, by the definition of evil which Augustine sets down[^2]: « Evil is the privation of mode, species, and order ». For if this account is correct, then it ought to apply to any evil: therefore any evil is privative of these three.

2. Likewise, it is impossible that there be mode without species and order, and conversely[^3]; but things which necessarily accompany one another in being, necessarily accompany one another in privation. If therefore evil is the privation of any of these, it is necessary that it corrupt those three together.

3. Likewise, there is a greater connection in these three, namely mode, species, and order, than there is in the habits of the virtues, which are formally diverse according to species[^4]; but on account of the connection of the habits, when one habit is lost, necessarily all of them too are lost: therefore much more strongly, when by evil order is taken away, species and mode are taken away together.
...
s mode, species, and order, as it ought, is good. But our will is good when, in moving or operating, it is continued to the divine power[^11] as to the moving principle, and is conformed to it as to the directing rule, and is united to it as to the quieting end; and in the first mode is regarded, in the second species, in the third order, according to comparison in the threefold genus of cause. But whenever anyone sins, he is necessarily discontinued from God as from a moving principle, because God never moves to sin; he is discordant from God as from a directing rule; and he removes himself and is disordered as[^12] from a quieting end, setting up the creature as his end. And in every sin it is necessary that these three concur. — And thus it is clear that every sin corrupts, concerning the will, these three, namely mode, species, and order, simultaneously and inseparably. — And the reasons showing this are to be granted. But to the reasons adduced to the opposite it is easy to respond.
...
2. To that which is objected, that in bodies one can be taken away without the other; it must be said that these in bodies can be taken in two ways: in one way, as they are taken according to diverse dispositions; and in this way one can be taken away without the other, but in this way the character of vestige is not regarded in them. In another way, as they are regarded according to the same according to comparisons, namely as the same substantial form gives mode, species, and order according to diverse comparisons in the threefold genus of cause; and this I say as to first being; or as the same accidental form gives [them] as to well-being[^13]; and in this way it never fails but that, if corruption occurs in mode, consequently it also occurs in species and order, and conversely.
...
[^2]: **La.** De Natura boni, c. 4. — De propos. seq., in qua pro *haec ratio* Vat. et edd. 3, 4 substituerunt *haec definitio*, cfr. Aristot., VII. Metaph. text. 33. (VI. c. 10), ubi docetur, definitionem esse rationem (λόγον), et VI. Topic. c. 1, ubi inter alia habetur illud: Oportet enim hominis definitionem de omni homine verificari.
...
[^11]: **La.** Vat. *voluntati.*
    **En.** The Vatican [edition] reads *voluntati* ("to the will") [for *virtuti*].

[^12]: **La.** Ita plures codd., ut F H W cc etc., cum ed. 1; alii non pauci, inter quos C K L O S Z bb ee, cum edd. 2, 3 *aliquid*, Vat. *se* pro *tanquam.*
    **En.** Thus several codices, such as F H W cc etc., with ed. 1; not a few others, among which C K L O S Z bb ee, with edd. 2, 3 [read] *aliquid*, the Vatican [edition reads] *se* for *tanquam.*

[^13]: **La.** Vat. addit *salvat in esse, vel bene et beate esse.* — Aliquanto superius pro *prout attenduntur* codd. K T V bb cc ee et alii cum edd. 1, 2, 3 *prout attenditur.*
    **En.** The Vatican [edition] adds *salvat in esse, vel bene et beate esse* ("preserves in being, or in well- and blessedly-being"). — Somewhat above, for *prout attenduntur* the codices K T V bb cc ee and others, with edd. 1, 2, 3, [read] *prout attenditur.*

[^14]: **La.** Codd. C L R S W bb etc. *numerus.*
    **En.** Codices C L R S W bb etc. [read] *numerus* ("number") [for *modus*].

## Notes

**Provenance.** Latin re-set from IA djvu OCR (raw 57641–57819), with the cascade-fragmented ARTICULUS II opener, Respondeo (three modes), Solutio ad obiecta 1–4, SCHOLION, and all page-footers verified against 450 dpi PDF column bands (printed pp. 828–830, offset pdf = printed + 22 → pdf pp. 850–852). Read Left column top→bottom then Right column for each page; body bands then footer bands.

**Folded ART II opener (per Override §5).** This chunk folds in the short ARTICULUS II opener (`ARTICULUS II. / De modo, quo peccatum bonum corrumpit.` + `Consequenter quantum ad secundum principale… circa hoc quaeruntur tria.` + the 3-question listing, raw ~57641–57651, p. 828 L/R) as headings + opening paragraph — no standalone divisio chunk. The 3-question listing is: (1) *utrum per quodlibet malum corrumpantur ista tria simul et inseparabiliter* (this q1); (2) *utrum haec tria per malum corrumpantur aequaliter sive aeque principaliter* (q2, raw 57820); (3) *utrum possint corrumpi totaliter* (q3, raw 57930 — skeleton MISSING, must be created from scratch).

**Alignment check (coordinator-verified, held).** After the folded opener, q1's body opener (`Circa primum sic proceditur et quaeritur, utrum per quodlibet malum habeant ista tria… corrumpi simul et inseparabiliter`) matches topic (1). No q-swap.

**Boundary.** This chunk = ARTICULUS II, QUAESTIO I only. ENDS at raw 57819, immediately before `QUAESTIO II.` (raw 57820, *Utrum modus, species et ordo corrumpantur per peccatum aequaliter*) — everything from 57820 onward is d35-a2-q2.

**Page-split / footer map.** Spans printed pp. 828–830, offset +22.
- p. 828 (running head over R col; ART II opener + QUAESTIO I opener + fund 1–4 + Sed contra arg 1): footers 1–5 (L-col 1–3, R-col 4–5) → continuous [^1]–[^5]. [^1] ART II opener *Augustinus* (De Nat. boni c.4); [^2] fund 1 *Augustinus* (definitio); [^3] fund 2 *e converso* (83 Qq q.6); [^4] fund 3 *secundum speciem* (III Sent d.33); [^5] Sed contra 1 *ratione finis* (IV de Gen ad lit).
- p. 829 (running head `DIST. XXXV. ART. II. QUAEST. I. 829`; Sed contra arg 2–4 + Conclusio + Respondeo modes 1–3): footers 1–5 → continuous [^6]–[^10]. [^6] arg 2 *corporalibus* (Vide supra lit. Magistri d.XXXIV c.4); [^7] arg 4 *unum uni opponitur* (Aristot., pag. 812 nota 8); [^8] Respondeo mode-1 *verbis Augustini* (De Nat. boni c.3); [^9] Respondeo mode-2 *verbis Augustini* (De Vera Relig. c.7 n.13); [^10] Respondeo mode-3 *primo libro* (Dist. 3 p.I q.2).
- p. 830 (running head `830 SENTENTIARUM LIB. II.`; Respondeo tail + Solutio ad 1–4 + SCHOLION I–II + QUAESTIO II opener at col-bottom): footers 1–4 → continuous [^11]–[^14]. [^11] Respondeo *divinae virtuti* (Vat. voluntati); [^12] Respondeo *tanquam* (Vat. se); [^13] Solutio ad-2 *ad bene esse* (Vat. addit salvat in esse); [^14] Solutio ad-4 *modus* (Codd. numerus). p.830 footer 5 (*Cap. 3* etc., anchors at QUAESTIO II body *Cap. 3* / fund 1) is forwarded to d35-a2-q2.
**Hand-off received.** NONE — a2-q1 opens a fresh footer sequence (a1-q3 forwarded nothing). Confirmed: p.828 footer 1 starts the new page sequence.

**Hand-off forwarded to d35-a2-q2.** p.830 footer 5 (`Cap. 3. — Paulo inferius pro maius edd., excepta 1, cum pluribus codd., inter quos codd. K T, magis.`) anchors at QUAESTIO II's fundamentum 1 (*in libro de Natura boni — Cap. 3*) and is forwarded to a2-q2. Also forwarded: p.830 footers for q2 body (`Vat. voluntati` n.1 / `Ita plures codd.` n.2 belong to q1; `Abbas Vercellensis… Naturaliter bonum producit ad esse` n.3 anchors at q2 body) — re-verify on the q2 dispatch; the q2 fundamentum 1 + the QUAESTIO II opener sit at the bottom of p.830 R col.

**Scholion disposition.** PRESENT here at q1 (p. 830 L-bottom + R-bottom, raw ~57795–57810), items I, II. `has_scholion: true`. Item I treats modus/species/ordo + triplex causalitas + grades of goods. Item II is the commentator roll for all three questions of the article (Alex. Hal., S. Thom., Petr. a Tar., Richard., Aegid., Dionys.). No item III. q2/q3 may legitimately lack their own scholion per Override §5.

**Cascade-dropout check.** PASSED. Both column bands of each of pp. 828–830 read top→bottom; the p.828/829 seam (inside Sed contra arg 1, `ergo ad cor-/ruptionem ordinis`), p.829/830 seam (inside Respondeo, `cum ha-/bet modum`), are each grammatically continuous. No mid-paragraph splice signature found. The SCHOLION spans both columns of p.830 (item I L+R, item II R) and is fully captured.
