---
id: "bon-sent-II-d9-divisio"
volume: 2
book: 2
distinctio: 9
type: "divisio"
title_la: "Commentarius in Distinctionem IX — Divisio textus, Praenotata de nominibus et divisionibus Angelorum, Tractatio quaestionum."
title_en: "Commentary on Distinction 9 — Division of the text, prefatory notes on the names and divisions of the Angels, treatment of the questions."
printed_pages: [237, 238, 239, 240, 241]
pdf_pages: [259, 260, 261, 262, 263]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 237–241 (Bonaventure's prologue to d.9: DIVISIO TEXTUS over Lombard's two principal parts; PRAENOTATA defining *hierarchia* (Dionys. 3 defs + Praepositivus magistral def) / *Angelus* (Damascene + Dionys.) / *ordo angelicus* (Greg./Magister def + threefold notification + three Divisiones into supercelestis/celestis/subcelestis); TRACTATIO listing the nine quaestiones of ARTICULUS UNICUS *De ordinibus Angelorum*)"
has_scholion: false
has_apparatus: true
line_start: 17004
line_end: 17301
word_count_latin: 2455
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR base (raw 17004–17301) over 450 dpi PDF column-band crops (printed pp.237–240 = PDF 259–262; the COMMENTARIUS opens mid-p.237 L-col below `d9-littera`'s Cap. VII close, with its OWN renumbered NOTAE AD COMMENTARIUM stream on p.237 R-col; PRAENOTATA runs p.237 R-col mid through p.240 L-col; TRACTATIO QUAESTIONUM closes mid-p.240 R-col; ARTICULUS UNICUS opener at raw 17302 folds into a1-q1 per locked Vol II convention). p.237 R-col footer (NOTAE AD COMMENTARIUM) ¹–⁴ = [^1]–[^4] (Plures codd. *beatorum* + Vat. *propriam* + Vat. allegatur c.2 / *Hic considerandum est* + Cap. 3 § 1 versio Scoti Erigenae + *consummata vel* desunt + *deiformi* vs *deiforme* + *omnis sanctae et scientiae* variants). p.238 footer ¹–⁶ = [^5]–[^10] (Cap. 30 n.56 Hierarch. increatae anchor + Cod. Y *ut egredientem* + Iac. 1,17 *Omne datum optimum* anchor for Similitudinis-sive-gratiae claim + Praepositivus *Sum.* p.I magistral-def gloss with *Ordinata potestas* genus + *rerum sacrarum* + *rationabilium* + *in subditis* differentia analysis + Damascene *de Fide orth.* II c.3 Greek κατὰ χάριν ἐν τῇ φύσει τὸ ἀθάνατον εἰληφυῖα anchor + Dionys. *de Div. Nom.* c.4 § 22 Versio Scoti Erigenae with τὸ ἀγαθὸν τῆς κρυφίας σιγῆς Greek anchor). p.239 footer ¹–⁶ = [^11]–[^16] (Aug. XIV de Trin. c.8 n.11 *Imago* anchor + *conformat* vs *confirmat* variant + the LONG *Foeditas acta/contracta/inflicta* triplex-poenae gloss with infra d.35/d.31/d.42/d.41 cross-refs and *voluntate aliena/propria/partim* threefold-voluntarium analysis spanning L-2 + R-2 + *adhaeret*/*deordinat*/*advenit* veniale-mechanism with infra d.24 cross-ref + Hic c.2 + infra q.2/q.3 cross-ref + Aristot. *I Topic.* c.1 *locos* definition anchor). p.240 footer ¹–⁷ = [^17]–[^23] (Praepositivus *Sum.* p.II *Media-tripartita* gloss with *epiphaniam/hyperphaniam/hypophaniam* Greek + cod. cc + ed.1 *Eparchia/Mesarchia/Hyparchia* variants + Dionys. *de Caelest. Hierarch.* c.6 § 2 + c.8 § 1 + Greg. Hom.34 n.7 + Bernard. V *de Consid.* c.4 n.8 triple-source + Dionys. c.9 § 1 + Greg./Bernard. for tertia hierarchia + the LONG cod. aa vs cod. cc/ed.1/Vat. textual-criticism note for the *est duplex* + *vel secundum status et officia* + *statum vel officia* → *status et officia* editorial decision + Magistri lit. c.2 cross-ref + secundae-divisionis Dionys/Greg cross-ref + cod. cc/ed.1 *per se* dropout). Marginal labels preserved inline per Vol II convention: *Definitiones. I. Quid sit hierarchia.* / *Distinctio et explicatio 3 definitionum.* / *Definitio I.* / *Definitio 2.* / *Definitio 3.* / *Definitio magistralis.* / *II. Quid sit Angelus, 2 definitiones.* / *Defin. Damasceni explicatur.* / *Defin. Dionysii explicatur.* / *Ratio imaginis.* / *Ratio similitudinis.* / *Ratio deiformitatis.* / *III. Quid sit ordo angelicus.* / *Epilogus.* / *Divisiones.* / *Divisio 1.* / *Divisio 2.* / *Divisio 3 cum 3 subdivisionibus.* / *Ratio 1. divisionis.* / *Ratio 2. divisionis duplex.* / *Ratio 3. divisionis.* / *Quoad supremam hierarch.* / *Quoad mediam hierarch. dupliciter.* / *Penes ordinatam potestatem.* / *Penes statum.* No `[?]` flags — all 23 superscripts + body anchors + the NOTAE-AD-COMMENTARIUM cross-chunk receipt (NOT backfilled from d9-littera since d9-littera's own footer block on p.237 L-col was the Cap. VII apparatus, the R-col carries the separately-headed Bonaventurean COMMENTARIUS apparatus that opens here) + the embedded Greek transliterations (κατὰ χάριν / ἀθάνατον εἰληφυῖα / τὸ ἀγαθὸν τῆς κρυφίας σιγῆς / Eparchia/Mesarchia/Hyparchia) verified column-by-column on `/tmp/colcrop/vol2-p23{7,8,9}-{L,R}-{0..2}.png` + `/tmp/colcrop/vol2-p240-{L,R}-{0..2}.png` 450 dpi extractions (2026-05-20). — s67 (2026-05-21) CORRECTION: the s66 build dropped ~170 words of p.241 divisio text via an OCR cascade-merge at *...sumsit | angelicis spiritibus* — restored the tertia-hierarchia subdivision (*Divisio etiam tertiae hierarchiae...penes actionem ministerialem...Et per istum modum distinguit et ordinat Dionysius*) and the Gregorius/Dionysius reconciliation (*Ex his apparet ratio harum divisionum...magis innitendum est dicto Dionysii...considerationis in fine*) from raw 17280–17301 over 450 dpi p.241 colcrops; added 4 apparatus entries [^24]–[^27] for p.241 footer ¹–⁴ (Ed.1 *deprehendi potest* / Cod. aa *quam multitudini* / Codd. F H *si* / Gregor. Hom.34 + the Pseudo-Dionysius-authorship note), `<!-- page 241 -->` break; printed_pages corrected to [237–241]"
format_version: 1
---

# bon-sent-II-d9-divisio

## *Commentarius in Distinctionem IX — Divisio textus, Praenotata, Tractatio quaestionum.*
...
Supra egit Magister de consequentibus ad malorum obstinationem; in hac parte agit de his quae consequuntur bonorum[^1] confirmationem. Haec autem sunt duo, scilicet distinctio ordinum et consequens ministerium: ideo haec pars duas habet. In prima agit de angelicorum ordinum distinctione. In secunda de Angelorum ministerio et missione, infra distinctione decima: *Hoc etiam investigandum est* etc.

Prima pars habet duas partes. In prima agit de distinctione ordinum quantum ad primam[^2] conditionem; in secunda vero quantum ad reparationem, ibi: *Notandum etiam, quod decimus ordo* etc.

Prima pars habet quatuor partes. In prima determinat, qualiter Angelorum ordines distinguuntur. In secunda, qualiter nominantur, ibi: *Haec nomina illis non propter se*[^3] etc. In tertia determinat, quod sit huius ordinationis principium, ibi: *Iam nunc inquirere restat* etc. In quarta vero et ultima determinat modum, ibi: *Praeterea considerari oportet* etc.
...
*Definitio magistralis.* Et sic patet ex praedictis definitionibus, quid sit *hierarchia* tam divina quam angelica; per quarum intellectum elicitur quaedam definitio magistralis, quae competit omni hierarchiae, licet non univoce, quae talis est: hierarchia est rerum sacrarum et rationabilium ordinata potestas, in subditis debitum retinens principatum[^8]. Haec autem non solum competit hierarchiae angelicae, sed etiam ecclesiasticae vel humanae, de qua nihil ad praesens, sed solum de hierarchia angelica. Et quoniam haec non potest cognosci, nisi cognoscatur, quid sit Angelus; ideo praenotandae sunt et Angeli definitiones.

*II. Quid sit Angelus, 2 definitiones.* Angelus autem sic notificatur a Damasceno[^9]: «Angelus est substantia incorporea, intellectualis, semper mobilis, arbitrio libera, Deo ministrans, gratia, non natura immortalitatem suscipiens». Dionysius[^10] autem aliter definit Angelum sic: «Angelus est imago Dei, manifestatio occulti luminis, speculum clarum, splendidissimum, immaculatum, incontaminatum, incoinquinatum, suscipiens, sicut conveniens est, totam speciositatem boniformis deiformitatis, et in se resplendere faciens bonitatem silentii, quod est in abditis». — Differunt autem hae duae notificationes, quia prima describit Angelum quantum ad *esse*, secunda vero non solum quantum ad *esse*, sed etiam quantum ad *bene esse*.
...
est haec: hierarchiarum alia *supercaelestis*, alia *caelestis*, alia *subcaelestis*. *Divisio 2.* Secunda est haec: hierarchiarum caelestium alia *superior*, alia *media*, alia *inferior*; sive quod idem est, alia *epiphania*, alia *hyperphania*, alia *hypophania*[^17]. *Divisio 3 cum 3 subdivisionibus.* Tertia est haec, quod ordines primae hierarchiae triplex est, scilicet Seraphim, Cherubim et Throni. Secundae hierarchiae similiter triplex est ordo secundum beatum Dionysium[^18]: Dominationes, Potestates et Virtutes. Secundum Gregorium et Bernardum: Dominationes, Principatus et Potestates. Similiter tertiae hierarchiae triplex est ordo secundum Dionysium[^19]: Principatus, Archangeli et Angeli. Secundum Gregorium et Bernardum: Virtutes, Archangeli et Angeli.
...
Above the Master treated of the consequences attendant upon the obstinacy of the evil; in this part he treats of those things which follow upon the confirmation of the good[^1]. These however are two, namely the distinction of the orders and the consequent ministry: therefore this part has two [subparts]. In the first he treats of the distinction of the angelic orders. In the second, of the ministry and mission of the Angels, below in distinction ten: *This too is to be investigated* etc.

The first part has two subparts. In the first he treats of the distinction of the orders as to their first[^2] condition; in the second, as to their restoration, there: *It is also to be noted that the tenth order* etc.

The first part has four subparts. In the first he determines in what way the orders of the Angels are distinguished. In the second, in what way they are named, there: *These names have been given to them not on their own account*[^3] etc. In the third he determines what is the principle of this ordering, there: *Now it remains to inquire* etc. In the fourth and last he determines the mode, there: *Furthermore it must be considered* etc.
...
*Magistral definition.* And thus there is clear from the aforesaid definitions what hierarchy is, both divine and angelic; and from the understanding of these is drawn a certain magistral definition, which fits every hierarchy, though not univocally: hierarchy is an ordered power over things sacred and rational, retaining over its subjects a due principate[^8]. This, however, fits not only the angelic hierarchy, but also the ecclesiastical or human; on which nothing for the present — only of the angelic hierarchy. And since this cannot be known unless it be known what an Angel is, therefore the definitions of an Angel are also to be set down beforehand.

*II. What an Angel is — 2 definitions.* An Angel, then, is thus notified by Damascene[^9]: «An Angel is an incorporeal substance, intellectual, ever in motion, free in choice, ministering to God, receiving immortality by grace, not by nature». Dionysius[^10] otherwise defines an Angel thus: «An Angel is the image of God, a manifestation of hidden light, a clear mirror, most resplendent, immaculate, uncontaminated, unpolluted, receiving — as is fitting — the whole beauty of bonny-formed deiformity, and making to shine in itself the goodness of the silence which is in the hidden parts». — These two notifications, however, differ in that the first describes an Angel as to *being*, the second not only as to *being*, but also as to *well-being*.
...
is this: of hierarchies, one is *supercelestial*, another *celestial*, another *subcelestial*. *Division 2.* The second is this: of celestial hierarchies, one is *superior*, another *intermediate*, another *inferior*; or what is the same, one is *epiphany*, another *hyperphany*, another *hypophany*[^17]. *Division 3 with 3 sub-divisions.* The third is this: that the orders of the first hierarchy are threefold, namely the Seraphim, Cherubim, and Thrones. Of the second hierarchy the order is likewise threefold according to blessed Dionysius[^18]: Dominions, Powers, and Virtues. According to Gregory and Bernard: Dominions, Principalities, and Powers. Likewise of the third hierarchy the order is threefold according to Dionysius[^19]: Principalities, Archangels, and Angels. According to Gregory and Bernard: Virtues, Archangels, and Angels.
...
> The numbered footnotes below correspond to markers in both the Latin body above and the English translation. Each entry gives the Quaracchi apparatus first in Latin (**La.**), then in English (**En.**). Variant readings (`Vat.`, `cod. cc`, etc.) are reproduced verbatim in Latin and rendered descriptively in English.

[^1]: **La.** Plures codd. cum edd. 1, 2 *beatorum*.

     **En.** Several codices with editions 1 and 2 read *beatorum* (*of the blessed*) [for *bonorum*].

[^2]: **La.** Vat. *propriam*.

     **En.** The Vatican edition reads *propriam* (*proper*) [for *primam*].

[^3]: **La.** In Vat. allegatur hic c. 2, quod incipit *Hic considerandum est* etc.

     **En.** In the Vatican edition there is alleged here c. 2, which begins *Hic considerandum est* etc.

[^4]: **La.** Cap. 3. § 1. seq. (iuxta versionem Scoti Erigenae). In prima definitione fere omnes codd. addunt *consummata vel*, quae verba desunt in textu originali et in Vat.; in secunda textus originalis substituit *deiformi* pro *deiforme*; in tertia *omnis sanctae et scientiae* pro *scientiae sanctae*.

     **En.** Dionysius, *On the Celestial Hierarchy* c. 3, § 1ff. (according to the version of Scotus Eriugena). In the first definition almost all codices add *consummata vel*, which words are absent in the original text and in the Vatican edition; in the second, the original text substitutes *deiformi* for *deiforme*; in the third, *omnis sanctae et scientiae* for *scientiae sanctae*.

[^5]: **La.** Cap. 30. n. 56.

     **En.** Chapter 30, n. 56.

[^6]: **La.** Cod. Y *ut egredientem*.

     **En.** Codex Y reads *ut egredientem* (*as going forth*).

[^7]: **La.** Iac. 1, 17: *Omne datum optimum... desursum est, descendens a Patre luminum*.

     **En.** James 1:17: *Every good gift… is from above, coming down from the Father of lights*.

[^8]: **La.** Haec definitio invenitur apud Praepositivum, *Sum.* p. I, ubi etiam sic explicatur: *Ordinata potestas* ponitur pro genere; *rerum sacrarum* ad differentiam profanarum, ut ligni et lapidis et aliarum; *rationabilium* ponitur ad differentiam irrationabilium; *in subditis debitum retinens dominatum* ponitur ad differentiam illorum subditorum, qui non sunt praelati aliis.

     **En.** This definition is found in Praepositivus, *Summa* part I, where it is also so explained: *Ordered power* is set down for the genus; *of sacred things* — to differentiate from profane things, such as wood and stone and others; *of rational things* — to differentiate from irrational; *retaining the due dominion over subjects* — to differentiate from those subjects who are not prelates over others.

[^9]: **La.** Libr. II. *de Fide orth.* c. 3, ubi textus originalis ultimam partem definitionis sic exhibet κατὰ χάριν ἐν τῇ φύσει τὸ ἀθάνατον εἰληφυῖα i. e. ex gratia in natura immortalitatem suscipiens.

     **En.** Damascene, *On the Orthodox Faith* book II, c. 3, where the original text presents the last part of the definition thus: κατὰ χάριν ἐν τῇ φύσει τὸ ἀθάνατον εἰληφυῖα, that is, *receiving immortality by grace in nature*.
...
- s66 (2026-05-20): rebuilt from auto-chunked skeleton (raw 17004–17301) to Tier 2 — Latin re-set verbatim from IA djvu OCR over 450 dpi colcrops of pp.237–240, fresh literal English (Bonaventure's prologue: COMMENTARIUS opener + DIVISIO TEXTUS over Lombard's two-pars structure + PRAENOTATA DE NOMINIBUS ET DIVISIONIBUS ANGELORUM with hierarchia/Angelus/ordo definitions + three Divisiones with their rationes + TRACTATIO QUAESTIONUM listing the 9 quaestiones of the ARTICULUS UNICUS), no scholion (divisio chunk), 23-entry apparatus.
- p.237 R-col carries the separately-headed `NOTAE AD COMMENTARIUM` block (footer ¹–⁴ = [^1]–[^4]) which opens this chunk's apparatus stream; the p.237 L-col footer block was taken in full by the prior chunk `d9-littera` as its [^16]–[^18] (Greg.loc.cit.n.11 + Aug.Enchirid./XXII de Civ.Dei + Rom.4:17) — no backfill needed. p.238 has 6 footer entries → [^5]–[^10]; p.239 has 6 → [^11]–[^16]; p.240 has 7 → [^17]–[^23]. All 23 markers verified column-by-column.
- Marginal labels preserved inline per locked Vol II convention: *Definitiones. I. Quid sit hierarchia.*, *Distinctio et explicatio 3 definitionum.*, *Definitio I.* through *Definitio 3.*, *Definitio magistralis.*, *II. Quid sit Angelus, 2 definitiones.*, *Defin. Damasceni explicatur.*, *Defin. Dionysii explicatur.*, *Ratio imaginis.* / *Ratio similitudinis.* / *Ratio deiformitatis.*, *III. Quid sit ordo angelicus.*, *Epilogus.*, *Divisiones.*, *Divisio 1.* / *Divisio 2.* / *Divisio 3 cum 3 subdivisionibus.*, *Ratio 1./2./3. divisionis.*, *Ratio 2. divisionis duplex.*, *Quoad supremam hierarch.*, *Quoad mediam hierarch. dupliciter.*, *Penes ordinatam potestatem.*, *Penes statum.* (×2).
- OCR garbles cleaned silently: Posl→Post; angelicorutii→angelicorum; ministeriimi→ministerium; angelicoruiu→angelicorum; quantuiu→quantum; commodatione→cognominatione (clean); subiectis* placeholder; spirituum (clean); deformitatem→deiformitatem; conformat→conformat preserved as variant in footer; partim-voluntate-aliena → partim voluntate propria reconciled across L-2/R-2 cascade split on p.239 [^13]; Au gelica→angelica; Au gelorum/Augelorum→Angelorum (×n); huius-notificationis→notificationis-explanatio (clean reflow); media+infima column-bleed on p.240 L-1 *Penes statum* sidebar reflowed column-by-column. Greek transliterations preserved verbatim: κατὰ χάριν ἐν τῇ φύσει τὸ ἀθάνατον εἰληφυῖα [^9]; τὸ ἀγαθὸν τῆς κρυφίας σιγῆς [^10]; *Eparchia/Mesarchia/Hyparchia* hellenizing variant [^17].
- The two-stage Praepositivus citation chain ([^8] for the magistral *Ordinata potestas* def with Sum. p.I gloss; [^17] for the supplementary Sum. p.II *Media-tripartita* gloss with the epiphaniam/hyperphaniam/hypophaniam Greek-spelling discussion) reads as Quaracchi's compositional spine for the praenotata.
- The LONG [^13] *Foeditas acta/contracta/inflicta* gloss cascade-splits across p.239 L-2 and R-2 (cod. aa reading reconciled with cod. cc/ed.1/Vat. interpolation) — fully reassembled.
- The LONG [^20] editorial-decision note (cod. aa selection over the cod. cc/ed.1/Vat. *vel secundum status et officia. Si primo modo* interpolation, with *statum vel officia* → *status et officia* editorial substitution) is the densest textual-criticism entry in d.9 divisio and is preserved verbatim.
- s67 (2026-05-21): repaired a p.241 body dropout introduced by the s66 build. The s66 OCR cascade-merged two distinct `sumsit` clauses, dropping ~170 words: (A) the *tertia hierarchia* subdivision `Divisio etiam tertiae hierarchiae...penes actionem ministerialem...regimen principum/multitudinis/personae singularis...Et per istum modum distinguit et ordinat Dionysius` and (B) the Gregorius/Dionysius reconciliation `distinctionem tertiae hierarchiae Gregorius et Bernardus. Ex his apparet ratio harum divisionum...Sed cum utrumque horum simul non possit esse verum...magis innitendum est dicto Dionysii`. Restored from raw 17280–17301 over 450 dpi p.241 colcrops; the s66 secunda-hierarchia close had also been paraphrased (`ideo Gregorius distinxit ordines mediae hierarchiae secundum hunc modum`) — corrected to the literal `ideo primo Dominationes, secundo Principatus et tertio Potestates enumerantur a Gregorio et a Bernardo`. Apparatus +4 ([^24]–[^27], p.241 footer ¹–⁴); `<!-- page 241 -->` break added; printed_pages [237–240] → [237–241]. **Apparatus is now 27 entries, not 23.**
- Outgoing cross-chunk split at mid-p.241 L-col CLEAN: TRACTATIO QUAESTIONUM ends `Nono et ultimo in comparatione ad disparatum.` (raw 17301); immediately below `ARTICULUS UNICUS. *De ordinibus Angelorum.* QUAESTIO I. *Utrum Angeli diversorum ordinum sint diversarum specierum per naturam.* Primo igitur est quaestio de ordinibus Angelorum...` belongs to next chunk `d9-a1-q1` (raw 17302+) — ART UNICUS opener folds into a1-q1 per locked Vol II convention.
- No `[?]` flags — all superscripts + body anchors + the cross-chunk NOTAE-AD-COMMENTARIUM stream-opening + Greek transliterations + Praepositivus glosses + the cod. aa/cc/Vat. textual-criticism notes verified column-by-column on 450 dpi colcrops.
- d.1–d.10 polish-blocker (2026-05-22): the pass-2 marker-pairing audit found `[^5]` had an apparatus definition (`Cap. 30. n. 56.`, p.238 footer 1) but no body anchor in either language. The anchor was restored after `de Vera Religione` / `On True Religion` in *Definitio I* — confirmed against the 600 dpi p.238 crop (superscript ¹ printed there, and `Cap. 30. n. 56.` is the Augustine *de Vera Religione* locus).
- **DISTINCTION 9 NOW 2/11.** Next chunk: `d9-a1-q1` *Utrum Angeli diversorum ordinum sint diversarum specierum per naturam* (raw 17302+, p.240 R-col-mid through ~p.243 per skeleton scope; raw apparatus-audit ~23 footer notes — the heaviest q in d.9 by skeleton signal, opens with the rich *multiplicatio Angelorum* manifestat-divinam-potentiam fundamenta).
