...
quaestio: 2
type: "quaestio"
title_la: "Utrum materia producta sit in perfecta actualitate."
title_en: "Whether matter was produced in perfect actuality."
printed_pages: [295, 296, 297, 298]
pdf_pages: [317, 318, 319, 320]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 295–298 (Bonaventure, In II Sent., d. XII, art. I, q. II — on Augustine's simul-creation thesis vs. the six-day formation account: whether prime matter was produced with all its forms simul or whether the formae were distinguished successively over the six days)"
has_scholion: true
has_apparatus: true
line_start: 20932
line_end: 21186
word_count_latin: 3687
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR base (raw 20932–21186) over 450 dpi PDF column-band crops (printed p.295–p.298 = PDF 317–320). Heaviest d.12 quaestio: 6 *videtur* args + 6 *Sed contra* (Fundamenta) args + Conclusio + lengthy Respondeo (Augustine-vs-common-doctors opinion survey + four *rationes* of the Magister's position: *litteralis, moralis, allegorica, anagogica*) + replies to *videtur* args (Ad 1, 2, 3, 4.5.6) + 2-section SCHOLION (S. Thom.'s explanation of Augustine's reading + parallel-citations list). 30-entry apparatus renumbered continuously: p.295 footers ¹–⁸ (8 entries), p.296 footers ¹–⁶ (6 entries), p.297 footers ¹–¹² (12 entries — heaviest Quaracchi-side cluster of d.12), p.298 footers ¹–⁴ (4 entries). Marginal labels (*Ad oppositum.*, *Fundamenta.*, *Opinio Augustini.*, *Non omnibus placet.*, *Conclusio.*, *Defenditur rationibus.*, *Ratio 1./2./3./4.*, *Notandum.*, *Solutio oppositorum.*) preserved inline per Vol II convention, NOT promoted to headings. No `[?]` flags (2026-05-23)"
format_version: 1
---

# bon-sent-II-d12-a1-q2

## *Quaestio II — Utrum materia producta sit in perfecta actualitate.*
...
1. First by the text of Genesis 2[^1]: *These are the generations of the heavens and the earth in the day when God created the heavens and the earth and every plant of the field* etc.: therefore in the same day were produced those things which he had earlier said were distinguished through the number of six days.

2. Likewise, Ecclesiasticus 18[^2]: *He who lives forever created all things at once.* If all things were created at once, then both corporeal and spiritual and every difference of corporeal things [were so created].

3. Likewise, Job 40[^3]: *Behold Behemoth, whom I made with thee*; but Behemoth is the Angel first made, and man was made on the last day: therefore all things were made at once. — By these authorities Augustine argues for his opinion in this part.

4. Likewise, the same thing is shown by reason. From an agent of perfect potency the effect ought to come forth in such measure as is *more* manifestative of supreme potency; but it is of greater potency to be able to produce all things at once than successively: therefore the production of matter with the perfect actuality of form conferred all at once and simultaneously is more declarative of divine potency than [the production] of matter [first], from which [the forms] are afterwards successively brought forth: if therefore God works according to what most befits his potency[^4], it seems [that he did so] etc.
...
[^1]: **La.** Vers. 4. — Paulo inferius plures codd. omittunt *sex.*
     ...
     **En.** Verse 4. — A little lower, several codices omit *six.*

[^2]: **La.** Vers. 1.

     **En.** Verse 1.

[^3]: **La.** Vers. 10. — Sententiam Augustini vide IV. *de Gen. ad lit.* c. 33. n. 52. seqq.; V. c. 3. n. 5. seqq. et c. 23. n. 44. seqq.; VI. c. 1. seq.; XI. *de Civ. Dei,* c. 6. seq.

     **En.** Verse 10. — For Augustine's view see *On Genesis according to the Letter* IV, c. 33, n. 52 ff.; V, c. 3, n. 5 ff. and c. 23, n. 44 ff.; VI, c. 1 f.; *On the City of God* XI, c. 6 f.

[^4]: **La.** Deut. 32, 4: *Dei perfecta sunt opera.* — Paulo ante non pauci codd. *successione eductae* pro *successive eductae.*

     **En.** Deuteronomy 32, 4: *God's works are perfect.* — A little earlier, not a few codices [read] *by succession brought forth* in place of *successively brought forth.*

[^5]: **La.** Aristot., I. *Metaph.* c. 2. Cfr. tom. I. pag. 685, nota 1. — Cod. cc cum ed. 1 et Vat. *ordinate operari.* Paulo inferius cod. Y *sub confusione* pro *cum confusione,* et deinde post *sub ordine* cod. O bene addit *omnia.*

     **En.** Aristotle, *Metaphysics* I, c. 2. Cf. vol. I, p. 685, note 1. — Codex cc with edition 1 and the Vatican [edition read] *to work in an ordered way.* A little lower, codex Y [reads] *under confusion* for *with confusion*; and then after *under order* codex O well adds *all things.*

[^6]: **La.** Cfr. August., 83 Qq. q. 78.

     **En.** Cf. Augustine, *On 83 Different Questions,* q. 78.

[^7]: **La.** Cap. 2, 2, ubi Vulgata *patrarat* pro *inchoaverat.*

     **En.** Chapter 2, 2, where the Vulgate has *had accomplished* in place of *had begun.*

[^8]: **La.** Libr. II. *de Gen. ad lit.* c. 5. n. 9.

     **En.** Book II *On Genesis according to the Letter,* c. 5, n. 9.

[^9]: **La.** Hom. 22. (alias 21.) n. 1, ubi in explicatione illius verbi *Nondum venit hora mea* (Ioan. 2, 4.) ait: *Verum per haec dicta hoc vult significare, se omnia congruenti tempore operari nec simul facere, ne hinc rerum ordo turbaretur, si non opportuno tempore singula ederet, sed omnia simul misceret, generationem, resurrectionem, iudicium. Hic animum adhibe: oportuit creaturam facere, sed non omnem simul; hominem et mulierem, sed non una ambos.* Idem docet hom. 2. n. 4. et hom. 3. n. 3. seq. in cap. 1. Gen. — Ipsa autem verba huius sententiae inveniuntur in Gregor., XXXII. *Moral.* c. 12. n. 16: *Rerum quippe substantia simul creata est, sed simul species formata non est; et quod simul exstitit per substantiam materiae, non simul apparuit per speciem formae.*

     **En.** Homily 22 (alias 21), n. 1, where in the explanation of that word *My hour has not yet come* (John 2, 4) he says: *Truly by these words he wishes to signify this — that he works all things at a fitting time and does not make them at once, lest from this the order of things be disturbed, if he were to produce individual things at an unsuitable time, but rather mix all things together — generation, resurrection, judgment. Apply your mind here: it was fitting to make the creature, but not all at once; man and woman, but not both at once.* He teaches the same thing in hom. 2, n. 4 and hom. 3, n. 3 ff. on Gen. c. 1. — The very words of this opinion are found in Gregory, *Moralia* XXXII, c. 12, n. 16: *For the substance of things was created at once, but the species was not formed at once; and what existed at once through the substance of matter did not at once appear through the species of form.*

[^10]: **La.** Libr. I. *Hexaem.* c. 7. seq. — Hieron., *Comment. in Epist. ad Titum,* 1, 3. seq. — Gregorii verba vide in nota praecedente. — Basil., Hom. 2. *in Hexaem.* — Dionys., *de Div. Nom.* c. 4. § 4. et c. 5. § 7. seq. — Damasc., II. *de Fide orthod.* c. 5. seqq. — Cfr. hic lit. Magistri, c. 3. seqq.

     **En.** Book I *Hexaemeron* c. 7 f. — Jerome, *Commentary on the Epistle to Titus,* 1, 3 f. — For Gregory's words see the preceding note. — Basil, Homily 2 *on the Hexaemeron.* — Dionysius, *On the Divine Names,* c. 4 § 4 and c. 5 § 7 f. — Damascene, *On the Orthodox Faith* II, c. 5 ff. — Cf. here the text of the Master, c. 3 ff.

[^11]: **La.** Cfr. verba Chrysost. hic nota 1.

     **En.** Cf. the words of Chrysostom here, note 1 [= apparatus entry [^9]].

[^12]: **La.** Codd. H W bb substituunt *naturales* pro *materiales*; sed infra in corp. legitur etiam in his *materiales.*

     **En.** Codices H, W, bb substitute *natural* for *material*; but below, in the body, *material* is also read in these [codices].

[^13]: **La.** Dist. 3. p. II. a. 1. q. 1. seq.

     **En.** Distinction 3, p. II, a. 1, q. 1 f.

[^14]: **La.** Supple cum cod. aa *debuit esse,* pro quo Vat. *fuit.* Eadem Vat. dein *planetarum et herbarum* pro *plantarum et herbae* substituit.

     **En.** Supply with codex aa *ought to be,* in place of which the Vatican [edition has] *was.* The Vatican [edition] then substitutes *of planets and grasses* for *of plants and grass.*

[^15]: **La.** Cod. Q praemittit *nec.* Vat. substituit *tantum* et bis *quantum potest* pro *quod potest.* Cod. bb post *etiam* a manu suppari addit *intendit.* Sed lectiones codd. et edd. sunt parum congruae.

     **En.** Codex Q prefixes *nec.* The Vatican [edition] substitutes *only* and twice *as much as he can* for *what he can.* Codex bb after *also,* by a near-contemporary hand, adds *intends.* But the readings of the codices and editions are little congruent.

[^16]: **La.** Cfr. August., I. *de Gen. ad lit.* c. 4. n. 9. seq.

     **En.** Cf. Augustine, *On Genesis according to the Letter* I, c. 4, n. 9 f.

[^17]: **La.** Cfr. August., IV. *de Gen. ad lit.* c. 2. n. 2. seqq. et Bonav., I. Sent. d. 2. q. 4, scholion. — Paulo superius unus alterque cod. cum edd. 2, 3 *Augustinum* pro *arithmeticum.*

     **En.** Cf. Augustine, *On Genesis according to the Letter* IV, c. 2, n. 2 ff., and Bonaventure, I Sent., d. 2, q. 4, scholion. — A little higher, one or another codex with editions 2 and 3 [reads] *Augustine* in place of *arithmetician.*

[^18]: **La.** Vide August., 1. *contra Advers. legis et proph.* c. 8. n. 11.

     **En.** See Augustine, *Against the Adversaries of the Law and the Prophets* I, c. 8, n. 11.

[^19]: **La.** Gen. 2, 2. seq. — Cfr. August., IV. *de Gen. ad lit.* c. 18. n. 31.

     **En.** Genesis 2, 2 f. — Cf. Augustine, *On Genesis according to the Letter* IV, c. 18, n. 31.

[^20]: **La.** Libr. I. *de Genesi contra Manich.* c. 23. n. 35. seqq.; XXII. *de Civ. Dei,* c. 30. n. 5; IV. *de Trin.* c. 4. n. 7; *Enarrat. in Ps.* 92. n. 1.

     **En.** Book I *On Genesis against the Manichees,* c. 23, n. 35 ff.; *On the City of God* XXII, c. 30, n. 5; *On the Trinity* IV, c. 4, n. 7; *Commentary on the Psalms,* Ps. 92, n. 1.

[^21]: **La.** Intellige: Librum I. *de Genesi contra Manichaeos,* c. 23. n. 35. seqq., cuius ipse Augustinus, VIII. *de Gen. ad lit.* c. 2. n. 3, mentionem facit. — Paulo superius cod. aa *praefiguratur* pro *praesignatur.*

     **En.** Understand: Book I *On Genesis against the Manichees,* c. 23, n. 35 ff., of which Augustine himself makes mention in *On Genesis according to the Letter* VIII, c. 2, n. 3. — A little higher, codex aa [reads] *prefigured* in place of *presignified.*

[^22]: **La.** Praecipue libr. IV. c. 21. n. 38. seqq. — August., II. *Retract.* c. 24. n. 1. ait: *Tituli eorum librorum inscribitur de Genesi ad litteram,* id est, non secundum allegoricas significationes, sed secundum rerum gestarum proprietatem. In quo opere plura quaesita quam inventa sunt, et eorum quae inventa sunt, pauciora firmata, cetera vero ita posita, velut adhuc requirenda sint. Cfr. I. *de Gen. ad lit.* c. 1. n. 1, c. 17. n. 34, c. 21. n. 41; IV. c. 28. n. 45 et VIII. c. 1. n. 4. seq.; I. *de Gen. contra Manich.* c. 1. seq. — Cod. T *quem ideo* pro *quod ideo.*

     **En.** Especially Book IV, c. 21, n. 38 ff. — Augustine, *Retractations* II, c. 24, n. 1, says: *The title of those books is inscribed* On Genesis according to the Letter, *that is, not according to allegorical significations, but according to the propriety of the things done.* In this work more things are inquired than discovered, and of those discovered, fewer are firmly established; the rest are set down as though still to be sought. Cf. *On Genesis according to the Letter* I, c. 1, n. 1; c. 17, n. 34; c. 21, n. 41; IV, c. 28, n. 45 and VIII, c. 1, n. 4 f.; *On Genesis against the Manichees* I, c. 1 f. — Codex T [reads] *quem ideo* (whom therefore) for *quod ideo* (which therefore).

[^23]: **La.** Libr. I. *de Gen. ad lit.* c. 19-21; IX. c. 12. n. 22. — In fine propositionis non pauci codd. cum ed. 2 *gratum,* Vat. *creatum* pro *congruum,* quod tamen recurrit etiam infra d. 15. dub. 3, in quo respicitur hic locus; dein post *vel tunc* ex pluribus codd. et ed. 1 supplevimus *esse.*

     **En.** Book I *On Genesis according to the Letter,* c. 19–21; IX, c. 12, n. 22. — At the end of the proposition, not a few codices with edition 2 [read] *grateful,* the Vatican [edition] *created,* in place of *fitting* — which, however, recurs also below in d. 15, dub. 3, where this passage is referenced; then, after *or then,* from several codices and edition 1 we have supplied *to be.*

[^24]: **La.** Cap. 18-32.

     **En.** Chapters 18–32.

[^25]: **La.** A Graeco vocabulo ζεῦγμα, i. e. *connexio,* per quod apud grammaticos significatur illa dictionis figura, qua plura (plures sensus) uno verbo connectuntur. — Verbum *confunditur* accipitur pro *distribuitur*; cfr. I. Sent. d. 4. q. 1, scholion.

     **En.** From the Greek word *zeugma,* that is, *connection,* by which among the grammarians is signified that figure of speech by which several things (several senses) are connected by one word. — The verb *confunditur* (is used confusedly) is to be taken for *distribuitur* (is distributed); cf. I Sent., d. 4, q. 1, scholion.

[^26]: **La.** Vers. 1. — Seq. textus est Gen. 2, 3, ubi Vulgata post *creavit* subiungit *Deus.*

     **En.** Verse 1. — The following text is Genesis 2, 3, where the Vulgate, after *created,* adds *God.*

[^27]: **La.** Vers. 10. Verba Gregorii, XXXII. *Moral.* c. 12. n. 17, sunt: *Sed si rerum causas subtili discussione pensamus, simul Angelum factum hominemque cognoscimus: simul videlicet non unitate temporis, sed cognitione rationis; simul per acceptam imaginem sapientiae, et non simul per coniunctam substantiam formae... In cuncta igitur creatura homo et Angelus simul conditus exstitit, quia ab omni creatura irrationali distinctus processit. Quia ergo in cuncta conditione rerum nullum rationale animal nisi Angelus et homo est, quidquid ratione uti non potest, cum homine factum non est.* — Ed. 1 et Vat. *simultatem rationis* pro *similitudinem rationis.* Dein multi codd. *sui similem* pro *tibi similem.*

     **En.** Verse 10. The words of Gregory, *Moralia* XXXII, c. 12, n. 17, are: *But if we weigh the causes of things with subtle discussion, we recognize the Angel and man to have been made at once: at once, namely, not by unity of time, but by knowledge of reason; at once through the received image of wisdom, and not at once through the conjoined substance of form... In the whole of the creature, therefore, man and Angel were at once established, since [the rational creature] went forth distinct from every irrational creature. Since therefore in the whole establishment of things there is no rational animal except the Angel and man, whatever cannot use reason was not made with man.* — Edition 1 and the Vatican [edition read] *simultaneity of reason* for *likeness of reason.* Then many codices [read] *like himself* for *like to thee.*

[^28]: **La.** In codd. L O additur *adeo*; in Vat. *ita.*

     **En.** In codices L, O *adeo* (so much) is added; in the Vatican [edition], *ita* (thus).

[^29]: **La.** Vat. *ornare.*

     **En.** The Vatican [edition reads] *to adorn.*

[^30]: **La.** Colos. 2, 3: *In quo sunt omnes thesauri sapientiae et scientiae absconditi.* — Mox post *formatione* in multis codd. et ed. 1 desideratur *rerum.* In fine solutionis plures codd. cum edd. 2, 3 *ordinare* pro *ornare.*

     **En.** Colossians 2, 3: *In whom are all the treasures of wisdom and knowledge hidden.* — Soon after *formation,* in many codices and edition 1, *of things* is missing. At the end of the solution, several codices with editions 2 and 3 [read] *to order* in place of *to adorn.*

---

## Notes

- Four printed pages (p.295–p.298 = PDF 317–320). Two-column quaestio body opens at the bottom of p.295 L (QUAESTIO II + *Utrum materia producta sit in perfecta actualitate* + *Secundo quaeritur* — immediately below the SCHOLION end of `d12-a1-q1`), runs through p.296, p.297, with SCHOLION (**I** S. Thomas's exposition of Augustine + Magisterium-of-the-Church admonition + geogony note; **II** parallel-citations list) occupying the bottom half of p.298 R immediately before QUAESTIO III opens on p.298 R-bottom.
- **Apparatus (30 entries, renumbered continuously across pp. 295–298):**
  - p.295 (8 entries): [^1] Gen 2:4 + codd. omit *sex* — at *Genesis secundo* in arg.1; [^2] Ecclus 18:1 — at *Ecclesiastici decimo octavo* in arg.2; [^3] Iob 40:10 + Aug., *de Gen. ad lit.* IV/V/VI + *de Civ. Dei* XI — at *Iob quadragesimo* in arg.3; [^4] Deut 32:4 + *successione/successive eductae* variant — at *eius potentiam magis decet* in arg.4; [^5] Aristot., *Metaph.* I c. 2 + variants — at *perfecte sapientis est ordinare* in arg.5; [^6] Aug., *83 Qq* q.78 — at *imitatrix divinae artis et virtutis* in arg.6; [^7] Gen 2:2 (*patrarat/inchoaverat*) — at *complevit Dominus opus, quod inchoaverat* in Sed contra 1; [^8] Aug., *de Gen. ad lit.* II c.5 n.9 — at *ut dicit Augustinus* in Sed contra 1.
  - p.296 (6 entries): [^9] Chrysost., *Hom.* 22 + Gregor., *Moral.* XXXII (verbal source) — at *Chrysostomus super Ioannem, homilia vigesima secunda* in Sed contra 2; [^10] Ambros., *Hexaem.* I + Hieron., Gregor., Basil., Dionys., Damasc. — at *Ambrosii* (parallel-Sancti list) in Sed contra 2; [^11] Cfr. note 1 (= [^9]) — at *efficacius sic manifestatur eius sapientia* in Sed contra 3; [^12] codd. H W bb *naturales* / *materiales* variant — at *dies materiales* in Sed contra 5; [^13] *Dist. 3. p.II.a.1.q.1.seq.* cross-ref — at *est supra improbatum* in Sed contra 5; [^14] *debuit esse / fuit* + *planetarum/plantarum* variants — at *productio solis et lunae* in Sed contra 6.
  - p.297 (12 entries, heaviest Quaracchi-side cluster of d.12): [^15] cod. Q *nec* + Vat. *tantum* variants — at *non tantum intendit facere quod potest* in Ratio 1; [^16] Aug., *de Gen. ad lit.* I c.4 n.9 — at *ut ipsam perficeret* in Ratio 1; [^17] Aug., *de Gen. ad lit.* IV c.2 + Bonav. I Sent. + *Augustinum/arithmeticum* variant — at *perfectio universi* in Ratio 1; [^18] Aug., *contra Advers. legis et proph.* I c.8 — at *nisi Deus gratiam suam infundat* in Ratio 2; [^19] Gen 2:2 + Aug., *de Gen. ad lit.* IV c.18 — at *dies septimus non habet sibi assignatum vespere in Scriptura* in Ratio 2; [^20] Aug., *de Gen. contra Manich.* I c.23 + *de Civ. Dei* XXII + *de Trin.* IV + *Enarr. in Ps.* 92 — at *expresse Augustinus* in Ratio 3; [^21] *Intellige: Librum I. de Genesi contra Manichaeos* + cod. aa *praefiguratur/praesignatur* — at *Augustinus super Genesim ad litteram* in Ratio 3; [^22] Aug., *de Gen. ad lit.* IV c.21 + *Retract.* II c.24 + cod. T *quem/quod ideo* — at *super Genesim ad litteram quasi per totum* in Ratio 4; [^23] Aug., *de Gen. ad lit.* I c.19-21 + IX c.12 + *gratum/creatum/congruum* variants — at *quid congruum fuerit vel tunc esse potuerit* in Ratio 4; [^24] Aug., *Confess.* XII c.18-32 — at *in duodecimo Confessionum* in Ratio 4 Notandum; [^25] Graeco *ζεῦγμα* etymology + *confunditur/distribuitur* — at *tenetur zeugmatice* in Ad 1; [^26] Ecclus 18:1 + Gen 2:3 *creavit Deus* variant — at *de Ecclesiastici decimo octavo* in Ad 2.
  - p.298 (4 entries): [^27] Iob 40:10 + Gregor., *Moral.* XXXII c.12 n.17 + *simultatem/similitudinem rationis* + *sui/tibi similem* variants — at *Gregorius exponit* in Ad 3; [^28] codd. L O *adeo* / Vat. *ita* — at *Et ideo* in Ad 4.5.6 Notandum; [^29] Vat. *ornare* — at *ordinare* (mid-Notandum, parallel verb) in Ad 4.5.6; [^30] Col 2:3 + codd. omit *rerum* + *ordinare/ornare* variant — at *infiniti thesauri sapientiae et scientiae* in Ad 4.5.6.
- **Incoming boundary CLEAN** — the prior chunk (`d12-a1-q1`, p.293–p.295) ends with its SCHOLION section II parallel-citations list at *Biel, hic q. 1.* on p.295 L; `QUAESTIO II.` + title + *Secundo quaeritur* opens immediately below on the same p.295 L (already documented in `d12-a1-q1`'s outgoing-boundary note).
- **Outgoing boundary CLEAN** — the SCHOLION section II closes p.298 R mid-column at the parallel-citations list (*…Biel, hic q. 2.*), and `QUAESTIO III. — Utrum materia creata sit sub aliqua formarum diversitate` opens immediately below on the same p.298 R and belongs to `bon-sent-II-d12-a1-q3`. The running rule plus the page-number line `298 SENTENTIARUM LIB. II.` sit before the SCHOLION begins; the page-footer NOTAE band on p.298 holds the four notes ¹–⁴ above.
- Marginal labels preserved inline (Vol II convention, NOT promoted to headings): *Ad oppositum.* (above arg 1 of the videtur side), *Fundamenta.* (above arg 1 of the Sed contra side), *Opinio Augustini.* (in the Respondeo, at the Augustinian-via-philosophica position), *Non omnibus placet.* (in the Respondeo, at the doctors-against-Augustine pivot), *Conclusio.* (at *simul esse creata in materia*), *Defenditur rationibus.* (at the four-rationes preamble), *Ratio 1./2./3./4.* (marking *litteralis, moralis, allegorica, anagogica*), *Notandum.* (×5: at *modo inquisitorio*; at *Confessionum* XII multilectu; at *bene manifestata sunt post consummatum esse*; at *Sicut enim Deus sacram Scripturam*; and the *Solutio oppositorum.* at the head of Ad 1).
- OCR garbles cleaned silently (a representative sample — the OCR cascade-fragmented heavily in the Respondeo + Ad-arguments block, requiring PDF column-band reconciliation throughout): `generaiiones`→generationes, `caelmn`→caelum, `sunl`→sunt, `mmierum`→numerum, `oclavo`→octavo, `creavil`→creavit, `creala`→creata, `lob`→Iob, `Behemotli`→Behemoth, `prirao faclus`→primo factus, `siraul`→simul, `slinus`→stinus, `iniitalrix`→imitatrix, `dejjuit`→debuit, `S7 tii clicas`→Si tu dicas, `concludil`→concludit, `statiiu`→statim, `debuil`→debuit, `Prinio`→Primo, `arguilur`→arguitur, `inchocwerat`→inchoaverat, `raateria`→materia, `Si igilur «luaior`→Si igitur «maior, `inagis standura`→magis standum, `sinml`→simul, `sufQciens`→sufficiens, `lilleram`→litteram, `qiiamvis`→quamvis, `simlliter`→similiter, `quantura`→quantum, `successivc/successive eductae`→successive eductae, `mariifestatur`→manifestatur, `decursii`→decursu, `manifestaiur`→manifestatur, `distinclione`→distinctione, `inforniis`→informis, `posilionem`→positionem, `congruitatcm`→congruitatem, `Iitteralis`→litteralis, `senariuui`→senarium, `senariura`→senarium, `arithmeti-cuum`→arithmeticum, `aliquoties`→aliquoties, `eruditiir`→eruditur, `sed simul species formata non est`→preserved verbatim, `praesignatur`→praesignatur (preserved over codex variant), `inquisitorio`→inquisitorio (preserved), `multipliciler`→multipliciter, `confnnditur`→confunditur, `zeic-gmatice`→zeugmatice, `simultatem`→similitudinem (preserved per Vat./ed.1 variant note [^27]), `manifcstare`→manifestare, `boniiatem`→bonitatem, `siu-gillatim`→singillatim, `creatioiiis`→creationis, `manifestari potenfta`→potentia (preserved), `imperfectam`→imperfectam, `obiicias`→obiicias, `condescendit`→condescendit (preserved), `Moiandmr/Notandum`→Notandum, `Moyses`→Moyses (preserved), `Auctori`→Auctori (preserved). Where the OCR cascade rendered an entire Respondeo passage unparseable, the body was reset from PDF column bands (per the Vol II Override) and then cross-checked against the OCR for footnote-marker spacing only.
- No `[?]` flags.
