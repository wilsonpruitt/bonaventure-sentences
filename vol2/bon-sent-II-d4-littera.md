---
id: "bon-sent-II-d4-littera"
volume: 2
book: 2
distinctio: 4
type: "littera"
title_la: "Distinctio IV. Magistri Sententiarum."
title_en: "Distinction 4. The text of the Master of the Sentences."
printed_pages: [129, 130]
pdf_pages: [151, 152]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 129–130 (Lombard's text, Cap. I; the COMMENTARIUS begins mid-p.130)"
has_scholion: false
has_apparatus: true
line_start: 9661
line_end: 9721
word_count_latin: 909
transcription_status: "Phase C Tier 2 complete — Latin re-set from IA djvu OCR base (raw 9661–9721) over the 450 dpi PDF column-band crops (printed pp. 129–130 = PDF pp. 151–152; Lombard littera Cap. I, two-column, sharing p.129 with the preceding d.3 dubia tail and p.130 with the following COMMENTARIUS), fresh literal English, no scholion, 4-entry apparatus. Cross-chunk footers (two two-stream pages): p.129 main-stream notes 1–4 anchor the preceding committed `bon-sent-II-d3-p2-dubia` (its [^6]–[^9]) — NOT taken here, NO backfill; this littera owns p.129's dedicated `NOTAE AD LIBR. SENTENTIARUM` block (¹² → [^1][^2]). p.130's footer is linearized in raw AFTER the COMMENTARIUS (within the still-skeleton `bon-sent-II-d4-divisio` range): its main-stream notes ¹² anchor THIS littera's p.130 body (*in eodem* / *qui ceciderunt*) → [^3][^4]; the p.130 `NOTAE AD COMMENTARIUM` block + d4-divisio's own notes belong to `d4-divisio` (to be taken at its build, not here). No hard [?] flags — Lombard prose clean in OCR, footers verified on 450 dpi crops (2026-05-17)"
format_version: 1
---

# bon-sent-II-d4-littera
...
[^1]: **La.** Cfr. Prov. 14, 34: *Miseros autem facit populos peccatum.*
    ...
    **En.** Cf. Prov. 14:34: *But sin makes peoples wretched.*

[^2]: **La.** Lib. XI. c. 17. n. 22, unde etiam quae sequuntur sumta sunt, sed multis omissis et mutatis. Quoad totam dist. cfr. Hugo, I. de Sacram. p. 5. c. 18. 19, et Sent. tr. 2. c. 2. 3.

    **En.** [Augustine, *On the Literal Meaning of Genesis*] Book XI, c. 17, n. 22, whence also what follows is taken, but with many things omitted and altered. On the whole distinction cf. Hugh [of St. Victor], *On the Sacraments* I, p. 5, c. 18, 19, and *Sentences* tr. 2, c. 2, 3.

[^3]: **La.** Cap. 19. n. 25, et seq. loc. ibid. c. 17. — Paulo postea *esse possunt* Vat. cum cod. D et paucis edd. *esse possent.*

    **En.** [The same work, Book XI] c. 19, n. 25, and the following passage ibid. c. 17. — A little later, *esse possunt* the Vatican edition, with codex D and a few editions [reads] *esse possent.*

[^4]: **La.** Cfr. August., XI. de Civ. Dei, c. 13.

    **En.** Cf. Augustine, *On the City of God* XI, c. 13.

## Notes

- This chunk is Lombard's text (the *littera*) for Distinction IV: the single Cap. I, *An perfecti et beati creati sint, an miseri et imperfecti* — whether the Angels were created perfect/blessed or wretched/imperfect, with the Augustine *de Gen. ad lit.* and *de Civ. Dei* discussion and the threefold sense of *perfectum* (secundum tempus / secundum naturam / universaliter). One continuous Lombard text spanning printed pp. 129–130 (= PDF 151–152); the COMMENTARIUS begins mid-p.130 (next chunk `bon-sent-II-d4-divisio`).
- **Source discipline.** Lombard's prose is clean in the IA djvu OCR (raw 9661–9721); transcribed verbatim from the OCR base and cross-verified on the 450 dpi column-band crops (`tools/extract-pages.py --volume vol2 --pages 129 --dpi 450` / `--pages 130`; `tools/colcrop.py vol2 129` / `130`). Both pages are two-column with two-stream footers; footers read off the crops, L column then R column.
- **No scholion** (`has_scholion: false`) — a littera chunk has no scholion.
- **Cross-chunk footer at p.129 (two streams — INHERITED, no backfill).** p.129's footer carries two streams. The **main-stream** notes 1–4 (`1 Primo modo explicat August. hoc verbum Iob, XI. de Civ. Dei c.15 …`; `2 Alex. Hal. S.p.I q.I m.I: Notandum praeterea …`; `3 Cfr. Iac. 3,15`; `4 Dist. I p.2 q.2 …`) anchor the *preceding* committed chunk `bon-sent-II-d3-p2-dubia` (DUB I *hoc verbum Iob* / DUB II *Sapientia est fructus pietatis* / DUB III) and are already its `[^6]`–`[^9]` (confirmed against that chunk's committed apparatus + its Notes, which explicitly deferred the subsequent `NOTAE AD LIBR. SENTENTIARUM` block here). **Not taken here; `d3-p2-dubia` not modified.** This littera's p.129 apparatus is the dedicated **`NOTAE AD LIBR. SENTENTIARUM`** block — `¹ Cfr. Prov. 14,34` → [^1] (*ex peccato miseria est¹*), `² Lib. XI c.17 n.22 …` → [^2] (*Unde Augustinus super Genesim²*). Exactly the `d2-littera`/`d3-littera` precedent (littera takes its dedicated NOTAE block; the prior dubia keeps that page's main-stream).
- **Cross-chunk footer at p.130 (OUTGOING — note for the d4-divisio build).** The littera body continues onto p.130 (*Unde Augustinus in eodem³* … *quam reliqui qui ceciderunt⁴*). p.130's footer is linearized in the raw OCR **after** the `COMMENTARIUS` (i.e. within the still-skeleton `bon-sent-II-d4-divisio` raw range 9722+, not in this chunk's 9661–9721). On the 450 dpi p.130 crops that footer is itself two-stream: the **main-stream** notes `¹ Cap. 19. n. 25, et seq. loc. ibid. c. 17. — Paulo postea esse possunt Vat. …` and `² Cfr. August., XI. de Civ. Dei, c. 13` anchor THIS littera's p.130 body (the *esse possunt/possent* variant + *in eodem* / *qui ceciderunt* loci) → [^3][^4], transcribed here from the crop (authoritative). The separate **`NOTAE AD COMMENTARIUM`** block on p.130 (`¹ Vat. in hac propositione pro habitibus bis substituit habitudinibus …`; `² Accipias particulam et pro etiam …`) is `bon-sent-II-d4-divisio`'s apparatus. **When d4-divisio is promoted it must take the p.130 `NOTAE AD COMMENTARIUM` block, NOT the p.130 main-stream ¹², which are this littera's [^3][^4]** (d4-divisio is still a skeleton — no backfill issue, just do not double-count at its build).
- **Apparatus crosswalk (per-page footer → continuous renumber 1–4):** p.129 `NOTAE AD LIBR. SENTENTIARUM` ¹² → [^1][^2]; p.130 main-stream ¹² → [^3][^4].
- **No hard `[?]` flags.** Lombard prose clean in OCR. Marginal editorial glosses trimmed per CLAUDE.md (`Expositio 1`, `Expositio 2`, `Contra`, `Dubium 1`, `Dubium 3`, `utrum creati sunt beati`, `utrum creati sint perfecti`, `Augustinus`, `Conclusio Magistri`, `Epilogus`, `Triplex perfectum`).
