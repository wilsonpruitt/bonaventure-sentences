---
id: "bon-sent-II-d11-dubia"
volume: 2
book: 2
distinctio: 11
type: dubia
title_la: "Dubia circa litteram Magistri"
title_en: "Doubts touching the letter of the Master"
printed_pages: [289, 290]
pdf_pages: [311, 312]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 289–290"
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from 450 dpi PDF column bands (p.289 R + p.290 L–R), fresh literal English translation, full apparatus from PDF footers (7 entries spanning p.289 nn.3–7 and p.290 nn.2–3), no [?] flags (2026-05-23)"
format_version: 1
---
...
[^2]: **La.** Post *tamen* excidisse videtur *et minus.*
    **En.** After *tamen* the words *et minus* seem to have dropped out.

[^3]: **La.** Vide Alex. Hal., S. p. II. q. 41. m. 4. a. 3; B. Albert., hic a. 3; S. Thom., hic q. I. a. 3; Petr. a Tar., hic q. 1. a. 3. et circa lit.; Richard. a Med., hic circa lit.; Ægid. R., hic dub. I. 2. litt.
    **En.** See Alexander of Hales, *Summa,* p. II, q. 41, m. 4, a. 3; Bl. Albert, on this [distinction], a. 3; St. Thomas, on this [distinction], q. I, a. 3; Peter of Tarantasia, on this [distinction], q. 1, a. 3, and circa litteram; Richard of Mediavilla, on this [distinction], circa litteram; Giles of Rome, on this [distinction], dub. I, 2, on the letter.

[^4]: **La.** Libr. IV. c. 33. Cfr. hic lit. Magistri, c. 2. in fine. — Paulo inferius cod. A *profecerunt* pro *defecerunt.*
    **En.** Book IV, c. 33. Cf. here the text of the Master, c. 2, at the end. — A little lower, codex A reads *profecerunt* for *defecerunt.*

[^5]: **La.** Hic c. 2.
    **En.** Here, c. 2.

[^6]: **La.** Vat. *fluente,* quod verbum eadem etiam in seqq. semper adhibet.
    **En.** The Vatican edition reads *fluente,* and uses that same word always in what follows.

[^7]: **La.** Libr. VIII. c. 20. n. 39. seqq. — Cfr. de hoc dubio S. Thom., hic q. 2. a. 1; Petr. a Tar., hic q. 2. a. 1. seqq.; Richard. a Med., hic a. 2. q. 1. seq.; Ægid. R., hic q. 2. a. 1. seqq.
    **En.** Book VIII, c. 20, n. 39 and following. — Cf. on this doubt St. Thomas, on this [distinction], q. 2, a. 1; Peter of Tarantasia, on this [distinction], q. 2, a. 1 and following; Richard of Mediavilla, on this [distinction], a. 2, q. 1 and following; Giles of Rome, on this [distinction], q. 2, a. 1 and following.

---

## Notes

**Incoming p.289 boundary CLEAN.** The preceding chunk d11-a2-q3 closes mid-page at *praeexcellentiam[^21].* immediately above the `DUBIA CIRCA LITTERAM MAGISTRI` header; this chunk opens at that header and the *Dub. I.* sub-header. P.289's footnotes nn. 1–2 (Aristotle *Rhetoric* + cross-reference to the preceding scholion) are anchored in d11-a2-q3; nn. 3–7 anchor here and are renumbered continuously as [^1]–[^5].

**Outgoing p.290 boundary CLEAN.** This chunk closes at *Et haec de Angelis dicta sufficiant.* on p.290 R, immediately above the `DISTINCTIO XII. Cap. I.` header. The next chunk d11-littera (Lombard's text for d.11) is the only remaining chunk of d.11; d.12 begins a new distinction. P.290's footnotes for the Bonaventure body are n.1 (the d.12 *elementorum* variant — anchored in d12-littera, not here), n.2 (*Vat. fluente* — anchors here at *gratia influente*), and n.3 (the *de hoc dubio* parallel-authors list with the leading *Libr. VIII. c. 20. n. 39.* — anchors here at *Augustinus super Genesim ad litteram*); the NOTAE AD LIBR. SENTENTIARUM block at the foot of p.290 L belongs to d12-littera.

**Only two dubia in d.11.** The session-resume note speculated a *Dub. III.* on a subsequent page, but eyes-on reading of the 450 dpi PDF column bands confirms d.11 closes with *Dub. II.* at the top of p.290 R, and `DISTINCTIO XII.` opens immediately thereafter. `Dub. III.` does not exist here.

**Marginal labels preserved inline (italic), per Vol II convention:** *Notandum.*, *Utrum quaest. incidens.*, *Distinctio.*, *Subdistinctio 1.*, *Subdistinctio 2.* — all rendered as inline italic markers, none promoted to headings.

**No scholion in this chunk.** Per Vol II Override §5: dubia chunks routinely have no scholion. `has_scholion` omitted from frontmatter (defaults false).
