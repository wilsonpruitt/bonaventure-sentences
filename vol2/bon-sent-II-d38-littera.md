---
id: "bon-sent-II-d38-littera"
volume: 2
book: 2
distinctio: 38
type: littera
title_la: "Distinctio XXXVIII — textus Magistri Sententiarum"
title_en: "Distinction XXXVIII — text of the Master of the Sentences"
printed_pages: [878, 879, 880]
pdf_pages: [900, 901, 902]
source: "Petri Lombardi Sententiarum Libri IV, Liber II, Dist. XXXVIII (as printed in S. Bonaventurae, Opera Omnia, Tomus II, Quaracchi 1885, pp. 878–880)"
line_start: 61084
line_end: 61216
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set column-by-column from 450dpi PDF (raw lines 61084–61216), fresh literal English translation, full apparatus from raw OCR + PDF footers (11 entries: NOTAE AD LIBR. SENTENTIARUM p.878 [1–5], p.879 [1–5], p.880 nulli-note [1]); littera has no scholion (2026-05-31)"
format_version: 1
---

# II Sent., d. 38 — Littera Magistri
## *Distinctio XXXVIII — text of the Master of the Sentences*
...
[^2]: **La.** Cap. 121. n. 32, ubi locus Scripturae est I. Tim. 1, 5. Seq. locus Augustini ibid. parum inferius.
    **En.** Chapter 121, n. 32, where the scriptural passage is 1 Tim. 1:5. The following passage of Augustine is in the same place, a little lower down.

[^3]: **La.** Libr. I. d. XVII. c. 3. — Paulo superius post *actionis* Vat. cum pluribus edd. addit *bonae*.
    **En.** Book I, d. XVII, c. 3. — A little above, after *actionis* the Vatican edition with several editions adds *bonae*.

[^4]: **La.** Rom. 10, 4. Verba Augustini in libro Sentent. Prosperi sunt sent. 190 (August. Enarrat. in Ps. 43. n. 1.); et quae sequuntur sent. 206 (in Ps. 56. n. 2.). In primo loco post *perfectio* Vat. addit *ex ipso et*, refragantibus codd. A B C D et edd. I, 8; in aliis tantum *ex ipso*. De originali recte annotat cod. Erf.: In originali *in ipso*, non *ex ipso*.
    **En.** Rom. 10:4. The words of Augustine in the book of the *Sentences of Prosper* are sentence 190 (Augustine, *Enarrationes in Ps. 43*, n. 1); and what follows is sentence 206 (on Ps. 56, n. 2). In the first place, after *perfectio* the Vatican edition adds *ex ipso et*, against codices A B C D and editions 1, 8; in the others only *ex ipso*. Concerning the original codex Erfurt rightly notes: in the original *in ipso*, not *ex ipso*.

[^5]: **La.** Cap. 6. n. 10. Seq. locus ibid. parum inferius, ubi in fine respicitur Matth. 22, 13.
    **En.** Chapter 6, n. 10. The following passage is in the same place, a little lower down, where at the end Matt. 22:13 is alluded to.

[^6]: **La.** Libr. II. c. 16. n. 54. Locus Scripturae est Matth. 6, 33. — Paulo superius pro *monet* Vat. cum pluribus edd. et cod. A *admonet*. — Seq. locus ibid. c. 17. n. 56; tertius ibid. infra, in quo pro *temporalem* edd., exceptis I, 8 et Vat., *corporalem*, sed originale *temporalium*.
    **En.** Book II, c. 16, n. 54. The scriptural passage is Matt. 6:33. — A little above, for *monet* the Vatican edition with several editions and codex A reads *admonet*. — The following passage is in the same place, c. 17, n. 56; the third is in the same place below, in which for *temporalem* the editions, except 1, 8 and the Vatican, read *corporalem*, but the original has *temporalium*.

[^7]: **La.** Psalm. 7, 10. Enarrat. ibi n. 9, multis mutatis, sed ad verbum in Glossa ibid. Ibid. est etiam seq. locus; et respicitur Ps. 36, 4.
    **En.** Ps. 7:10. *Enarratio* there, n. 9, with many changes, but word for word in the Gloss on the same place. In the same place is also the following passage; and Ps. 36:4 is alluded to.

[^8]: **La.** Psalm. 9, 16; Enarrat. in hunc Ps. n. 13.
    **En.** Ps. 9:16; *Enarratio* on this Psalm, n. 13.

[^9]: **La.** Augustinus, XI. de Trin. c. 6. n. 10, vide supra pag. 878, nota 3, ubi plura ex eodem loco afferuntur, ad quae mox respicitur.
    **En.** Augustine, *On the Trinity* XI, c. 6, n. 10; see above, p. 878, note 3, where more is adduced from the same passage, to which reference is presently made.

[^10]: **La.** Codd. *nullis*.
    **En.** The codices read *nullis*.

---

## Notes

**Provenance.** Latini re-set column-by-column from the 450 dpi PDF (vol2 pp. 900–902 = printed pp. 878–880) cross-checked against the IA djvu OCR (raw lines 61084–61216). This is the LITTERA MAGISTRI (Peter Lombard's text), printed above Bonaventure's commentary at the head of Distinction XXXVIII. Lombard's text has four chapters: Cap. I (*De voluntate et eius fine*), Cap. II (*Quis sit bonus finis, scilicet caritas*), Cap. III (*Quod omnes bonae voluntates unum habent finem...*), Cap. IV (*De differentia voluntatis et intentionis et finis*). Littera chunks carry no scholion.

**Page-split map.** The littera begins mid-page on printed p.878 (the upper part of p.878 is the tail of the d.37 commentary). Cap. I–III sit on p.878; Cap. III's closing paragraph and Cap. IV's body span p.879; Cap. IV concludes at the top of p.880, immediately before `COMMENTARIUS IN DISTINCTIONEM XXXVIII` (the divisio chunk). Page breaks placed at the running-head boundaries: `<!-- page 879 -->` before "Verumtamen huic sententiae"; `<!-- page 880 -->` before "ergo altera est voluntas videndi fenestras".

**Apparatus map.** 11 entries total, with Quaracchi's per-page restart:
- p.878 footer (`NOTAE AD LIBR. SENTENTIARUM`): notes 1–5 → `[^1]`–`[^5]`. (The left-column note `Hic dub. 1.2.3.` above that subheader belongs to the d.37 commentary, not the littera, and is excluded.)
- p.879 footer: notes 1–5 → `[^6]`–`[^9]` (note 5 = the cross-reference to p.878 note 3 → `[^9]`).
- p.880 footer: the single editorial note `Codd. nullis` on the word *nulli* → `[^10]`. (The `NOTAE AD COMMENTARIUM` block on p.880 belongs to the divisio chunk.)

**Hand-off picked up.** The a2-q3/dubia agents flagged that the p.878 `NOTAE AD LIBR. SENTENTIARUM` footer block belongs to this littera (Lombard's-text footnotes). Confirmed and captured here as `[^1]`–`[^5]`.

**Hand-off forwarded.** The p.880 `NOTAE AD COMMENTARIUM` footer notes belong to `bon-sent-II-d38-divisio` (COMMENTARIUS + DIVISIO TEXTUS, raw 61217–61269); only the `nulli`-note migrates here.

**[?] flags.** None. OCR-garbled "fideliam" on p.879 (`fi-/deliam`) is the printed word as set (a Quaracchi line-break artifact "fi-deliam" = *fideliam*); retained as printed.
