[^12]: Hucusque in edd. incongrue *intelligendum est*, cui lectioni plurimi codd. favent. Nostra lectio exhibetur a cod. Y. Mox Vat. *cum se viderit* pro *cum se videret*.

[^13]: Supple cum cod. aa *quam Angelum paris et superioris*. Aliquanto superius Vat. *Magister* pro *mater* et *hoc facit* pro *huius ratio est*.

## Notes

**Source range:** raw `bonaventure_vol2_raw.txt` lines 9505–9601; printed pp. 127–128 (PDF = printed + 22). Full 450 dpi column-band PDF re-set (`extract-pages.py --volume vol2 --pages 127-128 --dpi 450` + `colcrop.py`). videtur args clean prose from the IA djvu OCR base; the Respondeo (threefold *boni optati / affectus intensi / effectus impensi* + Corollarium) and the Scholion reflowed from the column-band crops; footers walked page-by-page.

**Apparatus crosswalk (continuous renumber 1–13):**
- **p.127 — 9 footer notes** (L-col n.1–2-start, R-col n.2-runover–9) → `[^1]`–`[^9]`. Note 2 (the long *de Caelesti Hierarch.* note) has an L→R column-footer runover (opener on L-col, `…ordinibus. Ratio praecipua inde sumitur…` recovered from R-col). Anchors: intro *magis diligat* (n.1); arg 1 *per quem Dionysius dicit* (n.2); arg 2 *Deum super omnia diligebat* (n.3); arg 4 *Ecclesiastici 13* (n.4); arg 5 *quam extraneum* (n.5); arg 6 *Ecclesiae militanti* (n.6); arg 7 *exhibitio operis* (n.7); arg 8 *magis diligit praeesse* (n.8); Respondeo *aut ratione affectus intensi* (n.9).
- **p.128 — footer SPLIT (this chunk takes n.1–4 only):** n.1 → `[^10]` (conclusio *plus trahit ad alterum*); n.2 → `[^11]` (conclusio *conformantur sibi*); n.3 → `[^12]` (conclusio *amplecti intelligendus est, cum se videret*); n.4 → `[^13]` (conclusio-3 *magis diligit Angelum inferioris*). **n.5+ → next chunk `d3-p2-dubia`** (n.5 = `Hic c. 4. circa medium, ubi ex Augustino haec affe-runtur…` → DUB I *ut infra exponit*; then n.6 *Epist. I. Tim. 2,4*, n.7 *Ioan. 8,44*, n.8 *de Civ. Dei XI. c.18*, n.9 *Matth. 1,22 et 21,4* — all DUB I). This is a **discovered outgoing split**: a3-q2's editorial Scholion I–II is short and ends partway down p.128, so `DUBIA CIRCA LITTERAM MAGISTRI` + DUB I's body begin on the *same* printed page (128) as a3-q2's footer; the clean/split rule (split iff q's scholion short enough that the next unit's body begins on q's footer page) yields a split here. Documented for the future `d3-p2-dubia` build: its p.128 apparatus starts at footer note 5.

**Incoming boundary a3-q1→a3-q2 = CLEAN (received):** a3-q1's editorial Scholion I–III carries no numbered apparatus and ends partway down p.127 L-col; QUAESTIO II opens immediately below it; all of p.127's footer (notes 1–9) is a3-q2's. a3-q1's last apparatus was p.126 n.5/`[^19]` — no backfill in either direction.

**Scholion:** editorial (Quaracchi) Scholion I–II — I = the Petr. a Tar. / Richard a Med. parallel-treatment note; II = the "other doctors" cross-reference list (Alex. Hal. / S. Thom. / B. Albert / Aegid. R.). No numbered apparatus (the `«…»` after *magis diligebat* in Scholion I is the opening quotation guillemet of Richard a Med.'s words — IA OCR garbled it `i (`, **not** a footnote marker; verified on the p.128 R-col crop).

**Marginal glosses trimmed** (not rendered): *Ad oppositum*, *Pro positione 1/2/3*, *Argg.*, *Conclusio / Conclusio 1/2/3*, *Distinctio*, *Corollarium*, *Notandum*.

**Low-confidence items parked for the d.10 600 dpi polish-blocker:** none new — the p.127/128 footers read cleanly at 450 dpi (the one colcrop R-col-0 left-edge clip on `[^12]`/`[^13]` was recovered from the full-width IA OCR, faithful).
