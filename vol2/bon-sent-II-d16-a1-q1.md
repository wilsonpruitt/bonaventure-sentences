...
quaestio: 1
type: quaestio
title_la: "Utrum homo sit vere imago Dei."
title_en: "Whether man is truly the image of God."
printed_pages: [393, 394, 395, 396]
pdf_pages: [415, 416, 417, 418]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 393–396"
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from 450 dpi PDF column bands (pp.393–396), fresh literal English translation, full apparatus from PDF footers (24 entries), SCHOLION I–III transcribed + translated (2026-05-25)"
format_version: 1
---

# bon-sent-II-d16-a1-q1
...
1. *Fundamenta.* Genesis primo[^3]: *Faciamus hominem ad imaginem* etc.; hoc non est nisi verbum Trinitatis: ergo etc.

2. Item, Ecclesiastici decimo septimo[^4]: *Deus de terra creavit hominem, et secundum imaginem suam fecit illum*; si igitur homo factus est secundum imaginem Dei, homo est imago Dei.

3. Item, quod est maxime natum uniri alteri maxime natum est ei configurari et conformari — amor enim, quia unit, transformare dicitur amantem in amatum, sicut dicit Hugo[^5] — sed creatura rationalis, ut homo, maxime nata est uniri Deo et in ipsum
...
*Ad 5.* Ad illud quod obiicitur, quod imago repraesentat secundum totum; dicendum, quod illud est verum de illa imagine, quae habet omnimodam perfectionem; et sic solus Filius Dei est imago Patris[^25]. De alia non est verum, quod repraesentet secundum totum *simpliciter*, repraesentat autem quantum ad *aliquam totalitatem*. Quia enim « rationalis creatura et intellectus quodam modo est omnia[^26] », et
...
### Article I. *In what way man is the image [of God] considered absolutely.*
...
1. *Fundamenta.* Genesis 1[^3]: *Let us make man to our image* etc.; this is none other than the word of the Trinity: therefore etc.

2. Likewise, Ecclesiasticus 17[^4]: *God created man of the earth, and made him after his own image*; if therefore man was made according to the image of God, man is the image of God.

3. Likewise, that which is in the highest degree apt to be united to another is in the highest degree apt to be configured and conformed to it — for love, since it unites, is said to transform the lover into the beloved, as Hugh says[^5] — but the rational creature, such as man, is in the highest degree apt to be united to God and to tend toward him
...
4. Likewise, that which truly represents something according to its noble act and according to distinction and order, is truly its image; but man truly represents God according to his most noble act, which is to understand — for he represents God not only inasmuch as he is being and living, but also inasmuch as he is intelligent — and again, he represents the distinction and order which is in the [divine] persons, with respect to memory, intelligence, and will[^6]: therefore man is truly the image of God.

**On the contrary:**

1. *To the opposite.* That to which something is made is not the thing itself, since nothing is made unto itself; but man was made unto the image of God, as is said in Genesis 1[^7]; therefore man is not the image [of God].

2. Likewise, wherever there is an image, there is *likeness*; wherever there is *likeness*, there is some *identity*; and wherever there is *identity*, there is *agreement* in some third thing[^8]: if therefore God and the creature do not agree in any third thing, the creature cannot be the likeness of God, and so neither the image.

3. Likewise, not every *likeness* is an image, but [only] an *expressed likeness*; but no *expressed likeness* of anything can have more that is dissimilar than what agrees: since therefore every creature is more unlike than like to God, as Augustine says in *On the Trinity* 15[^9], therefore no [creature] can be an expressed likeness of God: therefore none can be an image.

4. Likewise, wherever there is an image, there is configuration, for an image is considered with respect to figure[^10]; but the divine essence is in no way capable of being figured: therefore in no way can it be represented by any image: therefore no creature is the image of God.

5. Likewise, the image differs from the vestige, since the vestige represents according to a part, but the image according to the whole[^11]; but nothing finite can represent the infinite according to the whole: since therefore God is infinite, and every creature finite, no creature can be the image of God.
...
*To 5.* To that which is objected, that the image represents according to the whole; it must be said that that is true of that image which has every-mode perfection; and in this way the Son of God alone is the image of the Father[^25]. Of the other [image] it is not true that it represents according to the whole *simply*, but it represents according to a certain *totality*. For since "the rational creature and the intellect is in some way all things[^26]," and
...
[^5]: **La.** *De Arrha animae*: *Qui per affectum coniungeris, in ipsius similitudinem ipsa quodammodo dilectionis societate transformaris.*

     **En.** [Hugh of St. Victor], *De Arrha animae*: "You who are joined [to another] by affection are, by that very fellowship of love, in some way transformed into his likeness."

[^6]: **La.** Sicut explanatum est I. Sent. d. 3. p. II. per totam. — Vat. *et originem, quae* pro *et ordinem, qui.*

     **En.** As was explained in I Sent. d. 3 p. II throughout. — The Vatican [edition reads] *and origin, which* for *and order, which*.

[^7]: **La.** Vers. 26.

     **En.** Verse 26.

[^8]: **La.** Aristot., VI. Topic. c. 2. ait: « *Imago* id est, cuius generatio per imitationem est ». Et V. Metaph. text. 16. (IV. 9.) *similitudo* definitur rerum diversarum qualitas eadem; *identitas* autem unitas quaedam plurium in essentia.

     **En.** Aristotle, *Topics* VI c. 2, says: "*An image* is that whose generation is by imitation." And *Metaphysics* V text. 16 (IV. 9.) *likeness* is defined as the same quality of diverse things; while *identity* [is] a certain unity of many in essence.

[^9]: **La.** Cap. 11. n. 20. seqq., ubi et *similitudo* et *dissimilitudo*, quae est inter Verbum increatum et verbum creatum, inter imaginem increatam et creatam ostenditur. Cfr. lit. Magistri, I. Sent. d. III. c. 3. — De maiori cfr. August., 83 Qq. q. 74.

     **En.** Cap. 11 n. 20 ff., where both the *likeness* and the *unlikeness* between the uncreated Word and the created word, between the uncreated and created image, is shown. Compare the text of the Master, I Sent. d. III c. 3. — On the major [premise] compare Augustine, *83 Questions* q. 74.

[^10]: **La.** Hugo a S. Vict., I. de Sacram. p. VI. c. 2: *Imago* pertinet ad figuram. Cfr. hic lit. Magistri, c. 3. circa finem. — *Minorem* exhibet Damasc., IV. de Fide orthod. c. 16. Cfr. etiam eiusdem Orationes de imaginibus, ubi et haec sententia, sicut et plura alia huc spectantia occurrunt.

     **En.** Hugh of St. Victor, *De Sacramentis* I p. VI c. 2: *Image* pertains to figure. Compare here the text of the Master, c. 3 near the end. — The *minor [premise]* is supplied by [John] Damascene, *De Fide orthodoxa* IV c. 16. See also his *Orations on Images*, where this sentence is found, as also many other things bearing on this point.

[^11]: **La.** De quo vide I. Sent. d. 3. p. I. q. 2. ad 4.

     **En.** On which see I Sent. d. 3 p. I q. 2 ad 4.

[^12]: **La.** Aliqui codd. hic repetunt *creaturam*. Vat. cum uno alteroque cod. *Deus enim quodlibet finitum excellit in infinitum.*

     **En.** Some codices here repeat *creaturam*. The Vatican [edition], with one or another codex, [reads]: *For God excels every finite thing infinitely.*

[^13]: **La.** Codd. IQ *quodam modo*; bene. Dein multi codd. cum ed. 2 *autem* pro *etiam*; incongrue.

     **En.** Codices IQ [read] *quodam modo* ("in a certain mode"); well. Then many codices with ed. 2 [read] *autem* for *etiam*; incongruously.

[^14]: **La.** Plures codd. cum ed. 1 *proportionem*.

     **En.** Several codices with ed. 1 [read] *proportionem* ("proportion").

[^15]: **La.** Prov. 16, 4.

     **En.** Proverbs 16, 4.

[^16]: **La.** Cfr. August., de Vera Relig. c. 44. n. 82.

     **En.** Compare Augustine, *De Vera Religione* c. 44 n. 82.

[^17]: **La.** August., XIV de Trin. c. 8. n. 11.

     **En.** Augustine, *De Trinitate* XIV c. 8 n. 11.

[^18]: **La.** Cap. 8. n. 11. — Paulo superius post *similitudo expressa* non pauci codd. addunt *et imago*.

     **En.** Cap. 8 n. 11. — A little above, after *similitudo expressa*, not a few codices add *et imago*.

[^19]: **La.** Alluditur ad illud Ps. 4, 7: *Signatum est super nos* etc.

     **En.** Allusion to Ps. 4, 7: *It is signed upon us* etc.

[^20]: **La.** Cod. T (a manu suppari) bene addit *et origini*.

     **En.** Codex T (by a contemporary hand) well adds *et origini* ("and to the origin").

[^21]: **La.** Praesertim libr. IX. X. XIV. et XV. Cfr. lit. Magistri, I. Sent. d. III. c. 2. et ibid. Comment. p. II. per totam.

     **En.** Especially books IX, X, XIV, and XV. Compare the text of the Master, I Sent. d. III c. 2, and ibid. Commentary p. II throughout.

[^22]: **La.** Cfr. August., XV. de Trin. c. 22. n. 43. et hic lit. Magistri, c. 3. in fine et Comment. infra dub. 3.

     **En.** Compare Augustine, *De Trinitate* XV c. 22 n. 43, and here the text of the Master, c. 3 at the end, and the Commentary below dub. 3.

[^23]: **La.** Vat. cum uno alteroque cod. *proportionem*.

     **En.** The Vatican [edition], with one or another codex, [reads] *proportionem*.

[^24]: **La.** Vat. *etsi magna est*.

     **En.** The Vatican [edition reads] *etsi magna est* ("although it is great").

[^25]: **La.** Cfr. I. Sent. d. 31. p. II. a. 1. q. 1. seq. et dub. 4.

     **En.** Compare I Sent. d. 31 p. II a. 1 q. 1 seq. and dub. 4.

[^26]: **La.** Aristot., III. de Anima, text. 37. (c. 8.): « *Anima entia quodam modo est omnia* ». Ibid. text. 14. (c. 4.): *Potentia quodam modo est intelligibilia intellectus, sed actu nullum antequam intelligat. Oportet autem sic, ut in tabula, in qua nihil est scriptum actu* etc.

     **En.** Aristotle, *De Anima* III text. 37 (c. 8): "*The soul in some way is all things.*" Ibid. text. 14 (c. 4): *The intellect is in potency in some way the intelligibles, but actually none [of them] before it understands. It must be so, as in a tablet on which nothing is actually written* etc.

## Notes

- **Page span.** p.393 L band 2 (QUAESTIO I header + title + Fundamenta args 1–2 opener + arg 3 first half) → p.393 R band 2 (arg 3 close) → p.394 L band 1 (arg 4 + *Ad oppositum* args 1–6) → p.394 L band 2 (footers ¹–⁵) → p.394 R band 1 (CONCLUSIO + Respondeo + *Quadruplex similitudo* + *Applicatio ad Deum* + *Probatio: Primo de convenientia ordinis*) → p.394 R band 2 (footers ⁶–¹¹) → p.395 L band 0–1 (continuation + *Confirmatur* + *Probatio 2* + *Distinctio* + *Confirmatur*) → p.395 L band 2 (footers ¹–⁶) → p.395 R band 0–2 (*Solutio oppositorum* ad 1, ad 2 with *Notandum*, ad 3, ad 4, ad 5 opener; footers ⁷–¹⁰) → p.396 L band 0 (ad 5 close with *Notandum*, ad 6 opener) → p.396 R band 0 (ad 6 close with *Notandum* + SCHOLION I opener) → p.396 R band 1 + L band 1–2 + R band 2 (SCHOLION I cross-column continuation + II commentator list + III).

- **Cross-chunk footer hand-off (from `d16-divisio`).** p.393 L band 2 carries 5 footers. Footers ¹ (*Ita codd. et edd.; textus Magistri melius primo.*) and ² (*Codd. W an relativam.*) are anchored in `d16-divisio` (DIVISIO TEXTUS para 1 + TRACTATIO QUAESTIONUM). Footers ³ (Vers. 26), ⁴ (Vers. 1), ⁵ (Hugo *de Arrha animae*) inherit here at [^3]–[^5] per the d16-divisio Notes block forward hand-off — anchored at *Faciamus hominem ad imaginem³*, *secundum imaginem suam fecit illum⁴*, and *sicut dicit Hugo⁵* in args 1–3 respectively.

- **Per-page footer split.** p.393 L footers 3–5 = [^3]–[^5]; p.394 L footers 1–5 = [^6]–[^10]; p.394 R footers 6–11 = [^11]–[^16]; p.395 L footers 1–6 = [^17]–[^22]; p.395 R footers 7–10 = [^23]–[^26]; p.396 carries no body footnote (SCHOLION only, footnote-less).

- **Numbering convention.** Continuous renumbering across the four pages 393–396 yields 24 entries [^3]–[^26]. The chunk does **not** restart at [^1] because [^1] and [^2] are owned by `d16-divisio` (cross-chunk continuity across the shared p.393 footer).

- **Marginal labels preserved inline** per locked Vol II convention: *Fundamenta.*, *Ad oppositum.*, *Quadruplex similitudo.*, *Applicatio ad Deum.*, *Conclusio.*, *Probatio.* (×2), *Confirmatur.* (×2), *Distinctio.*, *Solutio oppositorum.*, *Notandum.* (×3).

- **No `[?]` flags** — all 24 footer anchors + marginal labels crisp at 450 dpi across pp.393–396. SCHOLION I cross-column flow (L→R→L→R) verified column-by-column.

- **`has_scholion: true`** — SCHOLION block present on p.396 (sections I, II, III). SCHOLION I is a substantial doctrinal scholion on the definition of imago and the connatural/natural/artificial trichotomy; II + III are commentator lists for this and the third article-question respectively.

- **Forward hand-off to `d16-a1-q2`.** No p.396 footer migrates forward — p.396 R bottom shows the QUAESTIO II opener (*Secundo quaeritur, utrum homo sit imago Dei naturaliter.*) with its own footers ¹ (*Intellige etsi, quod etiam Vat. ponit.*) and ² (*Hic in corp. quaest.*) and ³ (*Vat. ergo inest ei naturaliter.*) anchoring in q2's body.

- **Audits expected:** paraphrase HIGH (first-pass over OCR-cascade base — typical for Vol II Tier-2 promotion); apparatus-count flag should clear for q1 (24 entries vs raw heuristic ~22–28 expected within tolerance); header audit Q-LOSS / A-LOSS / DUB-LOSS will continue to fire because d16-a1-q2 / q3 / a2-q1–q3 / dubia siblings remain skeleton — clears as those promote.
