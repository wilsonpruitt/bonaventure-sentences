---
id: "bon-sent-II-d21-littera"
volume: 2
book: 2
distinctio: 21
type: littera
title_la: "Distinctio XXI — Littera Magistri"
title_en: "Distinction XXI — The Text of the Master"
printed_pages: [489, 490]
pdf_pages: [511, 512]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 489–490"
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from 450 dpi PDF column bands (pp. 489 R-bottom + 490 L+R), fresh literal English translation, full apparatus from PDF footers (8 entries: p.489 NOTAE block 1–2 + p.490 footers 1–6, renumbered continuously [^1]–[^8]), five Lombard capitula (I–V) preserved verbatim (2026-05-28)"
format_version: 1
---

# bon-sent-II-d21-littera

## *Distinctio XXI — Littera Magistri.*
...
« Videns igitur diabolus, hominem per obedientiae humilitatem posse ascendere, unde ipse per superbiam corruerat, invidit ei; et qui prius per superbiam fuerat diabolus, id est deorsum lapsus, zelo invidiae factus est satan, id est adversarius. Unde et mulierem tentavit, in qua minus quam in viro rationem vigere novit[^1] ». « Eius enim malitia, ad tentandam virtutem timida[^2], humanam naturam in ea parte, ubi debilior videbatur, aggressa est, ut si forte illic aliquatenus praevaleret, postmodum fiducialius ad alteram, quae
...
[^1]: **La.** Hugo, *Sum. Sent.* tr. 3. c. 4. Ex hoc capitulo nec non ex seq. atque ex eiusdem libro I. *de Sacram.* p. VII. c. 4, 6, 9, 3, Magister sumsit quae sequuntur usque ad finem dist.
    ...
    **En.** Hugh (of St. Victor), *Summa Sententiarum* tr. 3, c. 4. From this chapter as well as the following one, and from the same author’s book I *On the Sacraments* part VII, cc. 4, 6, 9, 3, the Master has taken what follows down to the end of the distinction.

[^2]: **La.** Alluditur ad Sap. 17, 10: *Cum sit enim timida nequitia*.

    **En.** Allusion to Wisdom 17:10: *For wickedness, being timid…*

[^3]: **La.** Libr. XI. *de Gen. ad lit.* c. 2. n. 4. Quae sequuntur usque in cap. V. excerpta sunt ex eodem loco, c. 2, 3, 27, 28, 29.

    **En.** (Augustine), Book XI *On Genesis according to the Letter* c. 2, n. 4. What follows down to chapter V is excerpted from the same place, cc. 2, 3, 27, 28, 29.

[^4]: **La.** Cod. Erl. adnotat: *Illud in Glossa ad Gen.* 3, 1. *et non in Augustino* [scil. quoad verba]. — In eadem Glossa inveniuntur plura alia, quae a Magistro hic afferuntur.

    **En.** Codex Erl. notes: *That is in the Gloss on Gen.* 3:1 *and not in Augustine* [namely as to the wording]. — In the same Gloss are found many other things which the Master here adduces.

[^5]: **La.** Num. 22, 28.

    **En.** Numbers 22:28.

[^6]: **La.** Vat. contra codd. et edd. 1, 3, 5 praemittit *etiam*, et paulo superius post *boni* omittit *enim*.

    **En.** The Vatican edition, against the codices and editions 1, 3, 5, prefixes *etiam* (“also”), and a little above, after *boni*, omits *enim*.

[^7]: **La.** Gen. 3, 1-3, et seq. locus ibid. 4. seqq.

    **En.** Genesis 3:1–3, and the following passage at the same place, 4 ff.

[^8]: **La.** Hunc locum sumsit Hugo (l. *de Sacram.* p. VII. c. 6.) ex Gregorio super Evang. *Hom.* 16. n. 1. 2.

    **En.** Hugh (of St. Victor) took this passage (book *On the Sacraments* part VII, c. 6) from Gregory on the Gospels, *Homily* 16, nn. 1–2.

---

## Notes

- **Provenance.** Latin re-set verbatim from 450 dpi PDF column bands of pp. 489 R-bottom (DISTINCTIO XXI title block + Cap. I opener, after d.20 DUB. VII close) and p. 490 L+R (Cap. I continuation + Cap. II + Cap. III + Cap. IV + Cap. V to *ambitur*[^8]). Per Vol II Override the column-band PDF read is authoritative; the IA djvu OCR (raw lines 34402–34499) cascade-fragments the Cap. headings into the d.20 DUB. VI/VII column bleed (e.g. `Cap. V.` surfaces in the raw at line 34444, mid Cap. II text, due to two-column bleed).
- **Page-split map.** p. 489 R-1: DISTINCTIO XXI title + `Cap. I` heading + opener through *postmodum fiducialius ad alteram, quae*. p. 489 R-2 footers: NOTAE AD LIBR. SENTENTIARUM ¹ (Hugo *Sum. Sent.* tr. 3 c. 4) = [^1]; ² (Sap. 17, 10 *timida nequitia*) = [^2]. p. 490 L: Cap. I close (*robustior fuit … experiretur*) + Cap. II (full) + Cap. III (full) + Cap. IV opener (Aug. *Non est putandum* … *potestas a Deo*[^4]). p. 490 R: Cap. IV continuation (Sic autem loquebatur … *etiam*[^6] *officium*) + Cap. V (full, *Tentatio autem* through *ambitur*[^8]). p. 490 L-2 footers: ¹ (Lib. XI *de Gen. ad lit.* c. 2 n. 4) = [^3]; ² (Cod. Erl. on Gloss vs Augustinus) = [^4]. p. 490 R-2 footers: ³ (Num. 22, 28) = [^5]; ⁴ (Vat. *etiam* variant) = [^6]; ⁵ (Gen. 3, 1-3) = [^7]; ⁶ (Hugo *l. de Sacram.* p. VII c. 6 ex Greg. *Hom.* 16) = [^8].
- **Cross-chunk hand-offs.** *Received* from `d20-dubia`: NOTAE block on p. 489 R-2 (footers ¹ Hugo + ² Sap. 17, 10) — native to this Cap. I opener per the d20-dubia forward note (resume note 2026-05-25); folded as [^1]–[^2]. *Forwarded* to `d21-divisio`: none — `Cap. VI. De duplici tentationis specie` opens at the top of p. 491 L-1 (raw line 34501) and carries its own apparatus block (e.g. the *Aug. in Enchiridio* and r.l.j 3 marginalia at p. 491 footers 3+).
- **No `[?]` flags.** All 8 anchors crisp at 450 dpi across pp. 489–490. Cap. V's *moriamur*[^7] anchor on Gen 3:1–3 absorbs the chained scriptural quotation block (*ne forte moriamur* + *Nequaquam moriemini* + *Quocumque die comederitis ex eo morte moriemini*) — Quaracchi anchors only at the close of the first quotation per their convention.
- **Five Lombard capitula** preserved verbatim with Quaracchi's italic chapter titles: I *De invidia diaboli, qua ad tentandum accessit*; II *De forma, in qua venit*; III *De calliditate serpentis*; IV *Utrum elegerit serpentem, ut per eum tentaret diabolus*; V *De modo tentationis*. Cap. VI–onward belong to `d21-divisio` per the auto-chunker boundary on p. 491.
- **Lombard marginals** on p. 490 (`Augustinus.` at Cap. III; `Dubium 1.` at Cap. IV close; `Dubium 2.` at Cap. IV mid; `Quaestio incidens` at *Hic quaeri solet*; `Tres modi tentandi.` at Cap. V close) are preserved inline by Vol II convention only where they survived the column-band read; they appear here as section-internal italics rather than as separately rendered margin labels (the d.21 q-articles will pick up their own marginals downstream).
