...
quaestio: 1
type: quaestio
title_la: "An caelum sit figurae orbicularis"
title_en: "Whether the heaven is of spherical figure"
printed_pages: [341, 342]
pdf_pages: [363, 364]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 341–342"
has_apparatus: true
has_scholion: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from 450 dpi PDF column-bands (Vol II PDF-priority inversion) for pp. 341–342, including the ARTICULUS II opener folded into q1 per the locked Vol II convention; fresh literal English translation; full apparatus from page-by-page footer NOTAE (p.341: 11 entries; p.342: 2 entries; 13 total); three-section SCHOLION transcribed and translated (2026-05-24)"
format_version: 1
---

# bon-sent-II-d14-p1-a2-q1

## *An caelum sit figurae orbicularis.*
...
3. Item, simplicissimo corpori simplicissima debetur figura[^3]; sed caelum est simplicissimum inter corpora, cum sit subtilissimum: ergo simplicissimam debet habere figuram. Sed haec est figura circularis: ergo etc.

4. Item, ei corpori, quod est maxime contentivum, debetur figura capacissima; sed caelum est contentivum omnium, sicut dicit Damascenus[^7], et figura orbicularis est capacissima, sicut manifeste convincit ratio et sensus: ergo etc.

5. Item, corpori perfectissimo perfectissima debetur figura; sed caelum est perfectissimum omnium, et figura orbicularis est perfectissima omnium figurarum, sicut probatur in alia scientia[^8], maxime cum in ea reperiatur perfectio senarii — sexies enim tantum reperitur in circumferentia, quantum est a circumferentia ad centrum — ergo etc.
...
*Ad oppositum* arguitur: 1. Primo per illud Psalmi[^9]: *Extendens caelum sicut pellem*, alia translatio, *sicut cameram*: ergo videtur, quod caelum se habeat ad modum tentorii, et ita videtur esse figurae semicircularis.

2. Item, *ratione* videtur, quia in universo nihil est superfluum, sed omnia facta sunt propter hominem[^10]: ergo nihil ponendum est, quod non valeat ad hominis usum. Sed si caelum esset semicircularis figurae, sufficeret ad tegendam terram inhabitatam ab hominibus: ergo videtur, quod superfluat alius semicirculus.

3. Item, caeli sunt solidissimi firmati, sicut dicitur in Iob[^11]; et hoc innuit ipsum nomen octavae sphaerae, quae dicitur firmamentum: ergo maxime competit eis figura, secundum quam maxime stabi-
...
3. Likewise, to the simplest body the simplest figure is owed[^3]; but the heaven is the simplest among bodies, since it is the most subtle: therefore it must have the simplest figure. But this is the circular figure: therefore etc.

4. Likewise, to that body which is most containing, the most capacious figure is owed; but the heaven is the container of all things, as Damascene says[^7], and the spherical figure is the most capacious, as reason and sense plainly establish: therefore etc.

5. Likewise, to the most perfect body the most perfect figure is owed; but the heaven is the most perfect of all, and the spherical figure is the most perfect of all figures, as is proved in another science[^8], especially since in it the perfection of the senary is found — for six times is found in the circumference as much as the distance from the circumference to the center — therefore etc.
...
*On the contrary* it is argued: 1. First by that of the Psalm[^9]: *Stretching out the heaven like a skin*, another translation, *like a tent*: therefore it seems that the heaven has itself after the manner of a tent, and so seems to be of semicircular figure.

2. Likewise, by *reason* it seems so, because in the universe nothing is superfluous, but all things were made for man[^10]: therefore nothing is to be posited which is not of use to man. But if the heaven were of semicircular figure, it would suffice to cover the earth inhabited by men: therefore it seems that the other semicircle is superfluous.

3. Likewise, the heavens are most solidly firmed, as is said in Job[^11]; and the very name of the eighth sphere, which is called *firmament*, implies this: therefore the figure most befitting them is that according to which they are most stabilized; but this is more the semicircular than the circular: therefore etc.
...
[^1]: **La.** Aristot., II. *de Gener. et corrupt.* text. 39. (c. 10.). Cfr. II. *de Caelo et mundo*, text. 34. (c. 5.); II. *de Partib. animal.* c. 14; IV. c. 10.

    **En.** Aristotle, *On Generation and Corruption* II, text 39 (c. 10). Cf. *On the Heavens* II, text 34 (c. 5); *On the Parts of Animals* II, c. 14; IV, c. 10.

[^2]: **La.** Part. II. huius d. a. 2. q. 2.

    **En.** Part II of this distinction, a. 2, q. 2.

[^3]: **La.** Sicut ponit Aristot., II. *de Caelo et mundo*, text. 42. (c. 7.).

    **En.** As Aristotle posits, *On the Heavens* II, text 42 (c. 7).

[^4]: **La.** Vide scholion ad praecedentem quaest.

    **En.** See the scholion on the preceding question.

[^5]: **La.** Cfr. Chalcidius, *in Timaeum Platonis*, n. 59. seqq. (ed. Wrobel, pag. 127).

    **En.** Cf. Chalcidius, *On the Timaeus of Plato*, n. 59 ff. (ed. Wrobel, p. 127).

[^6]: **La.** De hoc et seqq. fundam. vide Aristot., II. *de Caelo et mundo*, text. 22. seqq. (c. 4.).

    **En.** On this and the following fundamental arguments, see Aristotle, *On the Heavens* II, text 22 ff. (c. 4).

[^7]: **La.** Libr. II. *de Fide orthod.* c. 6.

    **En.** *On the Orthodox Faith*, book II, c. 6.

[^8]: **La.** Scil. mathematica. — Hoc arg. insinuatur a Platone in *Timaeo* (ed. Serrani, tom. III. pag. 33), ubi etiam dicit, Deum, scindendo *sexies* interiorem circulum, septem orbes impares formasse (ibid. pag. 36).

    **En.** Namely, mathematics. — This argument is suggested by Plato in the *Timaeus* (ed. Serranus, tom. III, p. 33), where he also says that God, by cutting the inner circle *six times*, formed seven unequal orbs (ibid. p. 36).

[^9]: **La.** Psalm. 103, 2. — Alia haec translatio est Septuaginta, Isa. 40, 22, ubi Vulgata: *Qui extendit velut nihilum caelos.*

    **En.** Psalm 103:2. — This other translation is that of the Septuagint, Isaiah 40:22, where the Vulgate reads: *Who stretches out the heavens like a nothing.*

[^10]: **La.** Cfr. infra d. 15. a. 2. q. 1.

    **En.** Cf. below, d. 15, a. 2, q. 1.

[^11]: **La.** Cap. 37, 18: *Tu forsitan cum eo fabricatus es caelos, qui solidissimi quasi aere fusi sunt.* — Paulo inferius multi codd. cum ed. 2 *stabilitur* pro *stabiliuntur*.

    **En.** Chapter 37:18: *Perhaps you formed the heavens with him, which are most solid as though cast from bronze.* — A little lower, many codices with the second edition read *stabilitur* for *stabiliuntur*.

[^12]: **La.** Cfr. supra pag. 70, nota 4.

    **En.** Cf. above, p. 70, note 4.

[^13]: **La.** Plurimi codd. cum primis edd. et Vat. *empyreo*; nostra lectio est codd. F1 (T a secunda manu).

    **En.** Very many codices with the first editions and the Vatican edition read *empyreo*; our reading is that of codex F1 (and T from a second hand).

## Notes

- **Page span**: p. 341 (L bottom band onward, beginning at *ARTICULUS II*) through p. 342 (L–R, ending at the bottom of *Ad 4* / SCHOLION III). The next chunk (a2-q2, *Utrum in caelo sit ponere dextram et sinistram*) opens with `QUAESTIO II.` mid-p.342 R; its body and footers (p.342 R-bottom note 3, etc.) belong to that chunk.
- **Column-band provenance**: re-set from `/tmp/colcrop/vol2-p341-{L,R}-{0..2}.png` and `/tmp/colcrop/vol2-p342-{L,R}-{0..2}.png` at 450 dpi, Vol II PDF-priority inversion (the IA djvu OCR cascade-shatters the Respondeo, both *Notandum/Conclusio* marginal labels, and the entire footer block on these pages).
- **ARTICULUS II opener**: folded into this chunk (q1) per the locked Vol II convention (no standalone a2-divisio chunk); the opener occupies the bottom of p.341 L between the tail of a1-q2 and the start of QUAESTIO I.
- **Marginal labels** preserved inline per Vol II convention: *Notandum.* and *Conclusio.* in the Respondeo block; *Solutio oppositorum.* on *Ad 1*; *Notandum.* on *Ad 4*. *Quaestio incidens.* / *damenta* / etc. visible in OCR margin are running-head fragments and have been dropped.
- **Apparatus page-split map**:
  - p. 341 footer = 11 numbered Quaracchi notes ([^1]–[^11]) — full page footer block belongs to this quaestio (the ARTICULUS II opener takes none; QUAESTIO I's *Quod autem habeant…* begins on p. 341 R-1).
  - p. 342 footer = 2 numbered Quaracchi notes ([^12] = `Cfr. supra pag. 70, nota 4.`; [^13] = `Plurimi codd. … empyreo …`) belong here; the third numbered note on p. 342 (`Text. 13. (c. 2.), qui secundum versionem Arabico…`) is the opener for QUAESTIO II's *Per illud quod dicit Philosophus in secundo de Caelo et mundo* citation and belongs to a2-q2.
- **Note [^2]** (`Part. II. huius d. a. 2. q. 2.`) — Quaracchi printed no inline superscript `²` glyph on arg. 2 (confirmed at 600 dpi `raw/vision/vol2/r600/p-341-r600.png`, both body L+R columns and footer block). The footer entry sits between printed `¹` and `³` and is implicitly attached to arg. 2 (*motus circularis*) per the Quaracchi cross-reference pattern in Vol II d. 14. Marker retained at the clause-end of *figurae circulari* in arg. 2 as the editorially-restored anchor position.
- **Cross-chunk footer hand-offs**: p. 342 footer note 3 forward-hands to a2-q2 (see above); no backward hand-off from p. 341 (the a1-q2 promotion already accounted for the p. 341 share via [^29] of that chunk per the prior session's split-convention note).
- **Polish-blocker resolution 2026-05-25 (600 dpi).** Both `[?]` flags closed: (a) `[^2]` in-line position — ACCEPT-ILLEGIBLE: at 600 dpi `p-341-r600.png` there is genuinely no printed superscript `²` on arg. 2 (Quaracchi attached the cross-reference footer implicitly to the *motus circularis* sub-argument); editorially placed at clause-end. (b) Footer [^13] (`F1 (T a secunda manu)`) — RESOLVED at 600 dpi `p-342-r600.png` (full-width footer crop): parenthesis is unambiguously present in the printed text.
