---
id: "bon-sent-II-d34-littera"
volume: 2
book: 2
distinctio: 34
type: littera
title_la: "Distinctio XXXIV — Littera Magistri"
title_en: "Distinction XXXIV — The Text of the Master"
printed_pages: [800, 801, 802]
pdf_pages: [822, 823, 824]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 800–802"
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set from 450dpi PDF column bands + IA djvu OCR (raw 55736–55856), literal English, full apparatus from page footers (10 entries), littera Cap I–V (2026-05-30)"
format_version: 1
---

# bon-sent-II-d34-littera

## *Distinctio XXXIV — Littera Magistri.*
...
The first cause and origin of sin was a good thing, because before the first sin there was not anything of evil[^1] from which it could arise. For since it had an origin and cause, it had it either from good or from evil. But evil did not exist before; therefore it arose from good. For sin first arose in the angel, and afterward in man. And what was the angel but a good nature of God? The evil which was in the angel did not arise from God, nor from any other than from the angel; therefore it arose from good. Whence Augustine[^2], in his responses against the heretic Julian, who had said: "If sin is from nature, then nature is evil"; he says: I ask that, if he can, he answer. It is manifest that from an evil will, as from an evil tree, all evil works are made, as evil fruits; but whence does he say that the evil will itself arose, except from good? For if from the angel — what is the angel but a good work of God? If from man — what was man himself but a good work of God? Nay, what were these two, before the evil will arose in them, but a good work of God and a good and praiseworthy nature? Therefore evil arises from good, nor was there anything from which it could arise except from good. I say, therefore, that no evil preceded the evil will, but it took its origin from good." — Here it is plainly said[^3] that the first cause and origin of evil was a good nature. And nonetheless it is shown of what sin it was the cause, namely of the evil will.
...
But against what has been said, "that there is an evil which is a good," some object thus: if we say that a good is an evil, we fall into that prophetic sentence where it is read: Woe to those who call good evil, and evil good. Therefore, if we wish to avoid this curse, we ought by no means to say that a good is an evil, and conversely. But Augustine determines this in the same book[^7], saying: "What was said in the pro-
...
[^1]: **La.** Codd. BCDE et ed. 1. *malum.* Deinde pro *habuerit* Vat. cum edd. 1, 4, 6, 8, 9 *habuit* contra codd. — Maior huius dist. pars invenitur in Hugone, Sum. sent. tr. 3. c. 14.
    **En.** Codices BCDE and edition 1 read *malum.* Then, for *habuerit,* the Vatican edition with editions 1, 4, 6, 8, 9 reads *habuit,* against the codices. — The greater part of this distinction is found in Hugh, *Sentences,* tr. 3, c. 14.

[^2]: **La.** Libr. II. de Nuptiis et concupisc. c. 28. n. 48.
    **En.** Book II, *On Marriage and Concupiscence,* c. 28, n. 48.

[^3]: **La.** Edd. 1, 3 *docetur.*
    **En.** Editions 1, 3 read *docetur.*

[^4]: **La.** Cap. 23. n. 8; seq. locus ibid. c. 24. n. 8.
    **En.** Chapter 23, n. 8; the following passage in the same place, c. 24, n. 8.

[^5]: **La.** Cap. II. n. 3. — Praecedens definitio mali occurrit apud August., I. Contra Adversar. Legis et Prophetarum, c. 3. n. 7. — Deinde locus: *Bonum enim minui* etc, Enchirid. c. 12. n. 4, in quo textu Vat. cum pluribus edd. ante *consumatur* adiicit *natura.* Ultimus locus est ibid. c. 13. n. 4, in quo textu pro *Cui vero,* quod cum originali habet Vat., in aliis edd. et codd. minus bene legitur *Cum vero.*
    **En.** Chapter II, n. 3. — The preceding definition of evil occurs in Augustine, *Against the Adversary of the Law and the Prophets* I, c. 3, n. 7. — Then the passage: *For to diminish good* etc., *Enchiridion* c. 12, n. 4, in which text the Vatican edition with several editions adds *natura* before *consumatur.* The last passage is in the same place, c. 13, n. 4, in which text, for *Cui vero,* which the Vatican edition has with the original, in the other editions and codices it is read less well as *Cum vero.*

[^6]: **La.** Ita codd. et edd., Vat. *connexione.* — Loc. cit. — Etiam textus seq. capitul. est ibid. c. 14. n. 4.
    **En.** Thus the codices and editions; the Vatican edition reads *connexione.* — Loc. cit. — The text of the following chapter is also in the same place, c. 14, n. 4.

[^7]: **La.** In codd. ABDE et edd. 1, 2, 3, 7, 9 omittitur *malum,* quod etiam deest in textu Maurinorum, ubi ad marginem ponitur. Seq. locus ibid. c. 18. n. 4. — *Isai.* 5, 20. — Paulo superius post *dicimus* edd. 1, 8 addunt *et malum bonum.* — Cap. 19. n. 6. Sicut verba praecedentia, ita etiam ultimus locus c. 13. n. 4. Sed ultimus locus in Vat. et multis edd. corrupte legitur. In originali ita est: *Quisquis ergo dicit: malum est, hominem esse; aut: bonum est, iniquum esse; ipse incidit in propheticam illam sententiam. Vae his, qui dicunt etc. Opus enim Dei culpat etc.* Noster textus legitur in codd. et edd. 8, 9.
    **En.** In codices ABDE and editions 1, 2, 3, 7, 9 the word *malum* is omitted, which is also lacking in the text of the Maurists, where it is placed in the margin. The following passage is in the same place, c. 18, n. 4. — *Isaiah* 5, 20. — A little above, after *dicimus,* editions 1, 8 add *et malum bonum.* — Chapter 19, n. 6. As with the preceding words, so also the last passage is c. 13, n. 4. But the last passage in the Vatican edition and many editions is read corruptly. In the original it is thus: *Whoever therefore says: it is evil, that a man exists; or: it is good, that an iniquitous man exists; he himself falls into that prophetic sentence. Woe to those who say etc. For he blames the work of God etc.* Our text is read in codices and editions 8, 9.

---

## Notes

**Provenance.** Latin re-set from the 450 dpi PDF column bands (printed pp. 800–802 = PDF 822–824, offset `pdf = printed + 22`) authoritative wherever the two-column IA djvu OCR (raw 55736–55856) was cascade-fragmented, reflowed Left-column-then-Right per the Vol II two-column discipline. This is Lombard's *Littera Magistri* for Distinctio XXXIV (*De peccato actuali* — on actual sin, treating the origin and cause of the first sin, that it arose from good, and that evil exists only in a good thing), Cap. I–V. The littera opens at the bottom band of the p.800 L-column (the `DISTINCTIO XXXIV.` header immediately after the end of `d33-dubia`'s DUB. IV Respondeo "…magis sibi reputet praestari beneficium, quam inferri supplicium") and closes at the top of p.802 with "…et vitium hominis laudat, quod est iniquitas».", immediately before `COMMENTARIUS IN DISTINCTIONEM XXXIV.` (raw 55857), which is the `d34-divisio` chunk.

**Capitula (5), order verified at 450 dpi.** Cap. I *De peccato actuali*; Cap. II *Quae fuit origo et causa peccati prima*; Cap. III *Quae fuerit secundaria causa malorum*; Cap. IV *Quod non nisi in re bona sit causa malorum*; Cap. V *Quod in his fallit dialecticorum regula de contrariis*. All five present and in printed reading order (L-column-then-R-column per page). NOTE: the IA djvu OCR running head `DISTINCTIO XXXIV.` at raw 55782 is a **page-top running head for p.801**, NOT the start of the littera — the true distinction header is on the lower L-band of p.800 (raw 55772). The auto-chunked skeleton mistook the p.801 running head for the start and dropped all of p.800's Cap. I–II + most of Cap. III; this rebuild recovers them.

**Page-split map.** Reading order is Left column top→bottom, then Right column top→bottom, per printed page. **p.800:** the L-col + R-col TOP bands hold the tail of d.33 DUB. IV (Lazarus/Martyrs Respondeo) — those belong to the already-complete `d33-dubia` chunk, NOT this littera. The littera begins at the **bottom** of the p.800 L-col (DISTINCTIO XXXIV + Cap. I *De peccato actuali* opener + Cap. II *Quae fuit origo* opener "Causa et origo prima peccati res bona exstitit…"); R-col holds Cap. II continued (the Augustinus contra Iulianum quote, ending "…cuius peccati fuerit causa, scilicet malae voluntatis") + Cap. III header + Cap. III opener ("Mala autem voluntas illa angeli et hominis causa est etiam malorum subsequentium, scilicet malorum"). **p.801:** L-col = Cap. III tail ("operum et malarum voluntatum. Unde Augustinus in Enchiridio… Prima igitur origo et causa peccati bonum fuit, et secunda malum, quod ortum est ex bono") + Cap. IV header + Cap. IV opener; R-col = Cap. IV tail ("…in quantum vitiosa est, mala est»") + Cap. V header + Cap. V text + Epilogus + Opponitur/Dubium opener ("…Augustinus in eodem libro determinat dicens: «Id quod dictum est in pro-"). **p.802:** L-col + R-col TOP bands = the dubium-determinatio tail only ("phetia, intelligendum est de ipsis rebus… et vitium hominis laudat, quod est iniquitas»."); everything below on p.802 (COMMENTARIUS IN DISTINCTIONEM XXXIV + DIVISIO TEXTUS) belongs to `d34-divisio`. Body seams across page/column breaks all grammatically continuous (450 dpi verified): 800 L→R (Cap. II "…non ex alio quam ex angelo, ex bono igitur ortum fuit. Unde Augustinus in re‖sponsionibus contra Iulianum"); 800 R→801 L (Cap. III "…causa est etiam malorum subsequentium, scilicet malorum ‖ operum et malarum voluntatum"); 801 L→R (Cap. IV "…nihil aliud dici videtur, cum vitiosa natura mala natura esse dicitur, nisi malum esse quod bo‖num est"); 801 R→802 L (Augustine determinatio "…determinat dicens: «Id quod dictum est in pro‖phetia, intelligendum est de ipsis rebus").

**Apparatus split map (10 entries → 7 sequential markers; footer numbering restarts per printed page).** **p.800** *NOTAE AD LIBR. SENTENTIARUM* footers 1–3 → [^1]–[^3]: [^1]=f1 (Codd. BCDE *malum*; *habuerit*/*habuit*; Hugo tr.3 c.14) at Cap. II *non erat aliquid mali*; [^2]=f2 (Libr. II de Nuptiis et concupisc. c.28 n.48) at *Unde Augustinus in responsionibus contra Iulianum*; [^3]=f3 (Edd. 1,3 *docetur*) at *Hic aperte dicitur*. **p.801** *NOTAE* footers 1–7 → [^4]–[^7] (footers 6 and 7 are merged into [^7] because both anchor on the same continuous Augustinus *in eodem libro* determinatio whose `malum`/Isaias/text-corruption notes all attach to the one quotation that spans p.801→p.802): [^4]=f1 (Cap.23 n.8; seq. c.24 n.8 — Enchirid.) at Cap. III *Unde Augustinus in Enchiridio*; [^5]=f2 (Cap. II n.3; Contra Adversar. Legis; *consumatur*/*natura*; *Cui vero*/*Cum vero* variants) at Cap. IV *ut ait Augustinus in Enchiridio*; [^6]=combines f3 (*connexione* variant) + f4 (Loc. cit.; seq. capitul. c.14 n.4) at *Hac contextione*; [^7]=combines f5 (Codd. ABDE omit *malum*; Maurini; seq. c.18 n.4) + f6 (Isai. 5,20; edd. 1,8 add *et malum bonum*) + f7 (Cap.19 n.6; *ultimus locus c.13 n.4*; Vat. corrupte legitur; *Quisquis ergo dicit…* original; Noster textus codd./edd. 8,9) at *Augustinus in eodem subdit* and again at *Augustinus in eodem libro determinat*. The p.802 dubium-determinatio tail carries no fresh footer — its `iniquitas¹` marker refers back to p.801 footer 7 (the determinatio quote spans the page), so it is folded into [^7]. Total raw footers = 3 (p.800) + 7 (p.801) = 10, rendered as 7 sequential markers.

**Hand-offs.** RECEIVED: nothing — DISTINCTIO XXXIV opens fresh on p.800; `d33-dubia` stopped at the p.800 DUB. IV Respondeo and its footer 6, forwarding nothing into this littera (the p.800 DUB. IV footers belong to `d33-dubia`). The p.800 *NOTAE AD LIBR. SENTENTIARUM* footer block (footers 1–3) belongs to THIS littera and is captured here. FORWARDED: nothing to `d34-divisio` — the littera closes at the top of p.802 before `COMMENTARIUS IN DISTINCTIONEM XXXIV.` (raw 55857); the COMMENTARIUS / DIVISIO TEXTUS (raw 55860) / TRACTATIO QUAESTIONUM (raw 55882) and their footers (*NOTAE AD COMMENTARIUM*, p.802) all belong to `d34-divisio`.

**[?] flags.** None. OCR garbles silently corrected against the 450 dpi PDF (e.g. indagine retained, tniae→quae, peccali→peccati, boiia→bona, niali→mali, volunlatem→voluntatem, miitabilis→mutabilis, immulabili→immutabili, conlrariis→contrariis, exterminatio retained, contextione retained — Vat. variant *connexione* noted in [^6], dicitur retained — edd. variant *docetur* noted in [^3]). The OCR running-head digit `801` is correct; printed p.800/802 confirmed against running-head text (`SENTENTIARUM LIB. II.`) and the +22 offset mapping.
