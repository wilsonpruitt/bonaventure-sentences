...
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR base with cascade-shattered Respondeo/footers reflowed from 450 dpi column-band PDF (raw lines 9602–9660, printed pp. 128–129), fresh literal English translation, full apparatus from raw OCR + PDF footers (9 entries, p.128 n.5–9 / p.129 n.1–4; incoming p.128 footer split received from committed a3-q2 — no backfill; outgoing dubia→DISTINCTIO IV split at p.129 — the NOTAE AD LIBR. SENTENTIARUM block → d4-littera), DUB I–III, no scholion. CLOSES DISTINCTIO 3 (17/17 Tier-2) (2026-05-16)"
format_version: 1
---
...
[^1]: Hic c. 4. circa medium, ubi ex Augustino haec afferuntur verba: Sed corpus aereum, quod tali voluntati aptavit Deus. — Paulo inferius cod. cc cum edd. 1, 2 *habuit* pro *habuerit*.

[^2]: Epist. I. Tim. 2, 4: Qui omnes homines vult salvos fieri.

[^3]: Ioan. 8, 44. — Alia translatio, subinde allegata, est Vulgatae, dum Septuaginta legunt *initium figmenti Dei*.

[^4]: Haec prop. formata est ex iis, quae August., XI. de Civ. Dei, c. 18. dicit. — Vat. *Nunc autem quamvis... tamen eum fecit* etc.

[^5]: Matth. 1, 22. et 21, 4.

[^6]: Primo modo explicat August. hoc verbum Iob, XI. de Civ. Dei, c. 15; secundum modum indicat ibid. c. 17. seq. et XI. de Gen. ad lit. c. 22. n. 29, quem locum Magist. hic c. 4. allegat. — Cfr. de hoc dubio Alex. Hal., S. p. II. q. 98. m. 1. a. 3. ad 1; B. Albert., S. p. II. tr. 4. q. 18. m. 2. a. 1. ad 5.

[^7]: Alex. Hal., S. p. I. q. 1. m. 1: Notandum praeterea, quod est scientia perficiens cognitionem secundum veritatem; est etiam scientia movens affectionem ad bonitatem. Prima est ut cognitio secundum visum, et ideo debet dici scientia absolute; secunda ut cognitio secundum gustum, et ideo debet dici sapientia a sapore affectionis. Cfr. tom. I. pag. 13, nota 5.

[^8]: Cfr. Iac. 3, 15.

[^9]: Dist. 4. a. 2. q. 2. — Paulo inferius Vat. *et taliter* pro *qualiter*. — De hoc et seq. dubio cfr. Petr. a Tar., hic dub. litt.

## Notes

**Source range:** raw `bonaventure_vol2_raw.txt` lines 9602–9660; printed pp. 128–129 (PDF = printed + 22). Full 450 dpi column-band PDF re-set (`extract-pages.py --volume vol2 --pages 128-129 --dpi 450` + `colcrop.py`). DUB intros clean prose from the IA djvu OCR base; the three Respondeo blocks and the footers reflowed from the column-band crops (cascade-shattered in OCR, per the Vol II Override). **This chunk closes DISTINCTIO 3 (17/17 Tier-2).**

**Apparatus crosswalk (continuous renumber 1–9):**
- **p.128 — incoming footer SPLIT (received from committed `d3-p2-a3-q2`):** p.128 has 9 footer notes; notes 1–4 are a3-q2's `[^10]`–`[^13]` (conclusio anchors — already committed, **no backfill**, a3-q2 correctly took only n.1–4). This chunk takes **n.5 → `[^1]`** (the `Hic c. 4. circa medium…` note — L→R column-footer runover, opener on L-col, `…afferuntur verba: Sed corpus aereum…` recovered from R-col; anchors DUB I *ut infra exponit*), **n.6 → `[^2]`** (Epist. I. Tim. 2,4 → DUB I *Deus vult omnes salvos fieri*), **n.7 → `[^3]`** (Ioan. 8,44 → DUB I Respondeo *in veritate non stetit*), **n.8 → `[^4]`** (de Civ. Dei XI c.18 → DUB I *quibus bonis usibus accommodaret*), **n.9 → `[^5]`** (Matth. 1,22 et 21,4 → DUB I *frequenter accipitur in Evangelio*).
- **p.129 — 4 footer notes for the dubia** (L-col n.1–2, R-col n.3–4; note 2 has an L→R runover, `…scientia absolute; secunda ut cognitio secundum gustum…` recovered from R-col) → `[^6]`–`[^9]`. Anchors: DUB I Respondeo end *consequitur eius ludificatio* (n.1); DUB II *sed a sapere* (n.2); DUB II *cognitio desursum descendens* (n.3); DUB II Respondeo *sicut infra patebit* (n.4). DUB III carries no apparatus markers.

**Outgoing boundary dubia→DISTINCTIO IV = cross-distinction SPLIT at p.129 (documented for the d.4 work):** the dubia's body (DUB III Respondeo) ends on p.129 R-col with `…ratione modi cognoscendi.` (raw 9660); DISTINCTIO IV (CAP. I littera *An perfecti et beati creati sint…*) begins immediately after on the same page (raw 9661+). p.129's footer therefore splits: notes 1–4 (renumbered `[^6]`–`[^9]`) are the dubia's; the separately-headed **`NOTAE AD LIBR. SENTENTIARUM`** block (its own notes 1–2: `Cfr. Prov. 14, 34…` / `Lib. XI. c. 17. n. 22…`) is DISTINCTIO IV's d4-littera apparatus — to be picked up by the future `d4-littera` build, which starts its p.129 apparatus at that NOTAE block. No backfill into d.3.

**No scholion** (dubia blocks carry none). DUB I = the Job *initium figmenti Dei* verse; DUB II = *Sapientia est fructus pietatis*; DUB III = *Triplex erat naturalis cognitio* (formaliter/materialiter).

**Marginal glosses trimmed** (not rendered): *Duplex sapientia*.

**Low-confidence items parked for the d.10 600 dpi polish-blocker:** none new — the p.128/129 footers read cleanly at 450 dpi (the two L→R runovers on `[^1]` and `[^7]` were recovered from the full-width IA OCR, faithful).
