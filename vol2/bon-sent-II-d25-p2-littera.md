---
id: "bon-sent-II-d25-p2-littera"
volume: 2
book: 2
distinctio: 25
pars: 2
type: littera
title_la: "Distinctio XXV, Pars II — Littera Magistri"
title_en: "Distinction XXV, Part II — The Text of the Master"
printed_pages: [589, 590, 591]
pdf_pages: [611, 612, 613]
source: "S. Bonaventurae, Opera Omnia, Tomus II (Quaracchi, 1885), pp. 589–591"
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from 450 dpi PDF column bands (Cap. V opens \"Pars II\" lower-left on p.589 below the d.25-p1-littera Cap. IV tail; Cap. V–VI run p.589 L-column, Cap. VII–VIII p.589 R-column, Cap. VIII continues across p.590 both columns, Cap. IX on p.591 L-column ending at the COMMENTARIUS which opens Pars I commentary), fresh literal English translation, full apparatus renumbered continuously [^1]–[^16] from the p.589 NOTAE footers (2–5), the p.590 footer sequence (1–11), and the p.591 Cap. IX footer (Rom. 7,18 etc.); five Lombard capitula (V–IX) on the theme *de libero arbitrio* (2026-05-29)"
format_version: 1
---

# bon-sent-II-d25-p2-littera

## *Distinctio XXV, Pars II — Littera Magistri.*
...
[^2]: **La.** Luc. 10, 30; cfr. Ambr. et Beda in hunc locum.
    **En.** Luke 10:30; compare Ambrose and Bede on this passage.

[^3]: **La.** Enchirid. c. 30. n. 9. — Locus Scripturae est II. Petr. 2, 19.
    **En.** *Enchiridion*, chapter 30, n. 9. — The scriptural passage is 2 Pet. 2:19.

[^4]: **La.** Bernard., de Gratia et lib. arbitrio c. 3. n. 7. — Superius edd. 1, 2, 3, 8 post *libertas* addunt *arbitrii*.
    **En.** Bernard, *On Grace and Free Choice*, chapter 3, n. 7. — Above, editions 1, 2, 3, 8 add *arbitrii* (of choice) after *libertas*.

[^5]: **La.** In Vat. desunt verba *ubi non est libertas*.
    **En.** In the Vatican edition the words *ubi non est libertas* (where there is no freedom) are lacking.

[^6]: **La.** Epist. II. Cor. 3, 17. Seq. locus Scripturae est Ioan. 8, 36; tertius et quartus Rom. 6, 18 et 20.
    **En.** Epistle, 2 Cor. 3:17. The following scriptural passage is John 8:36; the third and fourth, Rom. 6:18 and 20.

[^7]: **La.** Enchirid. c. 30. n. 9. Vide supra c. 7.
    **En.** *Enchiridion*, chapter 30, n. 9. See above, chapter 7.

[^8]: **La.** Cap. 30. n. 9.
    **En.** Chapter 30, n. 9.

[^9]: **La.** Ibid., in quo textu edd. 1-9 post *peccato* addunt *scilicet*; codd., excepto A, omittunt etiam *peccato*.
    **En.** Ibid., in which text editions 1–9 add *scilicet* (namely) after *peccato*; the codices, except A, also omit *peccato*.

[^10]: **La.** Edd. 1, 8 addunt *arbitrii*.
    **En.** Editions 1, 8 add *arbitrii* (of choice).

[^11]: **La.** Ibid. — Textus Scripturae est Ioan. 8, 36. — In verbis Augustini Vat. cum edd. 8, 9 post *faciendum* ponit *nunquam* pro *unde* et cum pluribus edd. post *vendito* addit *sub peccato* et omittit *ille* ante *qui*.
    **En.** Ibid. — The scriptural passage is John 8:36. — In Augustine's words the Vatican edition, with editions 8, 9, places *nunquam* (never) after *faciendum* instead of *unde*, and with several editions adds *sub peccato* (under sin) after *vendito* and omits *ille* before *qui*.

[^12]: **La.** Vat. cum ceteris edd., exceptis 1, 6, *reparatus est*, refragantibus codd.
    **En.** The Vatican edition, with the other editions except 1 and 6, [reads] *reparatus est*, the codices being opposed.

[^13]: **La.** Cap. 13. n. 31.
    **En.** Chapter 13, n. 31.

[^14]: **La.** Rom. 8, 21. — Paulo inferius pro *quia omni* edd. 1, 8 *qui omni*.
    **En.** Rom. 8:21. — A little below, for *quia omni* editions 1, 8 [read] *qui omni*.

[^15]: **La.** Rom. 7, 17.
    **En.** Rom. 7:17.

[^16]: **La.** Rom. 7, 18. Seqq. duo textus sunt Rom. 9, 16, et Phil. 2, 13.
    **En.** Rom. 7:18. The following two texts are Rom. 9:16 and Phil. 2:13.

## Notes

**Provenance.** Latin re-set column-by-column from the 450 dpi PDF column bands (`/tmp/colcrop/vol2-p589-{L,R}-{0,1,2}.png`, `/tmp/colcrop/vol2-p590-{L,R}-{0,1,2}.png`, `/tmp/colcrop/vol2-p591-{L,R}-{0,1,2}.png`, plus full-resolution sub-crops of p.589/p.591 columns under `/Users/wilsonpruitt/.cache/claude-tmp/`); cross-checked against the IA djvu OCR (raw lines ~41210–41383, two-column cascade-shattered). The chunk is the **Littera Magistri** for Distinctio XXV, Pars II, Capitula V–IX (Lombard's text), theme *de libero arbitrio*.

**Chapter count = FIVE (Cap. V–IX).** Headings: V *De differentia libertatis arbitrii secundum diversa tempora*; VI *De quatuor statibus liberi arbitrii*; VII *De corruptione liberi arbitrii per peccatum*; VIII *De tribus modis libertatis liberi arbitrii: a necessitate, a peccato, a miseria*; IX *De libertate, quae est ex gratia, et quae ex natura*. Cap. V opens **Pars II** ("Pars II" header lower-left on p.589 below the d.25-p1 Cap. IV tail).

**Boundaries.** Cap. V opens lower-left on p.589, below the d.25-p1-littera Cap. IV tail (which ends "…quod ex ratione decreverit"); the "Pars II" header marks the start. Cap. V–VI run the p.589 L-column; Cap. VII–VIII run the p.589 R-column; Cap. VIII continues across both columns of p.590; Cap. IX runs the p.591 L-column and its tail wraps to the p.591 R-column top, ending "…ut perficiat." immediately before the **COMMENTARIUS IN DISTINCTIONEM XXV** (Pars I commentary, raw ~41383) which belongs to `d25-p1-divisio`.

**Page-split map (printed pages; Quaracchi restarts footers per page):**
- **p.589** — Cap. V, VI (L-column), Cap. VII, VIII opener (R-column). Body markers: "perfecte¹"→[^1] (Ita in codd. *plene*); "spoliatus²"→[^2] (Luc. 10,30); "Enchiridio³"→[^3] (Enchirid. c.30 n.9, II Petr. 2,19); "a miseria⁴"→[^4] (Bernard., de Gratia c.3 n.7). The p.589 footer 1 (Ioan. 8,34 + Hugone source-note tail) served Cap. IV and was claimed by `d25-p1-littera` ([^7]); its Hugone tail ("Quod sequitur est ex Hugone…") is a provenance note for the following capitula, recorded here but carrying no body marker.
- **p.590** — Cap. VIII (both columns). Footers 1–11 → [^5]–[^15]. Body markers: "ubi non est libertas¹"→[^5]; "Apostolus²: Ubi Spiritus Domini"→[^6]; "Augustinus³ dicit"→[^7]; "Enchiridio⁴: Ad iustitiam"→[^8]; "Enchiridio⁵: Servi addicti"→[^9]; "libertas⁶ ad malum"→[^10]; "Enchiridio⁷: Ista libertas"→[^11]; "reparatur⁸"→[^12]; "de Gratia et libero arbitrio⁹"→[^13]; "Apostolus¹⁰: Et ipsa creatura"→[^14]; "Apostolus¹¹: peccatum habitat in carne"→[^15].
- **p.591** — Cap. IX (L-column + R-column top). Footer 1 → [^16] (Rom. 7,18; Rom. 9,16; Phil. 2,13) at "Apostolus¹⁶". Below the Cap. IX tail the **COMMENTARIUS IN DISTINCTIONEM XXV** (Pars I) begins; that and its "NOTAE AD COMMENTARIUM" footer belong to `d25-p1-divisio`.

**Hand-offs.** RECEIVED from `d25-p1-littera`: confirmation that the p.589 footer 1 (Ioan. 8,34) was fully owned upstream (Cap. IV, [^7]); this chunk's apparatus therefore begins with the NOTAE footers 2–5 (renumbered [^1]–[^4]); the Hugone source-note tail of footer 1 was forwarded as provenance for Cap. V–VIII and is recorded in this Notes block. FORWARDED to `d25-p1-divisio`: the p.591 COMMENTARIUS IN DISTINCTIONEM XXV (Pars I commentary, raw ~41383) and its NOTAE AD COMMENTARIUM footer.

**[?] flags:** none. Body is clean Lombard running prose. Quaracchi side-glosses bleeding into the OCR / margins ("Dubium 1/2/3", "Libertas a necessitate", "Libertas a peccato", "Haec sit per gratiam", "Falsa libertas", "Quaestio de falsa libertate", "Opinio 1/2", "Libertas a miseria", "Corollarium") were trimmed as marginalia, not Lombard's text.
