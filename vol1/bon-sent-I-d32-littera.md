...
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR pt2 (raw lines 13570–13859), Lombard's d.32 littera (single-pars; Capp. I–VI spanning printed pp. 553–556), fresh literal English translation, full apparatus from raw OCR Notae block + inline Magistri-text footers (12 entries), [?] flags on ambiguous spots (2026-05-06)"
format_version: 1
---
...
[^11]: **La.** Hilarius, *de Trin.* IX, in principio: «Naturae, qui contradicis, haereticae, haec unitas est ... non a se agendo nisi adeo ipse agit, ut quia [?]». — Lectio Magistri magis placet. Cod. (n.n.) addit *ipse*, et paulo ante et post *ita*.

    **En.** Hilary, *On the Trinity* IX, at the beginning: "There belongs to the nature, you who contradict, heretical [one], this unity ... not by acting from Himself unless to such a degree He Himself acts, that because [?]." — The Master's reading is preferable. A codex (n.n.) adds *ipse*, both a little before and after *ita*.
