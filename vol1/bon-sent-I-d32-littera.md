---
id: "bon-sent-I-d32-littera"
volume: 1
book: 1
distinctio: 32
type: littera
title_la: "Hic oritur quaestio ex praedictis deducta"
title_en: "Here a question arises drawn from what has been said"
printed_pages: [553, 554, 555, 556]
pdf_pages: [143, 144, 145, 146]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 553–556 (Petri Lombardi Sententiarum Lib. I, Dist. XXXII, single-pars). OCR source: raw/bonaventure_vol1_pt2_raw.txt (volume I, part 2)."
line_start: 13570
line_end: 13859
word_count_latin: 1820
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR pt2 (raw lines 13570–13859), Lombard's d.32 littera (single-pars; Capp. I–VI spanning printed pp. 553–556), fresh literal English translation, full editorial-NOTAE apparatus from raw OCR (15 entries, per-page distribution 2/8/4/1 across pp. 553/554/555/556), [?] flags on ambiguous spots (2026-05-06) [Wave 9b Tier B disposition 2026-05-09: hardened-audit raw=36 vs chunk=15 (diff +21) is OVERCOUNT-only per Lesson 9 reinforcement / Lesson 10 — same two-stream-apparatus pattern as d8-littera and d37-littera. Quaracchi prints two parallel footer bands on Lombard littera pages: (a) left-column text-critical band on Magistri's body text (variant readings on `Spirilu sancto`, `substantiam`, `concordibus`, `incongrue`, etc., plus the Hilary-quotation truncation note on p. 555), and (b) right-column 'NOTAE AD LIBR. SENTENTIARUM' editorial-content stream. The chunk consolidates only stream (b), matching the d8-littera / d37-littera convention. Inflation sources: ~5 left-col text-critical entries (p. 553) + ~5 (p. 555 incl. truncated Hilary + 'Lectio Magistri magis placet' codex variants) + 6 chapter-rubric line-starts (Cap. I–VI) + body italicized headings (Notula, Epilogus, Responsio, Improbatur, Difficilis quaestio, Quaestionem relinquit) catching the hardened regex `[\W_]\s+[A-Z]` and `\d{1,2}\s+[A-Z]`. Body and translation eyes-on confirmed: all 6 chapters present, body matches raw OCR pp. 553–556 with no paraphrase clusters, all 15 apparatus anchors have matching defs. Disposition metadata-only; no apparatus or body content edits.]"
format_version: 1
---

# bon-sent-I-d32-littera

## *Lombard's text on Distinction XXXII: whether the Father or the Son loves with the love that proceeds from both, that is, the Holy Spirit; and the difficult question of whether the Father is wise with the wisdom He begot.*
...
[^1]: **La.** *Dist.* XXXI. c. 6.
    ...
    **En.** Distinction XXXI, c. 6.

[^2]: **La.** Vat. aliaeque edd., refragantibus codd. et ed. 1, omittunt *vel Spiritu sancto*; deinde codd. C D et ed. 8 *diligant* pro *diligat*, et insuper cod. C addit *se*.

    **En.** The Vatican and other editions, contrary to the codices and ed. 1, omit *vel Spiritu sancto*; further, codices C D and ed. 8 [read] *diligant* in place of *diligat*, and codex C in addition adds *se*.
...
[^4]: **La.** *Dist.* X. c. 2.
    ...
    **En.** Distinction X, c. 2.

[^5]: **La.** Cap. 5. n. 7. — Paulo superius post *sed* cod. D bene adiicit *etiam*, deinde codd. B E *iungebit* pro *piget*.

    **En.** Chapter 5, n. 7. — A little above, after *sed*, codex D rightly adds *etiam*; further, codices B E [read] *iungebit* in place of *piget*.

[^6]: **La.** *Ephes.* 4, 3. Codd. A B D E addunt *in vinculo* ante *pacis*. Vulgata: *Solliciti servare unitatem spiritus in vinculo pacis*.

    **En.** *Ephesians* 4:3. Codices A B D E add *in vinculo* before *pacis*. Vulgate: *Solliciti servare unitatem spiritus in vinculo pacis* ("Careful to keep the unity of the spirit in the bond of peace").

[^7]: **La.** Cap. 7. n. 12.

    **En.** Chapter 7, n. 12.

[^8]: **La.** Cap. 1. n. 1. Ultima propositio est ibi ex n. 2. — Locus Scripturae est *I. Cor.* 1, 24.

    **En.** Chapter 1, n. 1. The last sentence is there from n. 2. — The Scripture passage is *1 Corinthians* 1:24.

[^9]: **La.** Quaest. 23. — Locus ex libro *Retractationum* est c. 26. In libris *de Trinitate* agitur de hac quaestione in VI. c. 1. n. seqq.; VII. c. 1–4; et XV. c. 7. n. 12.

    **En.** Question 23. — The passage from the *Retractations* is c. 26. In the books *On the Trinity* this question is treated in VI, c. 1, nn. following; VII, cc. 1–4; and XV, c. 7, n. 12.

[^10]: **La.** Cap. 7. n. 12.

    **En.** Chapter 7, n. 12.

[^11]: **La.** Hilarius, *de Trin.* IX, in principio: «Naturae, qui contradicis, haereticae, haec unitas est ... non a se agendo nisi adeo ipse agit, ut quia ...» [Quaracchi quotation truncated mid-clause; remainder not transcribed in this chunk.] — Lectio Magistri magis placet. Cod. (n.n.) addit *ipse*, et paulo ante et post *ita*.

    **En.** Hilary, *On the Trinity* IX, at the beginning: "There belongs to the nature, you who contradict, heretical [one], this unity ... not by acting from Himself unless to such a degree He Himself acts, that because ..." [Quaracchi quotation truncated mid-clause; remainder not transcribed.] — The Master's reading is preferable. A codex (n.n.) adds *ipse*, both a little before and after *ita*.

[^12]: **La.** Vat. perperam *responsio*; cod. D [paulo post]. Paulo post Vat. cum pluribus edd. addit *sapientia ea dicitur*.

    **En.** The Vatican wrongly [reads] *responsio*; codex D [a little after]. A little later the Vatican with several editions adds *sapientia ea dicitur*.

[^13]: **La.** Vat. et edd. 1, 8, 9 *ipsa*.

    **En.** The Vatican and editions 1, 8, 9 [read] *ipsa*.

[^14]: **La.** Ita codd.; Vat. cum pluribus edd. *ea*.

    **En.** Thus the codices; the Vatican with several editions [reads] *ea*.
