---
id: "bon-sent-I-d39-littera"
volume: 1
book: 1
distinctio: 39
type: littera
title_la: "De divina scientia rerum — littera Magistri"
title_en: "On the divine knowledge of things — text of the Master"
printed_pages: [682, 683]
pdf_pages: [272, 273]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 682–683 (Petri Lombardi Sententiarum Lib. I, Dist. XXXIX, single-pars, Capp. I–IV). OCR source: raw/bonaventure_vol1_pt2_raw.txt (volume I, part 2), lines 26377–26535. Frontmatter corrected: scaffolding had printed_pages [660, 661] (those page numbers belong to d.36 territory, not d.39); eyes-on running heads in OCR show line 26365 carries the SENTENTIARUM LIB. I running head closing the d.38 commentary p. 681, line 26377 opens DISTINCTIO XXXIX as a fresh page (= p. 682), line 26470 carries the DISTINCTIO XXXIX running head (= p. 683), and line 26531 carries the SENTENTIARUM LIB. I running head closing p. 683, with line 26536 beginning the Bonaventure COMMENTARIUS IN DISTINCTIONEM XXXIX, so the Lombard d.39 littera proper occupies pp. 682–683."
line_start: 26377
line_end: 26535
has_scholion: false
has_apparatus: true
...
# bon-sent-I-d39-littera

## *Lombard's text on Distinction XXXIX: whether God's knowledge can be increased or diminished or in any way changed; whether God can come to know anything anew or in time; whether God can know more than He knows; that God knows all things always and at once.*
...
[^3]: **La.** Cod. R addit *vel mutari*.
     ...
     **En.** Codex R adds *vel mutari* ("or changed").

[^4]: **La.** Ad c. 1, 14.

     **En.** [Jerome, *Commentary on Habakkuk*,] on c. 1, [v.] 14.

[^5]: **La.** I. Cor. 9, 9; alius locus est Sap. 12, 13.

     **En.** 1 Corinthians 9:9; the other passage is Wisdom 12:13.

[^6]: **La.** Intellige: respectu quorum dedit septem praecepta posteriora decalogi. Haec est lectio codd. et ed. 1; aliae edd. omittunt *de*, quia tunc sensus verborum idem est cum eo, quem exprimunt verba, quae sequuntur: *eisque recte vivendi legem praescripsit*.

     **En.** Understand: with respect to whom He gave the [last] seven precepts of the decalogue. This is the reading of the codices and edition 1; the other editions omit *de*, because then the sense of the words is the same as that which is expressed by the words which follow: *eisque recte vivendi legem praescripsit* ("and prescribed for them a law of right living").

[^7]: **La.** Respicitur Matth. 5, 45: *Qui solem suum oriri facit super bonos et malos et pluit super iustos et iniustos*.

     **En.** [The text] looks back to Matthew 5:45: *He who makes His sun rise upon the good and the wicked and rains upon the just and the unjust*.

[^8]: **La.** Solummodo Vat. et edd. 4, 5, 6, 8, 9 *semel*.

     **En.** Only the Vatican edition and editions 4, 5, 6, 8, 9 [read] *semel* ("once") [in place of *semper*].
