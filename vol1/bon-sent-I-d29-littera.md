---
id: "bon-sent-I-d29-littera"
volume: 1
book: 1
distinctio: 29
type: littera
title_la: "Distinctio XXIX littera Magistri (capp. I — IV) — De principio"
title_en: "Lombard's text on Distinction XXIX (chapters I — IV) — On the [name] principle"
printed_pages: [506, 507]
pdf_pages: [96, 97]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 506–507 (Petri Lombardi Sententiarum Lib. I, Dist. XXIX, capp. I — IV). OCR source: raw/bonaventure_vol1_pt2_raw.txt (volume I, part 2)."
has_scholion: false
has_apparatus: true
line_start: 8849
line_end: 8996
word_count_latin: 1203
transcription_status: "Phase C Tier 2 complete — Latin verbatim from IA djvu OCR (raw lines 8849–8996, multi-cap Lombard text), literal English, apparatus from page-bottom footnote bands (2026-05-06)"
format_version: 1
---

# bon-sent-I-d29-littera

## *Lombard's text on Distinction XXIX (chapters I — IV): on the divine name "principle" (principium); that the Father from eternity is the principle of the Son, but the Holy Spirit is not [eternally principle, since He is principle only in relation to creatures]; how the Father is principle of the Son, and He with the Son [is principle] of the Holy Spirit; whether the Father and the Son are principle of the Holy Spirit by the same notion (Lib. I, Dist. XXIX, capp. I — IV).*
...
[^1]: **La.** Cap. 20. n. 29. Verba: *ipse est a nullo* etc. sunt ex n. 28.
    ...
    **En.** Chapter 20, n. 29. The words *ipse est a nullo* ("He is from no one") etc. are from n. 28.

[^2]: **La.** Vat. cum aliis edd. *personarum* contra codd. ABDE et ed. 1.

    **En.** The Vatican with the other editions [reads] *personarum*, against codices ABDE and edition 1.

[^3]: **La.** August., l. contra Maxim. c. 17. n. 4.

    **En.** Augustine, book *Against Maximinus*, c. 17, n. 4.

[^4]: **La.** *Rom.* 11, 36.

    **En.** *Rom.* 11:36.

[^5]: **La.** Cap. 28. Etiam ea quae praecedunt, secundum sensum dicta sunt ab August., V. *de Trin.* c. 13. n. 14.

    **En.** Chapter 28. Also the things which precede are said, according to sense, by Augustine, book V *On the Trinity*, c. 13, n. 14.

[^6]: **La.** Vat. aliaeque edd., excepta 1, *naturalia*, sed contra codd. 1, 2, 3 et originale.

    **En.** The Vatican and the other editions, except edition 1, [read] *naturalia*, but against codices 1, 2, 3 and the original.

[^7]: **La.** Cap. 13. n. 14. Vide etiam *Enarrat. in Psalm.* 109. n. 13.

    **En.** Chapter 13, n. 14. See also *Expositions on the Psalms*, Ps. 109, n. 13.

[^8]: **La.** *Ioan.* 8, 25.

    **En.** *John* 8:25.

[^9]: **La.** Cod. D adiungit *esse principium et*. Paulo inferius ed. 9 cum originali post *creatoris* habet *et* pro *quia*.

    **En.** Codex D adds *esse principium et*. A little further on, edition 9 with the original, after *creatoris*, has *et* in place of *quia*.

[^10]: **La.** *1. Cor.* 12, 11: *Haec autem omnia operatur unus atque idem Spiritus.*

    **En.** *1 Cor.* 12:11: *But all these things one and the same Spirit works.*

[^11]: **La.** Codd. A D, ed. 1 et 5 (in margine) *simul*.

    **En.** Codices A, D, edition 1 and edition 5 (in the margin) [read] *simul*.

[^12]: **La.** Libr. V. *de Trin.* c. 14. n. 13. In principio textus codd. 1, 2, 3 cum originali *ad id quod gignit* pro *ad id quod gignitur*. — Locus s. Scripturae est *Ioan.* 15, 26.

    **En.** Book V *On the Trinity*, c. 14, n. 13. At the beginning of the text codices 1, 2, 3 with the original [read] *ad id quod gignit* in place of *ad id quod gignitur*. — The passage of Holy Scripture is *John* 15:26.

[^13]: **La.** Ita hic et paulo inferius omnes codd. cum originali; sed omnes edd. bis habent *eius* pro *ei*. Deinde post *Patrem et Filium* omnes edd., excepta 1, addunt *unum*, sed contra originale et codd. Denique plures codd. et edd. 2, 3, 4 cum originali omittunt *sunt* ante *sicut unus creator*.

    **En.** So here and a little further on read all the codices with the original; but all editions read twice *eius* in place of *ei*. Then, after *Patrem et Filium*, all editions except 1 add *unum*, but against the original and the codices. Finally, several codices and editions 2, 3, 4 with the original omit *sunt* before *sicut unus creator*.

[^14]: **La.** *N.* 9. Alius locus est ibid. n. 6.

    **En.** *N.* 9. The other passage is in the same place, n. 6.

[^15]: **La.** Receptum est nomen *spiratio*, consecratum a Concilio Lugdunensi II. (an. 1274): «Spiritus sanctus... non duabus spirationibus, sed unica spiratione procedit».

    **En.** The name *spiration* has been received, consecrated by the Second Council of Lyon (A.D. 1274): "The Holy Spirit... proceeds not by two spirations, but by a single spiration."

[^16]: **La.** Vat. sola omittit *quae*; paulo inferius eadem cum cod. C et aliis edd., excepta 1, *est* pro *sunt*.

    **En.** The Vatican alone omits *quae*; a little further on the same [Vatican], with codex C and the other editions, except edition 1, [reads] *est* in place of *sunt*.

[^17]: **La.** Dist. XIV, XV, XVIII.

    **En.** Distinctions XIV, XV, XVIII.
