...
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR (raw lines 32054-32575), fresh literal English translation, full apparatus from raw OCR (35 entries from p.152-154 footer blocks), scholion translated (2026-05-10 d.1-d.10 rechunk pipeline from-scratch) — 2026-05-12 [?]-flag polish pass wave 1: 3 resolved via 600dpi PDF, 8 wrongly accepted-illegible — 2026-05-12 retry: all flags RESOLVED via 600dpi PDF p.156 (printed); wave-1 had searched p.155 bottom-right (scholion I tail), but scholion II actually opens on p.156 top-left and is fully legible; full scholion II body re-transcribed from p.156 and English mirror rewritten literal"
format_version: 1
---
