...
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR (raw lines 32054-32575), fresh literal English translation, full apparatus from raw OCR (35 entries from p.152-154 footer blocks), scholion translated, [?] flags on ambiguous spots (2026-05-10 d.1-d.10 rechunk pipeline from-scratch)"
format_version: 1
---
...
3. Likewise, every such thing, with which understood not to be, something can be understood, can be thought not to be. But Boethius in the book *de Hebdomadibus*[^10] says that with [?the highest good] understood to be impossible, the highest good not to be, something round and white can still be understood: therefore similarly in the highest true, and thus it will be able to be thought not to be.
