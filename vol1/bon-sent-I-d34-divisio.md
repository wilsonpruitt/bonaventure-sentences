---
id: "bon-sent-I-d34-divisio"
volume: 1
book: 1
distinctio: 34
type: divisio
title_la: "Commentarius in Distinctionem XXXIV. Divisio textus."
title_en: "Commentary on Distinction XXXIV. Division of the text."
printed_pages: [585]
pdf_pages: [175]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), p. 585"
has_scholion: false
has_apparatus: true
line_start: 16889
line_end: 16969
word_count_latin: 360
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR pt2 (raw lines 16889–16969), COMMENTARIUS heading + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM, fresh literal English translation, full apparatus from raw OCR (4 entries), [?] flags on ambiguous spots (2026-05-07)"
format_version: 1
---

# bon-sent-I-d34-divisio

## *Commentarius in Distinctionem XXXIV.* — *Divisio textus.*
...
*Praeterea sciendum est, quod in assignatione distinctionis* etc. Haec est tertia particula, in qua agit Magister de nominum translatione, quae posset[^3] dividi contra totum tractatum praecedentem de divinis nominibus. Sed quia Magister parum aut nihil determinat de his nominibus, ideo potius incidenter cum epilogatione est positum[^4]. Unde haec particula duas habet partes. In prima quandam generalem de nominibus translativis tradit instructionem. In secunda vero ponit praedictorum epilogationem, in qua tractatum de sacramento Trinitatis et Unitatis finit, ostendens, se in hoc tractatu potius defecisse quam suffecisse propter materiae altitudinem, et hoc facit ibi: *De sacramento Unitatis atque Trinitatis* etc.
...
*"Moreover it must be known, that in the assignment of the distinction"* etc. This is the third little part, in which the Master treats of the translation [i.e. the transferred use] of names, which could[^3] be divided over against the whole preceding treatise on the divine names. But because the Master determines little or nothing about these names, it is therefore set down rather incidentally together with the epilogue[^4]. Hence this little part has two divisions. In the first he hands down a certain general instruction concerning translative names. In the second, however, he sets down the epilogue of what has been said, in which he ends the treatise on the mystery of the Trinity and of the Unity, showing that in this treatise he has rather fallen short than sufficed because of the loftiness of the matter, and this he does there: *"On the mystery of the Unity and Trinity"* etc.
...
[^1]: **La.** Codd. I bb et alii cum ed. 1 *particulas*. Mox pro *sua confirmatione*, quod ex codd. I T X et ed. 1 restituimus, Vat. *summa confirmatione*.

    **En.** Codices I, bb and others with edition 1 [read] *particulas* ("little parts"). Soon after, for *sua confirmatione* ("its confirmation"), which we have restored from codices I, T, X and edition 1, the Vatican edition [reads] *summa confirmatione* ("with the highest confirmation").

[^2]: **La.** Pro *ipsius auctoritatis* cod. T *huius auctoritatis*.
...
[^4]: **La.** Vat. *posita*.
    ...
    **En.** The Vatican edition [reads] *posita* ("placed", feminine, agreeing with *particula*) [in place of *positum*].
