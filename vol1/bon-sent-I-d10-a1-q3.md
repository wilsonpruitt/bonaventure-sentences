...
has_scholion: true
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin body re-set verbatim from IA djvu OCR (raw lines 38990–39160), full apparatus from raw OCR (8 entries), scholia I–II, full English body and scholia (2026-05-02)"
format_version: 1
---
...
1. Ioannis decimo septimo[^1]: «Ut sint unum, sicut et nos»: Dominus orat et petit discipulis unitatem, non naturae, sed dilectionis per conformitatem ad illam summam unitatem; sed membra Christi uniuntur per amorem mutuum: ergo in divinis est exemplar huius: sic etc.[^2]

2. Item, Hieronymus super Psalmum decimum septimum[^3]: «Spiritus sanctus est amor, quem habet Pater in Filium, et Filius in Patrem»: ergo est amor mutuus.
...
[^5]: **La.** Ex antiquioribus mss. et ed. 1 supplevimus *Richardus*.
    ...
    **En.** From the older manuscripts and ed. 1 we have supplied *Richardus*.
