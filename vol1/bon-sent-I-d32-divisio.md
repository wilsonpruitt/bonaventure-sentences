---
id: "bon-sent-I-d32-divisio"
volume: 1
book: 1
distinctio: 32
type: divisio
title_la: "Commentarius in Distinctionem XXXII — Solvuntur dubitationes circa duas locutiones ad appropriationem spectantes. Divisio textus."
title_en: "Commentary on Distinction XXXII — Doubts are resolved concerning two locutions pertaining to appropriation. Division of the text."
printed_pages: [554, 555, 556]
pdf_pages: [144, 145, 146]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 554–556"
has_scholion: false
has_apparatus: true
line_start: 13860
line_end: 13946
word_count_latin: 410
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR pt2 (raw lines 13860–13946), COMMENTARIUS heading + DIVISIO TEXTUS + TRACTATIO QUAESTIONUM, fresh literal English translation, full apparatus from raw OCR (6 entries; includes NOTAE AD COMMENTARIUM block), [?] flags on ambiguous spots (2026-05-06)"
format_version: 1
---

# bon-sent-I-d32-divisio

## *Commentarius in Distinctionem XXXII.* — *Divisio textus.*
...
Supra posuit Magister appropriata, in quorum explanatione dixit, Spiritum sanctum esse concordiam, quia Pater et Filius diligunt se Spiritu sancto; ideo hic movet quaestionem de illa locutione. Et hoc facit in ista distinctione. Habet autem haec distinctio tres[^1] partes.

In prima movet Magister principalem quaestionem prius positam, scilicet[^2] utrum Pater et Filius diligant se Spiritu sancto. In secunda vero movet aliam quaestionem huic consimilem, quae facit ad eius explanationem, et hoc facit ibi: *Praeterea diligenter investigari oportet*, et est illa quaestio: utrum Pater sit sapiens sapientia genita. In tertia redit ad principalem quaestionem determinandam, et hoc facit ibi: *Praeterea diligenter notandum est*.
...
*Praeterea diligenter investigari oportet*. Haec est secunda particula, in qua determinat Magister quaestionem annexam, scilicet utrum Pater sit sapiens[^3] sapientia genita. Et quia ad determinationem
...
*"Furthermore, it must be diligently investigated."* This is the second little section, in which the Master determines the annexed question, namely whether the Father is wise[^3] by a begotten wisdom. And because for the determination
...
[^1]: **La.** Mss. cum ed. I *quattuor*; perperam.

    **En.** The manuscripts together with edition I read *quattuor* ("four"); wrongly.
...
[^5]: **La.** Codd. B E *cognita*. Vat. cum pluribus edd. addit *ipsa* ante *praemissa*, et deinde *hanc* ante *quaestionem*.
    ...
    **En.** Codices B and E read *cognita* ("known"). The Vatican edition with several [other] editions adds *ipsa* ("itself") before *praemissa* ("the things mentioned"), and then *hanc* ("this") before *quaestionem* ("question").

[^6]: **La.** Vat. *Difficillimam mihi*; codd. BE cum ed. I *Difficile est mihi fateor hanc quaestionem solvere*; cod. C *Difficile esse mihi* etc.; cod. D cum edd. 3, 4, 5, 6, 7, 8, 9 *Difficilem mihi hanc fateor quaestionem*.

    **En.** The Vatican edition reads *Difficillimam mihi* ("Most difficult for me"); codices B and E with edition I read *Difficile est mihi fateor hanc quaestionem solvere* ("It is difficult, I confess, for me to solve this question"); codex C reads *Difficile esse mihi* ("That it is difficult for me") etc.; codex D with editions 3, 4, 5, 6, 7, 8, 9 reads *Difficilem mihi hanc fateor quaestionem* ("I confess this question to be difficult for me").

---

## Notes

[No editorial notes beyond the apparatus above. The "NOTAE AD COMMENTARIUM" block at the foot of p. 555 has been folded into the apparatus entries [^1]–[^3] above; later entries of that block are heavily OCR-garbled and only their legible substance has been retained — see `manual-review/tier2-ambiguities-d32-divisio.md`.]
