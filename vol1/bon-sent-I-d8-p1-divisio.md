...
Terminatis superius duabus partibus istius partis principalis, quae est de Trinitate secundum quod intelligitur, in quibus ad probandam Trinitatem Magister adduxit rationes et removit dubitationes, in hac tertia parte determinat Magister[^1] ipsius Trinitatis et Unitatis proprietates et conditiones. Et quoniam quaedam sunt proprietates respicientes essentiam, ut veritas, quaedam personas, ut generatio, quaedam utrasque, ut aequalitas: ideo haec pars tres habet partes. In *prima* parte agit Magister de proprietatibus essentialibus; in *secunda*, de proprietatibus personalibus, infra distinctione nona: *Nunc ad distinctionem personarum* etc.; in *tertia*, de proprietatibus et conditionibus quodam modo essentialibus et quodam modo personalibus, sicut est aequalitas personarum in aeternitate, magnitudine et virtute[^2], infra distinctione decima nona: *Nunc postquam coaeternitatem trium personarum* etc.
...
> *"We must now treat of the truth — or property — and the unchangeableness"* etc.

### Division of the Text

Now that the two previous parts of this principal part — which concerns the Trinity as it is understood, in which the Master adduced reasons for proving the Trinity and removed doubts — have been completed, in this third part the Master[^1] determines the properties and conditions of the Trinity and the Unity themselves. And since some properties regard the essence (as *truth*), some the persons (as *generation*), and some both (as *equality*), this part accordingly has three sub-parts. In the *first* sub-part, the Master treats of the essential properties; in the *second*, of the personal properties, below in distinction nine: *"Now to the distinction of persons"* etc.; in the *third*, of the properties and conditions that are in one mode essential and in another mode personal — such as the equality of the persons in eternity, magnitude, and power[^2] — below in distinction nineteen: *"Now, since we have shown the co-eternity of the three persons"* etc.

The first sub-part, which contains the present distinction, has three subdivisions according to the three properties it assigns: the *first* concerns truth; the *second*, unchangeableness — placed in the third chapter[^3]: *"The essence of God alone is properly called unchangeable"*; the *third*, simplicity — placed in the fourth chapter[^4]: *"And the same essence alone is properly and truly simple"* etc.

Likewise the first sub-part has two parts, since first he attributes to God the property of truth; second he removes a doubt arising from what was said, in the second chapter: *"Here it must be carefully attended to."* Similarly the second sub-part has two: in the *first* he assigns to God the property of unchangeableness and proves it by the authority of Augustine; in the *second* he confirms it by the Apostle, at: *"And so the Apostle, speaking,"* etc. The third [sub-part], on simplicity, will be subdivided below.
...
[^1]: **La.** Praeter fidem mss. et ed. 1 omisso *Magister*, substituit Vat. *istius* loco *ipsius* et paulo infra *utraque* pro *utrasque*.
    **En.** Against the witness of the manuscripts and edition 1 — *Magister* having been omitted — the Vatican edition substitutes *istius* for *ipsius*, and a little below *utraque* for *utrasque*.

[^2]: **La.** Vat. *unitate* pro *virtute*, sed contra textum Magistri et codd.
    **En.** The Vatican edition reads *unitate* ("unity") in place of *virtute* ("power"), but against the text of the Master and the manuscripts.

[^3]: **La.** Ita codd. cum ed. 1 ad normam alterius divisionis capitulorum; in nostra vide c. 2. — Vat. hic et in seqq. *ibi*.
    **En.** Thus the manuscripts with edition 1, according to the standard of an alternate division of chapters; in our edition see c. 2. — The Vatican edition here and in what follows reads *ibi* ("there").
