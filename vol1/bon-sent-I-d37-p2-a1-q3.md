...
quaestio: 3
type: quaestio
title_la: "Utrum Deus sit ab omni loco separabilis vel extra omnem locum"
title_en: "Whether God is separable from every place or [is] outside every place"
printed_pages: [655, 656, 657]
pdf_pages: [245, 246, 247]
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 655–657"
has_scholion: true
has_apparatus: true
line_start: 23767
line_end: 23926
word_count_latin: 1113
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR (raw lines 23767–23926 of pt2), fresh literal English translation, full apparatus from raw OCR (9 entries), scholion from OCR with [?] flags on ambiguous spots (2026-05-07)"
format_version: 1
---
...
1. Quia extra omnem locum nihil est; ergo si Deus est extra omnem locum, ergo nihil est[^1] vel in nihilo[^2].
...
si pro aliquo, ergo pro creato, vel increato: non pro creato; constat[^3]: ergo pro increato: ergo esse extra mundum est esse in Deo. Sed omnia sunt in Deo: ergo omnia sunt extra mundum.
...
2. Item, quod Deus separetur a loco secundum rem, videtur, quia, sicut se habet Dei aeternitas ad omne tempus, ita immensitas[^4] ad omnem locum; sed Dei aeternitas fuit ante omne tempus: ergo Dei immensitas fuit extra omnem locum. Sed quod est extra aliquid est separatum ab eo: ergo etc.
...
*Ad 5.* Similiter, si fiat Angelus extra mundum; Deus tunc est extra non secundum motum suum, sed Angeli. Sed forte hoc est magis fictionis quam veritatis, quod Angelus extra universum exeat, sicut patebit[^9]. Attamen illud quod cogitandum est, divinum esse, non potest cogitari habere terminum sicut in duratione, sic non potest cogitari nec debet habere terminum in existentia et praesentialitate; et sicut non potest cogitari habere intercisionem in duratione, sic nec in praesentialitate. Hic intellectus habendus est; caveat tamen, qualiter quis imaginetur et exprimat per sermonem.
...
1. Because outside every place there is nothing; therefore if God is outside every place, then he is nothing[^1] or in nothing[^2].
...
if for something, then either for a created or an uncreated [thing]: not for a created [thing]; that is established[^3]: therefore for an uncreated [thing]: therefore to be outside the world is to be in God. But all things are in God: therefore all things are outside the world.
...
*To 5.* Likewise, if an Angel be made outside the world; God is then outside, not according to his own motion, but [the motion] of the Angel. But perhaps it is more of fiction than of truth, that an Angel should go forth outside the universe, as will appear[^9]. Nevertheless, that which must be thought, the divine being, cannot be thought to have a term [as in duration]; just as in duration [it cannot be thought to have a term], so neither can it be thought, nor ought it to have, a term in existence and presentiality; and as it cannot be thought to have an interruption in duration, so neither in presentiality. This understanding must be held; let one nonetheless take care how one imagines [it] and expresses [it] through speech.
...
[^1]: **La.** Sola Vat. omittit *nihil est*.

    **En.** Only the Vatican [edition] omits *nihil est*.

[^2]: **La.** Et sic Deus esset in nihilo, quod absurdum est dicere.

    **En.** And thus God would be in nothing, which it is absurd to say.

[^3]: **La.** Codd. T V *hoc constat*.

    **En.** Codices T V [read] *hoc constat*.

[^4]: **La.** Cod. Y verbo *immensitas* praemittit *Dei*.

    **En.** Codex Y prefixes to the word *immensitas* the word *Dei*.

[^5]: **La.** Aliqui codd. ut M VV *dependentiam*; vitiose.

    **En.** Some codices, such as M VV, [read] *dependentiam*; corruptly.

[^6]: **La.** Intelligo: quod Deus sit extra omnem locum.

    **En.** I understand: that God is outside every place.

[^7]: **La.** Libr. II. *Moral.* c. 12. n. 20.

    **En.** Book II *Moralia*, c. 12, n. 20.

[^8]: **La.** Sive *existens*. — Vat. omittit *ens*. Paulo post pro *sive* — Vocabulum *mundum*, quod ex cod. Y restituimus, deest in ceteris codd. nec non in Vat.; in plerisque codd. deest etiam *extra*; in his lectionibus supplendum est *etc*.

    **En.** Or *existens* ("existing"). — The Vatican [edition] omits *ens*. A little later, in place of *sive* — the word *mundum*, which we have restored from codex Y, is missing in the other codices and also in the Vatican [edition]; in most codices *extra* is also missing; in these readings *etc.* must be supplied.

[^9]: **La.** Infra a. 2. q. 2. *ad ult.* et II. *Sent.*, d. 2. p. II. a. 2. q. 3. In his locis probatur, Angelos non posse in puncto indivisibili esse, ergo non possunt esse extra locum et per consequens non extra mundum.

    **En.** Below a. 2. q. 2. *ad ult.* and II *Sent.*, d. 2. p. II. a. 2. q. 3. In these places it is proved that Angels cannot be at an indivisible point, therefore they cannot be outside place and consequently not outside the world.
