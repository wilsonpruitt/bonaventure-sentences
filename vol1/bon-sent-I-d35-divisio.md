...
## *Commentarius in Distinctionem XXXV.* — *Divisio textus.*
...
[^1]: **La.** Cod. I subiungit *partes*.

    **En.** Codex I subjoins *partes* ("divisions").

[^2]: **La.** Vat. addit *partes*.

    **En.** The Vatican edition adds *partes* ("divisions").

[^3]: **La.** Vat. ante *connotata* repetit *nomina*, codd. non suffragantibus.

    **En.** The Vatican edition before *connotata* repeats *nomina* ("names"), the codices not supporting [it].
