...
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR (raw lines 16314–16494), fresh literal English translation, 6-entry apparatus from raw OCR; sweep-audited 2026-05-08 (reverted *rationalem*→*rationabilem* and restored omitted clause «multi enim credunt, qui non intelligunt») [d.1-d.10 Wave 9b residual re-verification campaign 2026-05-10 — apparatus completeness pending]"
line_start: 16314
line_end: 16494
format_version: 1
---

# I Sent., d. 2, Commentarius (Divisio textus)
## *Commentary on Distinction II: Division of the Text*
...
Haec est secunda pars, in qua, primi libri materia indagata, incipit Magister prosequi; dividitur autem haec pars[^1] in duas partes, quoniam dupliciter est considerare res, quibus fruendum, scilicet in se, et in comparatione ad creaturas: in se ratione trinitatis et unitatis; in comparatione ad creaturas ratione scientiae, potentiae et voluntatis. Primo ergo agit[^2] de sancta Trinitate et Unitate; secundo de scientia et potentia et voluntate, infra distinctione trigesima quinta: *Cumque supra disseruerimus*.
...
[^1]: **La.** Nulla freta auctoritate mss. et ed. 1 Vat. textum exhibet sic perturbatum: *Secunda pars Primi Libri, in qua materia... dividitur praesertim in*.
    **En.** Relying on no authority of the manuscripts or of ed. 1, the Vatican edition presents the text in this disturbed form: *The second part of the First Book, in which the matter... is divided especially into*.

[^2]: **La.** Codd. V W *agitur*.
    **En.** Codd. V W read *agitur* ("is treated").

[^3]: **La.** Codd. I cc *rationalem*.
    **En.** Codd. I and cc read *rationalem*.

[^4]: **La.** Praeter fidem omnium codd. et ed. 1 omittit Vat. *secundum tria capitula*; mox post *prima* addit *praemisso prooemio de mysterio Trinitatis et Unitatis*, et infra post *Trinitate* ibi omittit *secundo capitulo*.
    **En.** Against the witness of all the codices and ed. 1, the Vatican edition omits *secundum tria capitula* ("according to the three chapters"); immediately after *prima* it adds *praemisso prooemio de mysterio Trinitatis et Unitatis* ("with a proem on the mystery of the Trinity and Unity placed first"), and below, after *Trinitate*, it there omits *secundo capitulo*.

[^5]: **La.** Adiecimus ex cod. I *ostendere*, quod sane subintelligendum est.
    **En.** We have added *ostendere* ("to show") from cod. I, which is certainly to be understood.

[^6]: **La.** Vat., nullo suffragante cod. nec ed. 1, omittendo verba Magistri: *Proponamus ergo in medium*, constructionem sequentis propositionis invertit ponendo *Similiter* pro *Haec est* ac habet duas partes secundum *quod* loco *et quoniam*. — Supple cum Vat. *pars*, quod Codd. et ed. 1 omittunt. Paulo infra Vat. praeter fidem mss. et ed. 1 post *communi* minus correcte ponit *Secundo vero specialiter*.
    **En.** The Vatican edition, with no codex nor ed. 1 in its favor, by omitting the Master's words *Proponamus ergo in medium*, inverts the construction of the following proposition by putting *Similiter* in place of *Haec est* and has "two parts according to *quod*" in place of *et quoniam*. — Supply *pars* with the Vatican ed., which the codices and ed. 1 omit. A little below, the Vatican ed., against the witness of the manuscripts and ed. 1, after *communi* less correctly has *Secundo vero specialiter*.

---

## Notes

- **Chunk scope.** This chunk covers Bonaventure's commentary on Dist. II (distinct from Peter Lombard's text, which is in `bon-sent-I-d2-littera.md`). It contains the opening of the *Commentarius in Distinctionem II*, Bonaventure's *Divisio Textus* (in which he maps Lombard's three chapters on mode, intention, and order, plus Lombard's movement through OT and NT testimonies), and the *Tractatio Quaestionum* (in which he names the four questions that the single article of d. 2 will answer). It ends just before the `ARTICULUS UNICUS` heading; the single article and its four questions begin in `bon-sent-I-d2-a1-q1.md` and following.

- **Scope change from Phase A legacy.** The Phase A legacy `bon-sent-I-d2-divisio.md` combined (a) the tail of Lombard d. 2 Cap. V (NT testimonies — *Nunc vero post testimonia veteris Testamenti...*) and (b) Bonaventure's commentary and divisio textus. As part of Phase C's 2026-04-11 rebuild, Lombard's Cap. V was moved to the new `bon-sent-I-d2-littera.md` chunk alongside Cap. I–IV, and this chunk now contains only Bonaventure's commentary. See `PLAN.md` for the A3 split rationale.

- **Transcription status.** First-pass vision transcription from `raw/vision/vol1/p-049.png` and `p-050.png` at 200 dpi. Latin body and apparatus cross-verified against pdftotext extract of the same pages. English pairs with the legacy Phase A translation of the corresponding text (itself never verified at Tier 1), with some wording updated for consistency with `d2-littera`'s Cap. V translation.

- **Bonaventure's threefold schema.** The division of material by *credere → intelligere → dicere* ("believe → understand → express") is a characteristic Bonaventurian map that organizes the whole block of Distinctions 2, 3, and 22: d. 2 treats the Trinity as it is believed, d. 3 as it is understood through reason, d. 22 as it is expressed rationally and in a Catholic manner. This schema recurs throughout the *Commentary on the Sentences* and should be flagged as a key interpretive move when readers encounter it.

- **Cross-references.** *Infra distinctione trigesima quinta* points to Bonaventure's later treatment of divine knowledge, power, and will (d. 35 ff.). *Infra distinctione vigesima secunda* points to his treatment of the diversity of divine names. These are the three major movements of Book I as Bonaventure sees it.
