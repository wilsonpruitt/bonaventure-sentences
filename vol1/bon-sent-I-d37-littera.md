...
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin verbatim from IA djvu OCR pt2 (raw lines 21452–21915), Lombard's d.37 littera (two-pars; Pars I capp I–IV pp. 633–634; Pars II capp V–IX pp. 635–636), literal English, full apparatus from raw OCR (32 entries across 4 printed-page footer sequences: p. 633 = 12, p. 634 = 10, p. 635 = 2, p. 636 = 8 — distribution corrected 2026-05-09 from prior incorrect 12/9/1/10 attribution; per-page restart convention; chunk consolidates only the 'NOTAE AD LIBR. SENTENTIARUM' editorial-content stream, matching d8-littera convention, and does NOT include the parallel left-column text-critical apparatus on Lombard's body which adds ~30 entries — that is the source of the +30 audit diff per Lesson 9 OVERCOUNT bias on littera chunks); PDF-supplement diff already done 2026-05-07/09 against pt2 PDF pp. 224–226 at 600 dpi (see manual-review/d1-d11-pdf-supplement-resolution-log.md); n. 22 column-rule glyph resolved to printed em-dash separator; n. 32 verified verbatim against printed p. 636 footer fn 8; cap-numbering of Pars II Capp VI–IX vs printed Quaracchi cap-order documented in-body via HTML comments (structural rewrite deferred); rebuilt 2026-05-09 closing Wave 9b Tier A; see manual-review/d1-d4-tier2-promotion-log.md Lesson 9"
format_version: 1
---
