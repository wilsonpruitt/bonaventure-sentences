...
source: "S. Bonaventurae, Opera Omnia, Tomus I (Quaracchi, 1882), pp. 567–569 (Petri Lombardi Sententiarum Lib. I, Dist. XXXIII, single-pars, Capp. I–II). OCR source: raw/bonaventure_vol1_pt2_raw.txt (volume I, part 2), lines 15062–15351."
line_start: 15062
line_end: 15351
word_count_latin: 1840
has_scholion: false
has_apparatus: true
transcription_status: "Phase C Tier 2 complete — Latin re-set verbatim from IA djvu OCR pt2 (raw lines 15062–15351), Lombard's d.33 littera (single-pars; Capp. I–II spanning printed pp. 567–569), fresh literal English translation, full apparatus from raw OCR Notae blocks (19 entries: 0/11/8 across pp. 567/568/569 — p. 567 footers belong to the preceding d.32 chunk, d.33 body begins at the very bottom of p. 567 with no d.33-specific footnotes on that page). Wave 9b Tier C overcount-accepted 2026-05-10 — 19 footer entries verified per-page against raw OCR (p.567=0, p.568=11, p.569=8); banded-audit +14 diff is intra-entry noise (Cap. I/II rubric openers + italicized chapter-title rubrics + embedded Augustine/Hilary citation series matching the hardened footer-opener regex). All 19 [^N]: defs match ground-truth footers; no missing, fabricated, or mis-anchored entries. Body Latin verbatim from OCR, not paraphrased. (2026-05-10)"
format_version: 1
---

# bon-sent-I-d33-littera

## *Lombard's text on Distinction XXXIII: on the properties of the persons — whether the properties of the persons are the persons themselves and the divine essence, and how they can be in the divine nature without determining it.*
...
Resisting their audacity and providing for their ignorance, we shall dare to say something on this. Paternity and filiation are not said to be altogether in such a way in the divine substance, as in the very *hypostases*, in which they are so [present] that they determine them, as John Damascene says[^10]: "They are *characteristic idioms*, that is, *determinative properties* of *hypostasis*, and not of nature; for they determine *hypostasis*, and not nature." And therefore, although paternity and filiation are in the divine essence, since they do not determine it, on that account it cannot be said that the divine essence both begets and is begotten, or that one and the same thing is there[^11] Father and Son. For property in this way determines the person, that by this property the *hypostasis* is generating, and the other *hypostasis* is generated; and so it is not the same that begets and is begotten, but the one [begets] the other.
...
[^1]: **La.** Cfr. d. XXVI. c. 2, et d. XXVII. c. 1.

    **En.** Cf. Distinction XXVI, c. 2, and Distinction XXVII, c. 1.

[^2]: **La.** *Dist.* XXV. c. 3. in fine. — Infra codd. ABE *aperte ostendit* pro *aperte dicit*.

    **En.** Distinction XXV, c. 3, at the end. — Below, codices ABE [read] *aperte ostendit* ("openly shows") in place of *aperte dicit* ("openly says").

[^3]: **La.** *Dist.* VIII. pars II.

    **En.** Distinction VIII, part II.

[^4]: **La.** *Num.* 21. (n. = numerus, paragraph number; not biblical Numbers.)

    **En.** *n.* 21 — that is, *paragraph 21*. (*Note*: "Num." in Quaracchi apparatus = *numerus*, paragraph number, not the biblical book of Numbers.)

[^5]: **La.** *Num.* 40. Sequens locus VII. n. 22.

    **En.** *n.* 40. The following passage [is from book] VII, n. 22.

[^6]: **La.** *Dist.* XXVI. c. 3. Locus Hilarii est XII. *de Trin.* n. 23. — Vat. *Supra enim dixit* pro *Supra etiam dicit*.

    **En.** Distinction XXVI, c. 3. The Hilary passage is [book] XII *On the Trinity*, n. 23. — The Vatican edition [reads] *Supra enim dixit* ("For above he said") in place of *Supra etiam dicit* ("Above also he says").

[^7]: **La.** Codd. C D *dicuntur*. Paulo inferius codd. A B D E et edd. 1, 2, 3, 5, 7, 9 *affixa sunt* pro *affixae sunt*.

    **En.** Codices C D [read] *dicuntur* ("are said"). A little below, codices A B D E and editions 1, 2, 3, 5, 7, 9 [read] *affixa sunt* in place of *affixae sunt* ("are affixed").
...
[^11]: **La.** Ita codd. C D et ed. I, in ceteris *sibi*.
    ...
    **En.** Thus the codices C D and ed. I; in the rest [the reading is] *sibi* ("to itself").

[^12]: **La.** *Libr.* II. *de Trin.* n. 9. 10. 11, sed plurimis a Magistro omissis et transpositis.

    **En.** Book II, *On the Trinity*, nn. 9, 10, 11, but with very many things omitted and transposed by the Master.

[^13]: **La.** Respicitur *Prov.* 25, 27: *Qui scrutator est maiestatis, opprimetur a gloria*.

    **En.** Reference is made to *Proverbs* 25:27: *He who is a searcher of majesty shall be overwhelmed by glory*.

[^14]: **La.** August. *Enarratio in Psalm.* 68, 3, sermo 1. n. 5.
...
[^18]: **La.** *Dist.* XXVII. p. II. c. 3.
    ...
    **En.** Distinction XXVII, part II, c. 3.

[^19]: **La.** Ita codd. ACDE et ed. I, cod. B et aliae edd. *quo*.

    **En.** Thus the codices ACDE and ed. I; codex B and other editions [read] *quo*.
